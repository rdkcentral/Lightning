...
a),function(a){return a};let c=parseFloat(b[0]),d=parseFloat(b[1]),e=parseFloat(b[2]);b=parseFloat(b[3]);return isNaN(c)||isNaN(d)||isNaN(e)||isNaN(b)?(console.warn("Unknown timing function: "+a),function(a){return a}):q.getTimingBezier(c,d,e,b)}console.warn("Unknown timing function: "+a);return function(a){return a}}}}class D{constructor(a){this._v=a;this._horizontal=!0;this._reverse=!1;this._alignContent=this._justifyContent=this._alignItems="flex-start";this._baseMainAxisSize=0}get direction(){return(this._horizontal?
"row":"column")+(this._reverse?"-reverse":"")}set direction(a){this.direction!==a&&(this._horizontal="row"===a||"row-reverse"===a,this._reverse="row-reverse"===a||"column-reverse"===a,this._v._setHasFlexLayoutUpdates())}get alignItems(){return this._alignItems}set alignItems(a){if(this._alignItems!==a){if(-1===D.ALIGN_ITEMS.indexOf(a))throw Error("Unknown alignItems, options: "+D.ALIGN_ITEMS.join(","));this._alignItems=a;this._v._setHasFlexLayoutUpdates()}}get alignContent(){return this._alignContent}set alignContent(a){if(this._alignContent!==
a){if(-1===D.ALIGN_CONTENT.indexOf(a))throw Error("Unknown alignContent, options: "+D.ALIGN_CONTENT.join(","));this._alignContent=a;this._v._setHasFlexLayoutUpdates()}}get justifyContent(){return this._justifyContent}set justifyContent(a){if(this._justifyContent!==a){if(-1===D.JUSTIFY_CONTENT.indexOf(a))throw Error("Unknown justifyContent, options: "+D.JUSTIFY_CONTENT.join(","));this._justifyContent=a;this._v._setHasFlexLayoutUpdates()}}get _fitSingleLine(){return 0===(this._horizontal?this._v._w:
this._v._h)}layout(){}_distributeItemsOnMainAxis(){}_resizeLine(a){}_alignLines(){}_alignLayoutLine(a,b,c){}_resizeMainAxis(a){}_resizeCrossAxis(a){}_getMainAxisSize(a){return this._horizontal?a._lw:a._lh}_maxCrossAxisSize(a){}_getCrossAxisSize(a){}_setCrossAxisSize(a,b){}get _items(){return this._v.children}get _stage(){return this._v.view.stage}patch(a){this._stage.patchObject(this,a)}}D.ALIGN_ITEMS=["flex-start","flex-end","center","stretch"];D.ALIGN_CONTENT="flex-start flex-end center space-between space-around space-evenly stretch".split(" ");
D.JUSTIFY_CONTENT="flex-start flex-end center space-between space-around space-evenly".split(" ");class Ga{constructor(a){this._v=a;this._shrink=this._grow=0;this._alignSelf=void 0;this._lineIndex=0}_changed(){this._ctr&&this._ctr._v._setHasFlexLayoutUpdates()}get grow(){return this._grow}set grow(a){this._grow!==a&&(this._grow=parseInt(a)||0,this._changed())}get shrink(){return this._shrink}set shrink(a){this._shrink===a&&(this._shrink=parseInt(a)||0,this._changed())}get alignSelf(){return this._alignSelf}set alignSelf(a){if(this._alignSelf===
a){void 0===a&&(this._alignSelf=void 0);if(-1===FlexContainer.ALIGN_ITEMS.indexOf(a))throw Error("Unknown alignSelf, options: "+FlexContainer.ALIGN_ITEMS.join(","));this._alignSelf=a;this._changed()}}get _ctr(){return this._v._parent}get _stage(){return this._v.view.stage}patch(a){this._stage.patchObject(this,a)}}class l{static isFunction(a){return"function"===typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===
...
!1;this._recBoundsMargin=this._boundsMargin=void 0;this._withinBoundsMargin=!1;this._viewport=void 0;this._clipbox=!1;this.render=this._renderSimple;this._hasLayoutUpdates=0;this._flexItem=this._flex=void 0;this._lh=this._lw=this._ly=this._lx=0}get flex(){this._flex||(this._flex=new D(this));return this._flex}set flex(a){if(!a&&this._flex){if(this._flex=void 0,this._children)for(let a=0,c=this._children.length;a<c;a++)this._children[a]._layoutAbsolute()}else this.flex.patch(a)}get flexItem(){this._flexItem||
(this._flexItem=new Ga(this));return this._flexItem}set flexItem(a){!a&&this._flexItem?this._flexItem=void 0:this.flexItem.patch(a)}get x(){return this._x}set x(a){this._x!==a&&(this._isFlexItem()?this._setHasFlexLayoutUpdates():(this._updateLocalTranslateDelta(a-this._x,0),this._lx=a),this._x=a)}get y(){return this._y}set y(a){this._y!==a&&(this._isFlexItem()?this._setHasFlexLayoutUpdates():(this._updateLocalTranslateDelta(0,a-this._y),this._ly=a),this._y=a)}get w(){return this._w}set w(a){this._w!==
...
this._rotation&&this._rotation%(2*Math.PI)){let a=Math.sin(this._rotation),b=Math.cos(this._rotation);this._setLocalTransform(b*this._scaleX,-a*this._scaleY,a*this._scaleX,b*this._scaleY)}else this._setLocalTransform(this._scaleX,0,0,this._scaleY);this._updateLocalTranslate()}_updateLocalTranslate(){var a=this._pivotX*this._lw;let b=this._pivotY*this._lh,c=this._lx-(a*this.localTa+b*this.localTb)+a;a=this._ly-(a*this.localTc+b*this.localTd)+b;c-=this._mountX*this._lw;a-=this._mountY*this._lh;this._setLocalTranslate(c,
a)}_updateLocalTranslateDelta(a,b){this._addLocalTranslate(a,b)}_updateLocalAlpha(){this._setLocalAlpha(this._visible?this._alpha:0)}setHasRenderUpdates(a){if(this._worldContext.alpha){let b=this;for(b._hasRenderUpdates=Math.max(a,b._hasRenderUpdates);(b=b._parent)&&3!=b._hasRenderUpdates;)b._hasRenderUpdates=3}}_setRecalc(a){this._recalc|=a;this._setHasUpdates();this._parent&&this._parent.setHasRenderUpdates(3)}_setHasUpdates(){let a=this;for(;a&&!a._hasUpdates;)a._hasUpdates=!0,a=a._parent}_setHasFlexLayoutUpdates(){this._hasLayoutUpdates=
2;let a=this._parent;for(;a&&!a._hasLayoutUpdates;)a._hasLayoutUpdates=1,a=a._parent}setParent(a){if(a!==this._parent){let b=this.isZContext(),c=this._isFlexItem(),d=this._parent;this._parent=a;d&&(d.setHasRenderUpdates(3),d._isFlexContainer()&&d._setHasFlexLayoutUpdates());c&&!this._isFlexItem()&&this._updateAbsoluteLayout();this._setRecalc(7);this._parent&&(this._parent._setHasUpdates(),this._isFlexItem()&&this._parent._setHasFlexLayoutUpdates());0===this._zIndex?this.setZParent(a):this.setZParent(a?
a.findZContext():null);b!==this.isZContext()&&(this.isZContext()?this.enableZContext(d.findZContext()):this.disableZContext());this._zIndexResort=!0;this._zParent&&this._zParent.enableZSort();this._shader||(a=a&&!a._renderToTextureEnabled?a._shaderOwner:null,a!==this._shaderOwner&&(this.setHasRenderUpdates(1),this._setShaderOwnerRecursive(a)))}}enableZSort(a=!1){!this._zSort&&0<this._zContextUsage&&(this._zSort=!0,a&&this.ctx.forceZSort(this))}addChildAt(a,b){this._children||(this._children=[]);this._children.splice(a,
...
for(let a=0,c=b.length;a<c;a++)b[a].setParent(this)}moveChild(a,b){let c=this._children[a];this._children.splice(a,1);this._children.splice(b,0,c);this._isFlexContainer()&&this._setHasFlexLayoutUpdates();this._zIndexResort=!0;this._zParent&&this._zParent.enableZSort()}_setLocalTransform(a,b,c,d){this._setRecalc(4);this._localTa=a;this._localTb=b;this._localTc=c;this._localTd=d;this._isComplex=0!==b||0!==c||0>a||0>d}_setLocalTranslate(a,b){this._setRecalc(2);this._localPx=a;this._localPy=b}_addLocalTranslate(a,
b){this._setLocalTranslate(this._localPx+a,this._localPy+b)}_setLocalAlpha(a){!this._worldContext.alpha&&this._parent&&this._parent._worldContext.alpha&&a?this._setRecalc(129):this._setRecalc(1);1E-14>a&&(a=0);this._localAlpha=a}_isFlexItem(){return!(!this._parent||!this._parent._isFlexContainer())}_isFlexContainer(){return!!this._flex}setDimensions(a,b,c){return this._rw!==a||this._rh!==b?(this._rw=a,this._rh=b,this._rwhEstimate=c,this._isFlexItem()?this._setHasFlexLayoutUpdates():this._updateAbsoluteLayoutDims(),
!0):!1}layout(){this._flex&&console.log("flexbox!");if(this._hasLayoutUpdates&&(2===this._hasLayoutUpdates&&(this._hasLayoutUpdates=0),this._children))for(let a=0,b=this._children.length;a<b;a++)this._children[a].layout()}_updateAbsoluteLayout(){this._updateAbsoluteLayoutPos();this._updateAbsoluteLayoutDims()}_updateAbsoluteLayoutPos(){const a=this._x,b=this._y;if(a!==this._lx||b!==this._ly)this._lx=a,this._ly=b,this._updateLocalTranslate()}_updateAbsoluteLayoutDims(){const a=this._rw!==this._lw||
this._rh!==this._lh;a&&(this._lw=this._rw,this._lh=this._rh,this._lwhEstimate=this._rwhEstimate,this._updateLocalTranslate(),a&&this._texturizer&&(this._texturizer.releaseRenderTexture(),this._texturizer.updateResultTexture()))}setTextureCoords(a,b,c,d){this.setHasRenderUpdates(3);this._ulx=a;this._uly=b;this._brx=c;this._bry=d}get displayedTextureSource(){return this._displayedTextureSource}setDisplayedTextureSource(a){this.setHasRenderUpdates(3);this._displayedTextureSource=a}get isRoot(){return this._isRoot}setAsRoot(){this._parent=
new L(this._view);this._parent._hasRenderUpdates=3;this._isRoot=this._parent._hasUpdates=!0;this.ctx.root=this;this._parent._viewport=[0,0,this.ctx.stage.rw,this.ctx.stage.rh];this._parent._scissor=this._parent._viewport;this._parent._recBoundsMargin=[100,100,100,100];this._parent._boundsMargin=null;this._setRecalc(7);this._setHasFlexLayoutUpdates()}isAncestorOf(a){for(;a=a._parent;)if(this===a)return!0;return!1}isZContext(){return this._forceZIndexContext||this._renderToTextureEnabled||0!==this._zIndex||
this._isRoot||!this._parent}findZContext(){return this.isZContext()?this:this._parent.findZContext()}setZParent(a){if(this._zParent!==a){null!==this._zParent&&(0!==this._zIndex&&this._zParent.decZContextUsage(),this._zParent.enableZSort());if(null!==a){let b=0<a._zContextUsage;0!==this._zIndex&&a.incZContextUsage();0<a._zContextUsage&&((b||this._parent!==a)&&a._zIndexedChildren.push(this),a.enableZSort())}this._zParent=a;this._zIndexResort=!0}}incZContextUsage(){this._zContextUsage++;if(1===this._zContextUsage&&
...
this._updateTreeOrder+1:this._updateTreeOrder=this.ctx.updateTreeOrder++;b=this._renderToTextureEnabled&&this._texturizer.mustRenderToTexture();this._useRenderToTexture!==b&&(this._recalc|=6,d|=2,this._useRenderToTexture||this._texturizer.release());this._useRenderToTexture=b;b=this._renderContext;c=this._lw;const h=this._lh;let k,m,l,z;var e=0!==b.tb||0!==b.tc||0>b.ta||0>b.td;e?(k=Math.min(0,c*b.ta,c*b.ta+h*b.tb,h*b.tb)+b.px,l=Math.max(0,c*b.ta,c*b.ta+h*b.tb,h*b.tb)+b.px,m=Math.min(0,c*b.tc,c*b.tc+
h*b.td,h*b.td)+b.py,z=Math.max(0,c*b.tc,c*b.tc+h*b.td,h*b.td)+b.py):(k=b.px,l=b.px+b.ta*c,m=b.py,z=b.py+b.td*h);if(this._lwhEstimate&&(e||1>this._localTa||1>this._localTb)){var f=this._x*a.ta+this._y*a.tb+a.px,g=this._x*a.tc+this._y*a.td+a.py;f<k&&(k=f);g<m&&(m=g);f>l&&(l=f);g>z&&(z=g)}if(d&6||!this._scissor)if(this._clipping&&b.isSquare())if(f=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor){g=Math.max(f[0],k);const a=Math.max(f[1],m);this._scissor=[g,a,Math.min(f[2]+
f[0],l)-g,Math.min(f[3]+f[1],z)-a]}else this._scissor=[k,m,l-k,z-m];else this._scissor=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor;this._recBoundsMargin=void 0!==this._boundsMargin?this._boundsMargin:this._parent._recBoundsMargin;this._onAfterCalcs&&this._onAfterCalcs(this.view)&&(e?(k=Math.min(0,c*b.ta,c*b.ta+h*b.tb,h*b.tb)+b.px,l=Math.max(0,c*b.ta,c*b.ta+h*b.tb,h*b.tb)+b.px,m=Math.min(0,c*b.tc,c*b.tc+h*b.td,h*b.td)+b.py,z=Math.max(0,c*b.tc,c*b.tc+h*b.td,h*b.td)+
b.py):(k=b.px,l=b.px+b.ta*c,m=b.py,z=b.py+b.td*h),this._lwhEstimate&&(e||1>this._localTa||1>this._localTb)&&(e=this._x*a.ta+this._y*a.tb+a.px,a=this._x*a.tc+this._y*a.td+a.py,e<k&&(k=e),a<m&&(m=a),e>l&&(l=e),a>z&&(z=a)));if(2===this._parent._outOfBounds)this._outOfBounds=2,this._withinBoundsMargin&&(this._withinBoundsMargin=!1,this.view._disableWithinBoundsMargin());else if(d&6){this._outOfBounds=0;d=!0;if(!this._renderToTextureEnabled||!this._texturizer||!this._texturizer.renderOffscreen){if(this._scissor&&
(0>=this._scissor[2]||0>=this._scissor[3]))this._outOfBounds=2;else{if(this._scissor[0]>l||this._scissor[1]>z||k>this._scissor[0]+this._scissor[2]||m>this._scissor[1]+this._scissor[3])this._outOfBounds=1;this._outOfBounds&&(this._clipping||this._useRenderToTexture||this._clipbox)&&(this._outOfBounds=2)}d=0===this._outOfBounds;!d&&this._recBoundsMargin&&(d=!(l<this._scissor[0]-this._recBoundsMargin[2]||z<this._scissor[1]-this._recBoundsMargin[3]||k>this._scissor[0]+this._scissor[2]+this._recBoundsMargin[0]||
m>this._scissor[1]+this._scissor[3]+this._recBoundsMargin[1]))&&2===this._outOfBounds&&(this._outOfBounds=1)}if(this._withinBoundsMargin!==d)if(this._withinBoundsMargin=d){this._hasUpdates=!0;d=this._recalc;this._recalc=0;this.view._enableWithinBoundsMargin();if(this._recalc)return this.update();this._recalc=d}else this.view._disableWithinBoundsMargin()}this._useRenderToTexture&&(this._viewport?(this._viewport[2]=c,this._viewport[3]=h):this._viewport=[0,0,c,h]);this._pRecalc=this._recalc&135;this._recalc=
0;this._hasUpdates=!1;if(2>this._outOfBounds){this._useRenderToTexture&&(this._worldContext.isIdentity()?this._renderContext=this._worldContext:this._renderContext=I.IDENTITY);if(this._children)for(let a=0,b=this._children.length;a<b;a++)this._children[a].update();this._useRenderToTexture&&(this._renderContext=b)}else if(this._children)for(let a=0,b=this._children.length;a<b;a++)this._children[a]._hasUpdates?this._children[a].update():(this._children[a]._recalc|=this._pRecalc,this._children[a].updateOutOfBounds());
this._onAfterUpdate&&this._onAfterUpdate(this.view)}else-1===this.ctx.updateTreeOrder||this._updateTreeOrder>=this.ctx.updateTreeOrder?this.ctx.updateTreeOrder=-1:this.updateTreeOrder()}updateOutOfBounds(){if(2!==this._outOfBounds&&0<this._renderContext.alpha&&(this._outOfBounds=2,this._withinBoundsMargin&&(this._withinBoundsMargin=!1,this.view._disableWithinBoundsMargin()),this._children))for(let a=0,b=this._children.length;a<b;a++)this._children[a].updateOutOfBounds()}updateTreeOrder(){if(this._localAlpha&&
2!==this._outOfBounds&&(this._updateTreeOrder=this.ctx.updateTreeOrder++,this._children))for(let a=0,b=this._children.length;a<b;a++)this._children[a].updateTreeOrder()}_renderSimple(){this._hasRenderUpdates=0;this._zSort&&this.sortZIndexedChildren();if(2>this._outOfBounds&&this._renderContext.alpha){let a=this.renderState;0===this._outOfBounds&&this._displayedTextureSource&&!this._lwhEstimate&&(a.setShader(this.activeShader,this._shaderOwner),a.setScissor(this._scissor),this.renderState.addQuad(this));
if(this._children)if(this._zContextUsage)for(let a=0,c=this._zIndexedChildren.length;a<c;a++)this._zIndexedChildren[a].render();else for(let a=0,c=this._children.length;a<c;a++)0===this._children[a]._zIndex&&this._children[a].render()}}_renderAdvanced(){var a=this._hasRenderUpdates;this._hasRenderUpdates=0;this._zSort&&this.sortZIndexedChildren();if(2>this._outOfBounds&&this._renderContext.alpha){let c=this.renderState;var b=!0;let d,e;if(this._useRenderToTexture){if(0===this._lw||0===this._lh)return;
if(!this._texturizer.hasRenderTexture()||3<=a){c.setShader(c.defaultShader,this);e=c.renderTextureInfo;d={nativeTexture:null,offset:0,w:this._lw,h:this._lh,empty:!0,cleared:!1,ignore:!1,cache:!1};if(this._texturizer.hasResultTexture()||!c.isCachingTexturizer&&3>a)d.cache=!0,c.isCachingTexturizer=!0;this._texturizer.hasResultTexture()||this._texturizer.releaseRenderTexture();c.setRenderTextureInfo(d);c.setScissor(void 0);this._displayedTextureSource&&!this._lwhEstimate&&(a=this._renderContext,this._renderContext=
I.IDENTITY,this.renderState.addQuad(this),this._renderContext=a)}else b=!1}else 0===this._outOfBounds&&this._displayedTextureSource&&!this._lwhEstimate&&(c.setShader(this.activeShader,this._shaderOwner),c.setScissor(this._scissor),this.renderState.addQuad(this));if(b&&this._children)if(this._zContextUsage)for(let a=0,b=this._zIndexedChildren.length;a<b;a++)this._zIndexedChildren[a].render();else for(let a=0,b=this._children.length;a<b;a++)0===this._children[a]._zIndex&&this._children[a].render();
this._useRenderToTexture&&(a=!1,b&&(c.finishedRenderTexture(),(this._texturizer.empty=d.empty)?this._texturizer.releaseRenderTexture():d.nativeTexture?(this._texturizer.reuseTextureAsRenderTexture(d.nativeTexture),d.ignore=!0):(this._texturizer.renderTextureReused&&this._texturizer.releaseRenderTexture(),d.nativeTexture=this._texturizer.getRenderTexture()),c.setRenderTextureInfo(e),a=!0),this._texturizer.empty||(b=this._texturizer.getResultTexture(),a&&(b&&(b.update=c.stage.frameCounter),this._texturizer.updateResultTexture()),
this._texturizer.renderOffscreen||(c.setShader(this.activeShader,this._shaderOwner),c.setScissor(this._scissor),c.setTexturizer(this._texturizer,!d||d.cache),this._stashTexCoords(),this._texturizer.colorize||this._stashColors(),this.renderState.addQuad(this,!0),this._texturizer.colorize||this._unstashColors(),this._unstashTexCoords(),c.setTexturizer(null))));d&&d.cache&&(c.isCachingTexturizer=!1)}}get zSort(){return this._zSort}sortZIndexedChildren(){var a=this._zIndexedChildren.length;let b=0;var c=
this._zIndexedChildren,d=[];for(var e=0;e<a;e++)c[e]._zParent===this&&(c[e]._zIndexResort?d.push(c[e]):(b!==e&&(c[b]=c[e]),b++));if(a=d.length){for(e=0;e<a;e++)d[e]._zIndexResort=!1;d.sort(L.sortZIndexedChildren);const f=b;if(f){let g=b=0,h=0;e=[];do{const k=0<(c[g]._zIndex===d[h]._zIndex?c[g]._updateTreeOrder-d[h]._updateTreeOrder:c[g]._zIndex-d[h]._zIndex)?d[h++]:c[g++];if(0===b||e[b-1]!==k)e[b++]=k;if(g>=f){do if(c=d[h++],0===b||e[b-1]!==c)e[b++]=c;while(h<a);break}else if(h>=a){do if(d=c[g++],
0===b||e[b-1]!==d)e[b++]=d;while(g<f);break}}while(1);this._zIndexedChildren=e}else{e=b=0;do c[b++]=d[e++];while(e<a);c.length>b&&c.splice(b)}}else c.length>b&&c.splice(b);this._zSort=!1}get localTa(){return this._localTa}get localTb(){return this._localTb}get localTc(){return this._localTc}get localTd(){return this._localTd}get rw(){return this._rw}get rh(){return this._rh}get lw(){return this._lw}get lh(){return this._lh}get view(){return this._view}get renderUpdates(){return this._hasRenderUpdates}get texturizer(){this._texturizer||
(this._texturizer=new ia(this));return this._texturizer}getCornerPoints(){let a=this._worldContext;return[a.px,a.py,a.px+this._lw*a.ta,a.py+this._lw*a.tc,a.px+this._lw*a.ta+this._lh*a.tb,a.py+this._lw*a.tc+this._lh*a.td,a.px+this._lh*a.tb,a.py+this._lh*a.td]}getRenderTextureCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}getAbsoluteCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}}class I{constructor(){this.alpha=1;this.py=this.px=
0;this.ta=1;this.tc=this.tb=0;this.td=1}isIdentity(){return 1===this.alpha&&0===this.px&&0===this.py&&1===this.ta&&0===this.tb&&0===this.tc&&1===this.td}isSquare(){return 0===this.tb&&0===this.tc}}I.IDENTITY=new I;L.sortZIndexedChildren=function(a,b){return a._zIndex===b._zIndex?a._updateTreeOrder-b._updateTreeOrder:a._zIndex-b._zIndex};class F{static defaultSetter(a,b,c){a[b]=c}static patchObject(a,b){if(l.isObjectLiteral(b)){let c=Object.keys(b);for(let d=0,e=c.length;d<e;d++){let e=c[d];this.patchObjectProperty(a,
e,b[e])}}else console.error("Settings must be object literal")}static preparePatchSettings(a,b){return b?this._preparePatchSettings(a,"_$"+b):a}static _preparePatchSettings(a,b){b&&a[b]&&(a=Object.assign({},a,a[b]),delete a[b]);return a}static patchObjectProperty(a,b,c){let d=a.setSetting||F.defaultSetter;"_"===b.charAt(0)?"$"!==b.charAt(1)&&"__create"!==b&&console.error("Patch of private property '"+b+"' is not allowed"):"type"!==b&&(l.isFunction(c)&&c.__local&&(c=c.__local(a)),d(a,b,c))}static local(a){a.__local=
!0}}class v{constructor(){this._hasEventListeners=!1}on(a,b){this._hasEventListeners||(this._eventFunction={},this._eventListeners={},this._hasEventListeners=!0);this._eventFunction[a]?this._eventFunction[a]!==v.combiner?(this._eventListeners[a]=[this._eventFunction[a],b],this._eventFunction[a]=v.combiner):this._eventListeners[a].push(b):this._eventFunction[a]=b}has(a,b){if(this._hasEventListeners){const c=this._eventFunction[a];if(c){if(c===v.combiner)return 0<=this._eventListeners[a].indexOf(b);
...
this._x:0))/this._precision}getRenderHeight(){return(this._h||(this._source?this._source.getRenderHeight()-this._y:0))/this._precision}patch(a){this.stage.patchObject(this,a)}}A.prototype.isTexture=!0;A.id=0;class R extends A{constructor(a){super(a);this._src=void 0;this._hasAlpha=!1}get src(){return this._src}set src(a){this._src!==a&&(this._src=a,this._changed())}get hasAlpha(){return this._hasAlpha}set hasAlpha(a){this._hasAlpha!==a&&(this._hasAlpha=a,this._changed())}_getIsValid(){return!!this._src}_getLookupId(){return this._src}_getSourceLoader(){let a=
this._src,b=this._hasAlpha;if(this.stage.getOption("srcBasePath")){var c=a.charCodeAt(0);-1===a.indexOf("//")&&(65<=c&&90>=c||97<=c&&122>=c||46==c)&&(a=this.stage.getOption("srcBasePath")+a)}const d=this.stage.platform;return function(c){return d.loadSrcTexture({src:a,hasAlpha:b},c)}}getNonDefaults(){const a=super.getNonDefaults();this._src&&(a.src=this._src);return a}}class Ha{constructor(a,b,c){this._stage=a;this._canvas=b;this._context=this._canvas.getContext("2d");this._settings=c}getPrecision(){return this._settings.precision}setFontProperties(){this._context.font=
...
0;e<a.length;e++){let f=[],g="",h=b,k=a[e].split(" ");for(let a=0;a<k.length;a++){let c=this._context.measureText(k[a]).width,d=c+this._context.measureText(" ").width;0===a||d>h?(0<a&&(f.push(g),g=""),g+=k[a],h=b-c):(h-=d,g+=" "+k[a])}g&&f.push(g);c=c.concat(f);e<a.length-1&&d.push(c.length)}return{l:c,n:d}}}class J extends A{constructor(a){super(a);this._precision=this.stage.getOption("precision")}get text(){return this._text}set text(a){this._text!==a&&(this._text=""+a,this._changed())}get w(){return this._w}set w(a){this._w!==
...
a.cutSy=this._cutSy;a.cutEy=this._cutEy;return a}}let p=J.prototype;p._text="";p._w=0;p._h=0;p._fontStyle="normal";p._fontSize=40;p._fontFace=null;p._wordWrap=!0;p._wordWrapWidth=0;p._lineHeight=null;p._textBaseline="alphabetic";p._textAlign="left";p._offsetY=null;p._maxLines=0;p._maxLinesSuffix="..";p._textColor=4294967295;p._paddingLeft=0;p._paddingRight=0;p._shadow=!1;p._shadowColor=4278190080;p._shadowOffsetX=0;p._shadowOffsetY=0;p._shadowBlur=5;p._highlight=!1;p._highlightHeight=0;p._highlightColor=
4278190080;p._highlightOffset=0;p._highlightPaddingLeft=0;p._highlightPaddingRight=0;p._cutSx=0;p._cutEx=0;p._cutSy=0;p._cutEy=0;class ja extends A{constructor(a){super(a);this._textureSource=void 0}get textureSource(){return this._textureSource}set textureSource(a){a!==this._textureSource&&(a.isResultTexture&&(this._precision=this.stage.getRenderPrecision()),this._textureSource=a,this._changed())}_getTextureSource(){return this._textureSource}}class S extends v{constructor(a,b,c,d){super();this.manager=
...
this._isEnabled()||this._updateDimensions())}_enableTextureError(){const a=this.__texture.loadError;a&&this.emit("txError",a,this.__texture._source)}_enableTexture(){this.__texture.isLoaded()?this._setDisplayedTexture(this.__texture):(this._setDisplayedTexture(null),this._enableTextureError())}_disableTexture(){this._setDisplayedTexture(null)}get texture(){return this.__texture}set texture(a){let b;if(l.isObjectLiteral(a))(b=a.type?new a.type(this.stage):this.texture)&&this.stage.patchObject(b,a);
else if(a)if(a.isTexture)b=a;else if(a.isTextureSource)b=new ja(this.stage),b.textureSource=a;else{console.error("Please specify a texture type.");return}else b=null;a=this.__texture;b!==a&&((this.__texture=b)?this.__enabled&&(this.__texture.addView(this),this.withinBoundsMargin&&(this.__texture.isLoaded()?this._setDisplayedTexture(this.__texture):this._enableTextureError())):this._setDisplayedTexture(null),a&&a!==this.__displayedTexture&&a.removeView(this),this._updateDimensions())}get displayedTexture(){return this.__displayedTexture}_setDisplayedTexture(a){var b=
...
a}get clipbox(){return this.__core.clipbox}set clipbox(a){this.__core.clipbox=a}get tags(){return this.getTags()}set tags(a){Array.isArray(a)||(a=[a]);this.setTags(a)}set t(a){this.tags=a}get _children(){this.__childList||(this.__childList=new Ia(this,!1));return this.__childList}get childList(){this._allowChildrenAccess()||this._throwError("Direct access to children is not allowed in "+this.getLocationString());return this._children}hasChildren(){return this._allowChildrenAccess()&&this.__childList&&
0<this.__childList.length}_allowChildrenAccess(){return!0}get children(){return this.childList.get()}set children(a){this.childList.patch(a)}add(a){return this.childList.a(a)}get p(){return this.__parent}get parent(){return this.__parent}get src(){if(this.texture&&this.texture instanceof R)return this.texture._src}set src(a){this.texture=new R(this.stage);this.texture.src=a}set mw(a){this.texture?this.texture.mw=a:this._throwError("Please set mw after setting a texture.")}set mh(a){this.texture?this.texture.mh=
a:this._throwError("Please set mh after setting a texture.")}get rect(){return this.texture===this.stage.rectangleTexture}set rect(a){this.texture=a?this.stage.rectangleTexture:null}enableTextTexture(){this.texture&&this.texture instanceof J||(this.texture=new J(this.stage),this.texture.w||this.texture.h||(this.texture.w=this.w,this.texture.h=this.h));return this.texture}get text(){if(this.texture&&this.texture instanceof J)return this.texture}set text(a){this.texture&&this.texture instanceof J||
this.enableTextTexture();l.isString(a)?this.texture.text=a:this.texture.patch(a)}get flex(){return this.__core.flex}set flex(a){this.__core.flex=a}get flexItem(){return this.__core.flexItem}set flexItem(a){this.__core.flexItem=a}set onUpdate(a){this.__core.onUpdate=a}set onAfterCalcs(a){this.__core.onAfterCalcs=a}set onAfterUpdate(a){this.__core.onAfterUpdate=a}forceUpdate(){this.__core._setHasUpdates()}get shader(){return this.__core.shader}set shader(a){if(a=M.create(this.stage,a))this.__enabled&&
...
this.texturizer.renderOffscreen}set renderOffscreen(a){this.texturizer.renderOffscreen=a}get colorizeResultTexture(){return this._hasTexturizer()&&this.texturizer.colorize}set colorizeResultTexture(a){this.texturizer.colorize=a}getTexture(){return this.texturizer._getTextureSource()}get texturizer(){return this.__core.texturizer}patch(a,b=!1){a=F.preparePatchSettings(a,this.stage.getPatchId());let c=Object.keys(a);a.hasOwnProperty("__create")&&(b=a.__create);for(let e=0,f=c.length;e<f;e++){let f=
c[e];const h=a[f];var d=f.indexOf(".");if(-1===f.indexOf(">")&&-1===d)if(d=f.charCodeAt(0),l.isUcChar(d))if(d=this.getByRef(f))void 0===h?d.parent&&d.parent.childList.remove(d):l.isObjectLiteral(h)?d.patch(h,b):h.isView?(h.ref=f,this.childList.replace(h,d)):this._throwError("Unexpected value for path: "+f);else{if(void 0!==h&&(d=b,l.isObjectLiteral(h)&&h.hasOwnProperty("__create")&&(d=h.__create),null!==d))if(!0===d){let a;l.isObjectLiteral(h)?(a=this.childList.createItem(h),a.patch(h,d)):l.isObject(h)&&
(a=h);a.isView&&(a.ref=f);this.childList.a(a)}else this._throwError("Can't find path: "+f)}else F.patchObjectProperty(this,f,h);else if(d=this.select(f),void 0===h)for(let a=0,b=d.length;a<b;a++)d[a].parent&&d[a].parent.childList.remove(d[a]);else if(l.isObjectLiteral(h))for(let a=0,c=d.length;a<c;a++)d[a].patch(h,b);else this._throwError("Unexpected value for path: "+f)}}_throwError(a){throw Error(this.constructor.name+" ("+this.getLocationString()+"): "+a);}animation(a){return this.stage.animations.createAnimation(this,
a)}transition(a,b){if(void 0===b)return this._getTransition(a);this._setTransition(a,b);return null}set transitions(a){a=this.stage.preparePatchSettings(a);Object.keys(a).forEach((b)=>{this.transition(b,a[b])})}set smooth(a){a=this.stage.preparePatchSettings(a);Object.keys(a).forEach((b)=>{let c=a[b];Array.isArray(c)?this.setSmooth(b,c[0],c[1]):this.setSmooth(b,c)})}fastForward(a){this._transitions&&(a=this._transitions[a])&&a.isTransition&&a.finish()}_getTransition(a){this._transitions||(this._transitions=
{});let b=this._transitions[a];b?b.isTransitionSettings&&(b=new S(this.stage.transitions,b,this,a)):b=new S(this.stage.transitions,this.stage.transitions.defaultTransitionSettings,this,a);return this._transitions[a]=b}_setTransition(a,b){if(b){l.isObjectLiteral(b)&&(b=this.stage.transitions.createSettings(b));this._transitions||(this._transitions={});let c=this._transitions[a];if(c&&c.isTransition)return c.settings=b,c;this._transitions[a]=b}else this._removeTransition(a)}_removeTransition(a){this._transitions&&
delete this._transitions[a]}getSmooth(a,b){return(a=this._getTransition(a))&&a.isAttached()?a.targetValue:b}setSmooth(a,b,c){c&&this._setTransition(a,c);a=this._getTransition(a);a.start(b);return a}static isColorProperty(a){return 0<=a.indexOf("color")}static getMerger(a){return r.isColorProperty(a)?q.mergeColors:q.mergeNumbers}}v.addAsMixin(r);r.prototype.isView=1;r.id=1;r.PROP_GETTERS=new Map;r.PROP_SETTERS=new Map;class x extends r{constructor(a,b){super(a);this.tagRoot=!0;l.isObjectLiteral(b)&&
Object.assign(this,b);this.__state="";this.__firstEnable=this.__firstActive=this.__initialized=!1;this.__passSignals=this.__signals=void 0;this.__construct();a=this.constructor.getTemplateFunc(a);a.f(this,a.a)}static getTemplateFunc(a){a=a.getPatchId();const b="_templateFunc_"+a,c="__has"+b;this[c]!==this&&(this[c]=this,this[b]=this.parseTemplate(a?"_$"+a:a,this._template()));return this[b]}static parseTemplate(a,b){const c={patchId:a,loc:[],store:[],rid:0};b=F._preparePatchSettings(b,a);this.parseTemplateRec(b,
c,"view");a=c.loc.join(";\n");return{f:new Function("view","store",a),a:c.store}}static parseTemplateRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((f)=>{let g=a[f];if(l.isUcChar(f.charCodeAt(0)))if(l.isObjectLiteral(g)){g=F._preparePatchSettings(g,b.patchId);var h=`r${f.replace(/[^a-z0-9]/gi,"")+b.rid}`,k=g.type?g.type:r;"View"===k?e.push(`const ${h} = view.stage.createView()`):(d.push(k),e.push(`const ${h} = new store[${d.length-1}](${c}.stage)`));e.push(`${h}.ref = "${f}"`);b.rid++;
this.parseTemplateRec(g,b,h);e.push(`${c}.childList.add(${h})`)}else l.isObject(g)&&(d.push(g),e.push(`${c}.childList.add(store[${d.length-1}])`));else"text"===f?(f=c+"__text",e.push(`${f} = ${c}.enableTextTexture()`),this.parseTemplatePropRec(g,b,f)):"texture"===f&&l.isObjectLiteral(g)?(h=c+"__texture",(k=g.type)?(d.push(k),e.push(`${h} = new store[${d.length-1}](${c}.stage)`),this.parseTemplatePropRec(g,b,h),e.push(`${c}["${f}"] = ${h}`)):(e.push(`${h} = ${c}.texture`),this.parseTemplatePropRec(g,
b,h))):l.isNumber(g)?e.push(`${c}["${f}"] = ${g}`):l.isBoolean(g)?e.push(`${c}["${f}"] = ${g?"true":"false"}`):l.isObject(g)||Array.isArray(g)?(d.push(g),e.push(`${c}["${f}"] = store[${d.length-1}]`)):e.push(`${c}["${f}"] = ${JSON.stringify(g)}`)})}static parseTemplatePropRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((b)=>{if("type"!==b){const f=a[b];l.isNumber(f)?e.push(`${c}["${b}"] = ${f}`):l.isBoolean(f)?e.push(`${c}["${b}"] = ${f?"true":"false"}`):l.isObject(f)||Array.isArray(f)?
...
this.quadTextures[a];return b.h?b.h:this.quadViews[a]._displayedTextureSource.h}}class Ja extends la{constructor(a){super(a);a=a.stage.getOption("bufferMemory");this.dataLength=0;this.data=new ArrayBuffer(a);this.floats=new Float32Array(this.data);this.uints=new Uint32Array(this.data);a=this.floats;let b=this.uints;a[0]=-1;a[1]=-1;a[2]=0;a[3]=0;b[4]=4294967295;a[5]=1;a[6]=-1;a[7]=1;a[8]=0;b[9]=4294967295;a[10]=1;a[11]=1;a[12]=1;a[13]=1;b[14]=4294967295;a[15]=-1;a[16]=1;a[17]=0;a[18]=1;b[19]=4294967295}getAttribsDataByteOffset(a){return 80*
...
w.fragmentShaderSource="\n    #ifdef GL_ES\n    precision lowp float;\n    #endif\n    varying vec2 vTextureCoord;\n    varying vec4 vColor;\n    uniform sampler2D uSampler;\n    void main(void){\n        gl_FragColor = texture2D(uSampler, vTextureCoord) * vColor;\n    }\n";class pa{constructor(a){this.stage=a;this._defaultShader=void 0}gc(a){}destroy(){}getDefaultShader(a=this.stage.ctx){this._defaultShader||(this._defaultShader=this._createDefaultShader(a));return this._defaultShader}_createDefaultShader(a){}isValidShaderType(a){return a.prototype instanceof
this._getShaderBaseType()}createShader(a,b){const c=b.type||DefaultShader;if(this.isValidShaderType(c))return a=new c(a),this.stage.patchObject(this,b),a;b=this._getShaderAlternative(c);return b?new b(a):(console.warn("Shader has no implementation for render target: "+c.name),this._createDefaultShader(a))}_getShaderBaseType(){}_getShaderAlternative(a){return this.getDefaultShader()}getPatchId(){}copyRenderTexture(a,b,c){console.warn("copyRenderTexture not supported by renderer")}}class Na extends pa{constructor(a){super(a);
this.shaderPrograms=new Map}destroy(){this.shaderPrograms.forEach((a)=>a.destroy())}_createDefaultShader(a){return new w(a)}_getShaderBaseType(){return T}_getShaderAlternative(a){return a.getWebGL&&a.getWebGL()}createCoreQuadList(a){return new Ja(a)}createCoreQuadOperation(a,b,c,d,e,f){return new Ka(a,b,c,d,e,f)}createCoreRenderExecutor(a){return new La(a)}createCoreRenderState(a){return new oa(a)}createRenderTexture(a,b,c,d){const e=this.stage.gl,f=e.createTexture();e.bindTexture(e.TEXTURE_2D,f);
...
a=a.quads.uints;const f=q.mergeColorAlpha;if(0!==c.tb||0!==c.tc)e[d++]=c.px,e[d++]=c.py,e[d++]=b._ulx,e[d++]=b._uly,a[d++]=f(b._colorUl,c.alpha),e[d++]=c.px+b._lw*c.ta,e[d++]=c.py+b._lw*c.tc,e[d++]=b._brx,e[d++]=b._uly,a[d++]=f(b._colorUr,c.alpha),e[d++]=c.px+b._lw*c.ta+b._lh*c.tb,e[d++]=c.py+b._lw*c.tc+b._lh*c.td,e[d++]=b._brx,e[d++]=b._bry,a[d++]=f(b._colorBr,c.alpha),e[d++]=c.px+b._lh*c.tb,e[d++]=c.py+b._lh*c.td;else{let g=c.px+b._lw*c.ta,h=c.py+b._lh*c.td;e[d++]=c.px;e[d++]=c.py;e[d++]=b._ulx;
...
{premultiplyAlpha:"premultiply",colorSpaceConversion:"none",imageOrientation:"none"}).then((a)=>{this.finish({imageBitmap:a,hasAlphaChannel:this._hasAlphaChannel()})}).catch((a)=>{this.error({type:"parse",message:"Error parsing image data"})})}_hasAlphaChannel(){return!0}cancel(){this._canceled||(this._xhr&&this._xhr.abort(),this._canceled=!0)}error(a,b){!this._canceled&&this._onError&&this._onError({type:a,message:b})}finish(a){!this._canceled&&this._onFinish&&this._onFinish(a)}}new a};class Wa{init(a){this.stage=
a;this._awaitingLoop=this._looping=!1;this.stage.getOption("useImageWorker")&&(window.createImageBitmap&&window.Worker?this._imageWorker=new Ta:console.warn("Can't use image worker because browser does not have createImageBitmap and Web Worker support"))}startLoop(){this._looping=!0;this._awaitingLoop||this.loop()}stopLoop(){this._looping=!1}loop(){let a=this,b=function(){a._awaitingLoop=!1;a._looping&&(a.stage.drawFrame(),requestAnimationFrame(b),a._awaitingLoop=!0)};requestAnimationFrame(b)}uploadGlTexture(a,
...
{};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Xa{static load(a){return Wa}}class E{static isFunction(a){return"function"===typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===a||!1===a}static isString(a){return"string"==typeof a}static isObject(a){let b=typeof a;return!!a&&("object"==b||"function"==b)}static isPlainObject(a){return!!a&&
"object"==typeof a}static isObjectLiteral(a){return"object"===typeof a&&a&&a.constructor===Object}static getArrayIndex(a,b){return E.getModuloIndex(a,b.length)}static equalValues(a,b){return typeof a!==typeof b?!1:E.isObjectLiteral(a)?E.isObjectLiteral(b)&&E.equalObjectLiterals(a,b):Array.isArray(a)?Array.isArray(b)&&E.equalArrays(a,b):a===b}static equalObjectLiterals(a,b){let c=Object.keys(a),d=Object.keys(b);if(c.length!==d.length)return!1;for(let e=0,f=c.length;e<f;e++){const f=c[e],h=d[e];if(f!==
h||!E.equalValues(a[f],b[h]))return!1}return!0}static equalArrays(a,b){if(a.length!==b.length)return!1;for(let c=0,d=a.length;c<d;c++)if(!this.equalValues(a[c],b[c]))return!1;return!0}}class G{constructor(a,b){this._id=a;this._gl=b;this._program=void 0;this._buffers=new Map;this._framebuffers=new Map;this._renderbuffers=new Map;this._vertexAttribs=Array(16);this._nonDefaultFlags=new Set;this._settings=new Map;this._textures=Array(8);this._maxTexture=0;this._activeTexture=b.TEXTURE0;this._pixelStorei=
...
d;c++)if(a._pixelStorei[c]!==b._pixelStorei[c]){const a=void 0!==b._pixelStorei[c]?b._pixelStorei[c]:G._getDefaultPixelStoreiByIndex(c);this._gl._pixelStorei(G._getPixelStoreiByIndex(c),a)}}_migrateTextures(a,b){const c=Math.max(a._maxTexture,b._maxTexture);let d=a._activeTexture;for(let f=0;f<c;f++){const c=b._textures[f];var e=a._textures[f];const h=G._getTextureByIndex(f);e=Math.max(e?e.length:0,c?c.length:0);for(let a=0,b=e;a<b;a++)e=G._getTextureTargetByIndex(a),d!==h&&(this._gl._activeTexture(h),
...
{b._vertexAttribs[c]||this._gl._disableVertexAttribArray(c)}),b._vertexAttribs.forEach((a,b)=>{this._gl._vertexAttribPointer(b,a[0],a[1],a[2],a[4]);a[5]?this._gl._enableVertexAttribArray(b):this._gl._disableVertexAttribArray(b)}))}_migrateSettings(a,b){const c=this.constructor.getDefaultSettings();a._settings.forEach((a,e)=>{a=e.name||e.xname;b._settings.has(e)||(a=c.get(a),E.isFunction(a)&&(a=a(this._gl)),b._settings.set(e,a),e.apply(this._gl,a))});b._settings.forEach((b,c)=>{const d=a._settings.get(c);
d&&E.equalValues(d,b)||c.apply(this._gl,b)})}_migrateFlags(a,b){a._nonDefaultFlags.forEach((a)=>{b._nonDefaultFlags.has(a)||(this._getDefaultFlag(a)?this._gl._enable(a):this._gl._disable(a))});b._nonDefaultFlags.forEach((b)=>{a._nonDefaultFlags.has(b)||(this._getDefaultFlag(b)?this._gl._disable(b):this._gl._enable(b))})}static getDefaultSettings(){if(!this._defaultSettings){const a=this._defaultSettings=new Map,b=WebGLRenderingContext.prototype;a.set("viewport",function(a){return[0,0,a.canvas.width,
...
1)),this._nativeFreeTextureSource(a));a.loadingSince=null;this.removeFromLookupMap(a)}_nativeUploadTextureSource(a,b){return this.stage.renderer.uploadTextureSource(a,b)}_nativeFreeTextureSource(a){this.stage.renderer.freeTextureSource(a);a.clearNativeTexture()}}class Za{constructor(a){this.stage=a;this.root=null;this.updateTreeOrder=0;this.renderState=this.stage.renderer.createCoreRenderState(this);this.renderExec=this.stage.renderer.createCoreRenderExecutor(this);this.renderExec.init();this._usedMemory=
...
0;this.render();return!0}layout(){this.root.layout()}update(){this.updateTreeOrder=0;this.root.update()}render(){this.renderState.reset();this.root.render();this.renderState.finish();this.renderExec.execute()}_addMemoryUsage(a){this._usedMemory+=a;this.stage.addMemoryUsage(a)}allocateRenderTexture(a,b){let c=this.stage.getRenderPrecision(),d=Math.max(1,Math.round(a*c)),e=Math.max(1,Math.round(b*c));var f=this._renderTexturePool.length;for(--f;0<=f;f--){const a=this._renderTexturePool[f];if(a.w===
d&&a.h===e&&a.update!==this.stage.frameCounter)return a.f=this.stage.frameCounter,this._renderTexturePool.splice(f,1),a}a=this._createRenderTexture(a,b,d,e);a.precision=c;return a}releaseRenderTexture(a){this._renderTexturePool.push(a)}freeUnusedRenderTextures(a=60){let b=this.stage.frameCounter-a;this._renderTexturePool=this._renderTexturePool.filter((a)=>a.f<=b?(this._freeRenderTexture(a),!1):!0)}_createRenderTexture(a,b,c,d){this._addMemoryUsage(c*d);const e=this.stage.renderer.createRenderTexture(a,
b,c,d);e.id=this._renderTextureId++;e.f=this.stage.frameCounter;e.ow=a;e.oh=b;e.w=c;e.h=d;return e}_freeRenderTexture(a){this.stage.renderer.freeRenderTexture(a);this._addMemoryUsage(-a.w*a.h)}copyRenderTexture(a,b,c){this.stage.renderer.copyRenderTexture(a,b,c)}forceZSort(a){this._zSorts.push(a)}}class V{constructor(a){this.stage=a;this._timingFunction="ease";this._timingFunctionImpl=q.getTimingFunction(this._timingFunction);this.delay=0;this.duration=.2;this.merger=null}get timingFunction(){return this._timingFunction}set timingFunction(a){this._timingFunction=
a;this._timingFunctionImpl=q.getTimingFunction(a)}get timingFunctionImpl(){return this._timingFunctionImpl}patch(a){this.stage.patchObject(this,a)}}V.prototype.isTransitionSettings=!0;class $a{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set;this.defaultTransitionSettings=new V(this.stage)}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.progress(a);c.isRunning()||(b=!0)});b&&(this.active=new Set([...this.active].filter((a)=>
a.isRunning())))}}createSettings(a){let b=new V(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}removeActive(a){this.active.delete(a)}}class t{constructor(){this._clear()}_clear(){this._p=[];this._pe=[];this._idp=[];this._f=[];this._v=[];this._lv=[];this._sm=[];this._s=[];this._ve=[];this._sme=[];this._se=[];this._length=0}parse(a,b){l.isObjectLiteral(b)||(b={0:b});let c=.5,d=[];for(g in b)if(b.hasOwnProperty(g)){var e=b[g];l.isObjectLiteral(e)||(e={v:e});var f=parseFloat(g);"sm"===
...
void 0;this.properties=a}set p(a){this.properties=a}patch(a){this.animationSettings.stage.patchObject(this,a)}hasColorProperty(){void 0===this._hasColorProperty&&(this._hasColorProperty=this._props.length?r.isColorProperty(this._props[0]):!1);return this._hasColorProperty}}ra.prototype.isAnimationActionSettings=!0;class y{constructor(a){this.stage=a;this._actions=[];this.delay=0;this.duration=1;this.repeatDelay=this.repeatOffset=this.repeat=0;this.autostop=!1;this.stopMethod=y.STOP_METHODS.FADE;this._stopTimingFunction=
...
this._settings.duration*60)}get settings(){return this._settings}}n.STATES={IDLE:0,PLAYING:1,STOPPING:2,STOPPED:3,FINISHED:4,PAUSED:5};class ab{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.isActive()?c.progress(a):b=!0});b&&(this.active=new Set([...this.active].filter((a)=>a.isActive())))}}createAnimation(a,b){l.isObjectLiteral(b)&&(b=this.createSettings(b));
return new n(this,b,a)}createSettings(a){const b=new y(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}}class sa extends A{_getLookupId(){return"__whitepix"}_getSourceLoader(){return function(a){var b=new Uint8Array([255,255,255,255]);a(null,{source:b,w:1,h:1,permanent:!0})}}}class W extends v{constructor(a={}){super();this._setOptions(a);this._lastGcFrame=this._usedMemory=0;this.platform=new (Xa.load(a));this.platform.init&&this.platform.init(this);this.c2d=this.gl=void 0;(a=this.getOption("context"))?
a.useProgram?this.gl=a:this.c2d=a:!l.isWeb||W.isWebglSupported()&&!this.getOption("canvas2d")?this.gl=this.platform.createWebGLContext(this.getOption("w"),this.getOption("h")):this.c2d=this.platform.createCanvasContext(this.getOption("w"),this.getOption("h"));this.gl&&O.enable(this.gl,"lightning");this._mode=this.gl?0:1;this.getCanvas()&&(this._options.w=this.getCanvas().width,this._options.h=this.getCanvas().height);this._renderer=0===this._mode?new Na(this):new Sa(this);this.setClearColor(this.getOption("clearColor"));
this.frameCounter=0;this.transitions=new $a(this);this.animations=new ab(this);this.textureManager=new Ya(this);this._destroyed=!1;this.dt=this.currentTime=this.startTime=0;this.rectangleTexture=new sa(this);this.rectangleTexture.load();this.rectangleTexture.source.permanent=!0;this.ctx=new Za(this);this._updateSourceTextures=new Set}get renderer(){return this._renderer}static isWebglSupported(){if(l.isNode)return!0;try{return!!window.WebGLRenderingContext}catch(a){return!1}}get mode(){return this._mode}isWebgl(){return 0===
...
null===a||void 0===a?this._clearColor=void 0:Array.isArray(a)?this._clearColor=a:this._clearColor=q.getRgbaComponentsNormalized(a)}getClearColor(){return this._clearColor}createView(a){return a?this.view(a):new r(this)}createShader(a){return M.create(this,a)}view(a){if(a.isView)return a;let b;b=a.type?new a.type(this):new r(this);b.patch(a,!0);return b}c(a){return this.view(a)}get w(){return this._options.w}get h(){return this._options.h}get rw(){return this.w/this._options.precision}get rh(){return this.h/
...
!0):this.textureManager.freeUnusedTextureSources()}gcRenderTextureMemory(a=!1){a&&this.root.visible?(this.root.visible=!1,this.ctx.freeUnusedRenderTextures(0),this.root.visible=!0):this.ctx.freeUnusedRenderTextures(0)}getDrawingCanvas(){return this.platform.getDrawingCanvas()}preparePatchSettings(a){return F.preparePatchSettings(a,this.getPatchId())}patchObject(a,b){b=F.preparePatchSettings(b,this.getPatchId());F.patchObject(a,b)}getPatchId(){return this.renderer.getPatchId()}}class B{constructor(){this._fireLevel=
...
this._logPrefix.length-1)),a;this._fireLevel--;this.debug&&(this._logPrefix=this._logPrefix.substr(0,this._logPrefix.length-1))}}static _executeAction(a,b,c){let d;a.a&&(d=a.a.call(b,c));void 0===d&&(d=a.s);return d}static _getSuperState(a,b){return 0===b?a:a.split(".").slice(0,-b).join(".")}static _compareStatePaths(a,b){a=a.reverse();b=b.reverse();const c=Math.min(a.length,b.length);let d;for(d=0;d<c&&a[d]===b[d];d++);return{exit:a.slice(d),enter:b.slice(d)}}}class H extends x{constructor(a={},
b){H._temp_options=a;H.booting=!0;super(new W(a.stage),b);H.booting=!1;this.stage.init();this.updateFocusSettings();(this.__keymap=this.getOption("keys"))&&this.stage.platform.registerKeyHandler((a)=>{this._receiveKeydown(a)})}getOption(a){return this.__options[a]}_setOptions(a){this.__options={};let b=(b,d)=>{let c=a[b];this.__options[b]=void 0===c?d:c};b("debug",!1);b("keys",{})}__construct(){this.stage.setApplication(this);this._setOptions(H._temp_options);delete H._temp_options;this.stateManager=
new B;this.stateManager.debug=this.__options.debug;super.__construct()}__init(){super.__init();this.__updateFocus()}updateFocusPath(){this.__updateFocus()}__updateFocus(){this.__updateFocusRec()&&this._handleFocusSettings!==H.prototype._handleFocusSettings&&(H.booting||this.updateFocusSettings())}__updateFocusRec(a=100){var b=this.__getFocusPath();const c=b[b.length-1],d=this._focusPath?this._focusPath[this._focusPath.length-1]:void 0;if(d){var e=Math.min(this._focusPath.length,b.length);let f;for(f=
...
"fixed",this._preloadArea.style.display="block",this._preloadArea.style.top="100vh",this._preloadArea.style.overflow="hidden",document.body.appendChild(this._preloadArea));return this._preloadArea}}class bb extends A{constructor(a,b){super(a);this._options=b}set options(a){this._options!==a&&(this._options=a,this._changed())}get options(){return this._options}_getIsValid(){return!!this._options}_getSourceLoader(){return(a)=>{a(null,this._options)}}}class cb extends x{constructor(a){super(a);this._wrapper=
super._children.a({});this._reloadVisibleElements=!1;this._visibleItems=new Set;this._index=0;this._started=!1;this._scrollTransitionSettings=this.stage.transitions.createSettings({});this._itemSize=100;this._itemScrollOffset=this._viewportScrollOffset=0;this._roll=!1;this._rollMax=this._rollMin=0;this._progressAnimation=null;this._invertDirection=!1;this._horizontal=!0;this.itemList=new db(this)}_allowChildrenAccess(){return!1}get items(){return this.itemList.get()}set items(a){this.itemList.patch(a)}start(){this._wrapper.transition(this.property,
...
class Ca extends x{static _template(){const a=function(a,c){if(c._recalc&130){a=c.rw;const b=c.rh;do c=c._children[0],c._view.w=a,c._view.h=b;while(c._children)}};return{Textwrap:{rtt:!0,forceZIndexContext:!0,renderOffscreen:!0,BloomBase:{shader:{type:Da},Content:{}}},Layers:{L0:{rtt:!0,onUpdate:a,scale:2,pivot:0,visible:!1,Content:{shader:{type:C}}},L1:{rtt:!0,onUpdate:a,scale:4,pivot:0,visible:!1,Content:{shader:{type:C}}},L2:{rtt:!0,onUpdate:a,scale:8,pivot:0,visible:!1,Content:{shader:{type:C}}},
...
this._strength=.5;this._fudge=.4;this._z=this._ry=this._rx=0;this._pivotY=this._pivotX=NaN;this._lightZ=this._lightY=this._pivotZ=0}setupUniforms(a){super.setupUniforms(a);a=a.shaderOwner;var b=a.view,c=isNaN(this._pivotX)?b.pivotX*a.lw:this._pivotX;b=isNaN(this._pivotY)?b.pivotY*a.lh:this._pivotY;c=a.getRenderTextureCoords(c,b);a=-Math.atan2(a._renderContext.tc,a._renderContext.ta);b=this.gl;this._setUniform("pivot",new Float32Array([c[0],c[1],this._pivotZ]),b.uniform3fv);this._setUniform("rot",
...
return{Application:H,Component:x,Base:F,Utils:l,StageUtils:q,View:r,Tools:P,Stage:W,ViewCore:L,ViewTexturizer:ia,Texture:A,EventEmitter:v,shaders:{Grayscale:Z,BoxBlur:C,Dithering:aa,CircularPush:ba,Inversion:Fa,LinearBlur:Q,Outline:ca,Pixelate:da,RadialFilter:ea,RadialGradient:fa,Light3d:ha,WebGLShader:T,WebGLDefaultShader:w,C2dShader:U,C2dDefaultShader:N,c2d:{Grayscale:Ea,Blur:za}},textures:{RectangleTexture:sa,NoiseTexture:xa,TextTexture:J,ImageTexture:R,HtmlTexture:ya,StaticTexture:bb,StaticCanvasTexture:ta,
SourceTexture:ja},components:{FastBlurComponent:eb,BloomComponent:Ca,SmoothScaleComponent:Y,BorderComponent:fb,ListComponent:cb},tools:{ObjMerger:ua,ObjectListProxy:va,ObjectListWrapper:wa}}}();
