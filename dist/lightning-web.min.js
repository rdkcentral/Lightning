...
c;a++)this._zIndexedChildren[a].render();else for(let a=0,c=this._children.length;a<c;a++)0===this._children[a]._zIndex&&this._children[a].render()}}_renderAdvanced(){var a=this._hasRenderUpdates;this._hasRenderUpdates=0;this._zSort&&this.sortZIndexedChildren();if(2>this._outOfBounds&&this._renderContext.alpha){let c=this.renderState;var b=!0;let d,e;if(this._useRenderToTexture){if(0===this._rw||0===this._rh)return;if(!this._texturizer.hasRenderTexture()||3<=a){c.setShader(c.defaultShader,this);e=
c.renderTextureInfo;d={nativeTexture:null,offset:0,w:this._rw,h:this._rh,empty:!0,cleared:!1,ignore:!1,cache:!1};if(this._texturizer.hasResultTexture()||!c.isCachingTexturizer&&3>a)d.cache=!0,c.isCachingTexturizer=!0;this._texturizer.hasResultTexture()||this._texturizer.releaseRenderTexture();c.setRenderTextureInfo(d);c.setScissor(void 0);this._displayedTextureSource&&(a=this._renderContext,this._renderContext=H.IDENTITY,this.renderState.addQuad(this),this._renderContext=a)}else b=!1}else 0===this._outOfBounds&&
...
b,h=this._settings.w*b;const k=this._settings.h*b;var m=this._settings.wordWrapWidth*b;const l=this._settings.cutSx*b;var E=this._settings.cutEx*b;const n=this._settings.cutSy*b;var p=this._settings.cutEy*b;this.setFontProperties();var r=h||2048/this.getPrecision(),u=r-c;10>u&&(r+=10-u,u+=10-u);m||(m=u);if(this._settings.wordWrap)var v=this.wrapText(this._settings.text,m);else{v={l:this._settings.text.split(/(?:\r\n|\r|\n)/),n:[]};var w=v.l.length;for(var x=0;x<w-1;x++)v.n.push(x)}w=v.l;if(this._settings.maxLines&&
...
!1,a.remainingText="";x=0;v=[];for(m=0;m<w.length;m++)y=this._context.measureText(w[m]).width,v.push(y),x=Math.max(x,y);a.lineWidths=v;h||(r=x+c+d,u=x);g=g||e;h=k?k:g*(w.length-1)+.5*e+Math.max(g,e)+f;null===f&&(f=e);a.w=r;a.h=h;a.lines=w;a.precision=b;r||(r=1);h||(h=1);if(l||E)r=Math.min(r,E-l);if(n||p)h=Math.min(h,p-n);this._canvas.width=Math.ceil(r+this._stage.getOption("textRenderIssueMargin"));this._canvas.height=Math.ceil(h);this.setFontProperties();128<=e&&(this._context.globalAlpha=.01,this._context.fillRect(0,
0,.01,.01),this._context.globalAlpha=1);(l||n)&&this._context.translate(-l,-n);E=[];for(let a=0,b=w.length;a<b;a++)p=0,r=a*g+f,"right"===this._settings.textAlign?p+=u-v[a]:"center"===this._settings.textAlign&&(p+=(u-v[a])/2),p+=c,E.push({text:w[a],x:p,y:r,w:v[a]});if(this._settings.highlight)for(f=this._settings.highlightHeight*b||1.5*e,e=null!==this._settings.highlightOffset?this._settings.highlightOffset*b:-.5*e,c=null!==this._settings.highlightPaddingLeft?this._settings.highlightPaddingLeft*b:
c,d=null!==this._settings.highlightPaddingRight?this._settings.highlightPaddingRight*b:d,this._context.fillStyle=q.getRgbaString(this._settings.highlightColor||0),g=0;g<E.length;g++)u=E[g],this._context.fillRect(u.x-c,u.y+e,u.w+d+c,f);d=null;this._settings.shadow&&(d=[this._context.shadowColor,this._context.shadowOffsetX,this._context.shadowOffsetY,this._context.shadowBlur],this._context.shadowColor=q.getRgbaString(this._settings.shadowColor),this._context.shadowOffsetX=this._settings.shadowOffsetX*
b,this._context.shadowOffsetY=this._settings.shadowOffsetY*b,this._context.shadowBlur=this._settings.shadowBlur*b);this._context.fillStyle=q.getRgbaString(this._settings.textColor);for(let a=0,c=E.length;a<c;a++)b=E[a],this._context.fillText(b.text,b.x,b.y);d&&(this._context.shadowColor=d[0],this._context.shadowOffsetX=d[1],this._context.shadowOffsetY=d[2],this._context.shadowBlur=d[3]);(l||n)&&this._context.translate(l,n);this.renderInfo=a}wrapText(a,b){a=a.split(/\r?\n/g);let c=[],d=[];for(let e=
0;e<a.length;e++){let f=[],g="",h=b,k=a[e].split(" ");for(let a=0;a<k.length;a++){let c=this._context.measureText(k[a]).width,d=c+this._context.measureText(" ").width;0===a||d>h?(0<a&&(f.push(g),g=""),g+=k[a],h=b-c):(h-=d,g+=" "+k[a])}g&&f.push(g);c=c.concat(f);e<a.length-1&&d.push(c.length)}return{l:c,n:d}}}class I extends z{constructor(a){super(a);this._precision=this.stage.getOption("precision")}get text(){return this._text}set text(a){this._text!==a&&(this._text=""+a,this._changed())}get w(){return this._w}set w(a){this._w!==
...
4278190080;p._highlightOffset=0;p._highlightPaddingLeft=0;p._highlightPaddingRight=0;p._cutSx=0;p._cutEx=0;p._cutSy=0;p._cutEy=0;class ia extends z{constructor(a){super(a);this._textureSource=void 0}get textureSource(){return this._textureSource}set textureSource(a){a!==this._textureSource&&(a.isResultTexture&&(this._precision=this.stage.getRenderPrecision()),this._textureSource=a,this._changed())}_getTextureSource(){return this._textureSource}}class R extends v{constructor(a,b,c,d){super();this.manager=
...
this.stage.rectangleTexture}set rect(a){this.texture=a?this.stage.rectangleTexture:null}enableTextTexture(){this.texture&&this.texture instanceof I||(this.texture=new I(this.stage),this.texture.w||this.texture.h||(this.texture.w=this.w,this.texture.h=this.h));return this.texture}get text(){if(this.texture&&this.texture instanceof I)return this.texture}set text(a){this.texture&&this.texture instanceof I||this.enableTextTexture();l.isString(a)?this.texture.text=a:this.texture.patch(a)}set onUpdate(a){this.__core.onUpdate=
a}set onAfterCalcs(a){this.__core.onAfterCalcs=a}set onAfterUpdate(a){this.__core.onAfterUpdate=a}forceUpdate(){this.__core._setHasUpdates()}get shader(){return this.__core.shader}set shader(a){if(a=L.create(this.stage,a))this.__enabled&&this.__core.shader&&this.__core.shader.removeView(this),this.__core.shader=a,this.__enabled&&this.__core.shader&&this.__core.shader.addView(this)}_hasTexturizer(){return!!this.__core._texturizer}get renderToTexture(){return this.rtt}set renderToTexture(a){this.rtt=
...
{});let c=this._transitions[a];if(c&&c.isTransition)return c.settings=b,c;this._transitions[a]=b}else this._removeTransition(a)}_removeTransition(a){this._transitions&&delete this._transitions[a]}getSmooth(a,b){return(a=this._getTransition(a))&&a.isAttached()?a.targetValue:b}setSmooth(a,b,c){c&&this._setTransition(a,c);a=this._getTransition(a);a.start(b);return a}static isColorProperty(a){return 0<=a.indexOf("color")}static getMerger(a){return r.isColorProperty(a)?q.mergeColors:q.mergeNumbers}}v.addAsMixin(r);
r.prototype.isView=1;r.id=1;r.PROP_GETTERS=new Map;r.PROP_SETTERS=new Map;class x extends r{constructor(a,b){super(a);this.tagRoot=!0;l.isObjectLiteral(b)&&Object.assign(this,b);this.__state="";this.__firstEnable=this.__firstActive=this.__initialized=!1;this.__passSignals=this.__signals=void 0;this.__construct();a=this.constructor.getTemplateFunc(a);a.f(this,a.a)}static getTemplateFunc(a){a=a.getPatchId();const b="_templateFunc_"+a,c="__has"+b;this[c]!==this&&(this[c]=this,this[b]=this.parseTemplate(a?
"_$"+a:a,this._template()));return this[b]}static parseTemplate(a,b){const c={patchId:a,loc:[],store:[],rid:0};b=D._preparePatchSettings(b,a);this.parseTemplateRec(b,c,"view");a=c.loc.join(";\n");return{f:new Function("view","store",a),a:c.store}}static parseTemplateRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((f)=>{let g=a[f];if(l.isUcChar(f.charCodeAt(0)))if(l.isObjectLiteral(g)){g=D._preparePatchSettings(g,b.patchId);var h=`r${f.replace(/[^a-z0-9]/gi,"")+b.rid}`,k=g.type?g.type:r;
"View"===k?e.push(`const ${h} = view.stage.createView()`):(d.push(k),e.push(`const ${h} = new store[${d.length-1}](${c}.stage)`));e.push(`${h}.ref = "${f}"`);b.rid++;this.parseTemplateRec(g,b,h);e.push(`${c}.childList.add(${h})`)}else l.isObject(g)&&(d.push(g),e.push(`${c}.childList.add(store[${d.length-1}])`));else"text"===f?(f=c+"__text",e.push(`${f} = ${c}.enableTextTexture()`),this.parseTemplatePropRec(g,b,f)):"texture"===f&&l.isObjectLiteral(g)?(h=c+"__texture",(k=g.type)?(d.push(k),e.push(`${h} = new store[${d.length-
...
a}_clearRenderTexture(a){}_setScissor(a){}}class Ja extends ma{constructor(a){super(a);this.gl=this.ctx.stage.gl;this.init()}init(){let a=this.gl;this._attribsBuffer=a.createBuffer();let b=Math.floor(this.renderState.quads.data.byteLength/80),c=new Uint16Array(6*b);for(let a=0,e=0;a<b;a+=6,e+=4)c[a]=e,c[a+1]=e+1,c[a+2]=e+2,c[a+3]=e,c[a+4]=e+2,c[a+5]=e+3;this._quadsBuffer=a.createBuffer();a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this._quadsBuffer);a.bufferData(a.ELEMENT_ARRAY_BUFFER,c,a.STATIC_DRAW);this._projection=
new Float32Array([2/this.ctx.stage.rw,-2/this.ctx.stage.rh])}destroy(){super.destroy();this.gl.deleteBuffer(this._attribsBuffer);this.gl.deleteBuffer(this._quadsBuffer)}_reset(){super._reset();let a=this.gl;a.blendFunc(a.ONE,a.ONE_MINUS_SRC_ALPHA);a.enable(a.BLEND);a.disable(a.DEPTH_TEST);this._stopShaderProgram();this._setupBuffers()}_setupBuffers(){let a=this.gl;a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this._quadsBuffer);let b=new DataView(this.renderState.quads.data,0,this.renderState.quads.dataLength);
...
else{let b=this.ctx.stage.getClearColor();b&&(a.clearColor(b[0]*b[3],b[1]*b[3],b[2]*b[3],b[3]),a.clear(a.COLOR_BUFFER_BIT))}}_setScissor(a){super._setScissor(a);if(this._scissor!==a){this._scissor=a;var b=this.gl;if(a){b.enable(b.SCISSOR_TEST);let c=this.ctx.stage.getRenderPrecision(),d=a[1];null===this._renderTexture&&(d=this.ctx.stage.h/c-(a[1]+a[3]));b.scissor(Math.round(a[0]*c),Math.round(d*c),Math.round(a[2]*c),Math.round(a[3]*c))}else b.disable(b.SCISSOR_TEST)}}}class na{constructor(a){this.ctx=
...
b?this.modes[a]|2:this.modes[a]-(this.modes[a]&2)}getRenderContext(a){return this.renderContexts[a]}getSimpleTc(a){return this.modes[a]&1}getWhite(a){return this.modes[a]&2}}class Na extends la{getRenderContext(a){return this.quads.getRenderContext(this.index+a)}getSimpleTc(a){return this.quads.getSimpleTc(this.index+a)}getWhite(a){return this.quads.getWhite(this.index+a)}}class pa extends ma{init(){this._mainRenderTexture=this.ctx.stage.getCanvas()}_renderQuadOperation(a){let b=a.shader;if(a.length||
...
a}}static _equalScissorAreas(a,b,c){b||(b=[0,0,a.width,a.height]);c||(c=[0,0,a.width,a.height]);return l.equalValues(b,c)}}class T extends L{beforeDraw(a){}draw(a){}afterDraw(a){}}class M extends T{constructor(a){super(a);this._rectangleTexture=a.stage.rectangleTexture.source.nativeTexture;this._tintManager=this.ctx.stage.renderer.tintManager}draw(a,b){const c=b.ctx;let d=a.length;for(let l=0;l<d;l++){var e=a.getTexture(l);const d=a.getViewCore(l);var f=a.getRenderContext(l),g=a.getWhite(l),h=a.getSimpleTc(l),
k=this.ctx.stage.getRenderPrecision();c.setTransform(f.ta*k,f.tc*k,f.tb*k,f.td*k,f.px*k,f.py*k);var m=e===this._rectangleTexture;k={operation:a,target:b,index:l,rect:m};if(m)g?c.fillStyle="white":this._setColorGradient(c,d),c.globalAlpha=f.alpha,this._beforeDrawEl(k),c.fillRect(0,0,d.rw,d.rh);else{c.globalAlpha=f.alpha;this._beforeDrawEl(k);f=h?0:d._ulx*e.w;m=h?0:d._uly*e.h;const a=(h?1:d._brx-d._ulx)*e.w;h=(h?1:d._bry-d._uly)*e.h;if(g)c.fillStyle="white",c.drawImage(e,f,m,a,h,0,0,d.rw,d.rh);else{g=
d._colorUl;if(d._colorUl!==d._colorUr||d._colorUr!==d._colorBl||d._colorBr!==d._colorBl)g=q.mergeMultiColorsEqual([d._colorUl,d._colorUr,d._colorBl,d._colorBr]);c.globalAlpha*=(g/16777216|0)/255;e=this._tintManager.getTintTexture(e,g&16777215);c.fillStyle="white";c.drawImage(e,f,m,a,h,0,0,d.rw,d.rh)}}this._afterDrawEl(k);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,g;b._colorUl===b._colorUr?b._colorBl===b._colorBr&&b._colorUl!==b.colorBl&&(g=a.createLinearGradient(0,
...
{};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Va{static load(a){return Ua}}class C{static isFunction(a){return"function"===typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===a||!1===a}static isString(a){return"string"==typeof a}static isObject(a){let b=typeof a;return!!a&&("object"==b||"function"==b)}static isPlainObject(a){return!!a&&
"object"==typeof a}static isObjectLiteral(a){return"object"===typeof a&&a&&a.constructor===Object}static getArrayIndex(a,b){return C.getModuloIndex(a,b.length)}static equalValues(a,b){return typeof a!==typeof b?!1:C.isObjectLiteral(a)?C.isObjectLiteral(b)&&C.equalObjectLiterals(a,b):Array.isArray(a)?Array.isArray(b)&&C.equalArrays(a,b):a===b}static equalObjectLiterals(a,b){let c=Object.keys(a),d=Object.keys(b);if(c.length!==d.length)return!1;for(let e=0,f=c.length;e<f;e++){const f=c[e],h=d[e];if(f!==
h||!C.equalValues(a[f],b[h]))return!1}return!0}static equalArrays(a,b){if(a.length!==b.length)return!1;for(let c=0,d=a.length;c<d;c++)if(!this.equalValues(a[c],b[c]))return!1;return!0}}class F{constructor(a,b){this._id=a;this._gl=b;this._program=void 0;this._buffers=new Map;this._framebuffers=new Map;this._renderbuffers=new Map;this._vertexAttribs=Array(16);this._nonDefaultFlags=new Set;this._settings=new Map;this._textures=Array(8);this._maxTexture=0;this._activeTexture=b.TEXTURE0;this._pixelStorei=
...
{b._vertexAttribs[c]||this._gl._disableVertexAttribArray(c)}),b._vertexAttribs.forEach((a,b)=>{this._gl._vertexAttribPointer(b,a[0],a[1],a[2],a[4]);a[5]?this._gl._enableVertexAttribArray(b):this._gl._disableVertexAttribArray(b)}))}_migrateSettings(a,b){const c=this.constructor.getDefaultSettings();a._settings.forEach((a,e)=>{a=e.name||e.xname;b._settings.has(e)||(a=c.get(a),C.isFunction(a)&&(a=a(this._gl)),b._settings.set(e,a),e.apply(this._gl,a))});b._settings.forEach((b,c)=>{const d=a._settings.get(c);
d&&C.equalValues(d,b)||c.apply(this._gl,b)})}_migrateFlags(a,b){a._nonDefaultFlags.forEach((a)=>{b._nonDefaultFlags.has(a)||(this._getDefaultFlag(a)?this._gl._enable(a):this._gl._disable(a))});b._nonDefaultFlags.forEach((b)=>{a._nonDefaultFlags.has(b)||(this._getDefaultFlag(b)?this._gl._disable(b):this._gl._enable(b))})}static getDefaultSettings(){if(!this._defaultSettings){const a=this._defaultSettings=new Map,b=WebGLRenderingContext.prototype;a.set("viewport",function(a){return[0,0,a.canvas.width,
...
a.isRunning())))}}createSettings(a){let b=new U(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}removeActive(a){this.active.delete(a)}}class u{constructor(){this._clear()}_clear(){this._p=[];this._pe=[];this._idp=[];this._f=[];this._v=[];this._lv=[];this._sm=[];this._s=[];this._ve=[];this._sme=[];this._se=[];this._length=0}parse(a,b){l.isObjectLiteral(b)||(b={0:b});let c=.5,d=[];for(g in b)if(b.hasOwnProperty(g)){var e=b[g];l.isObjectLiteral(e)||(e={v:e});var f=parseFloat(g);"sm"===
...
!0):this.textureManager.freeUnusedTextureSources()}gcRenderTextureMemory(a=!1){a&&this.root.visible?(this.root.visible=!1,this.ctx.freeUnusedRenderTextures(0),this.root.visible=!0):this.ctx.freeUnusedRenderTextures(0)}getDrawingCanvas(){return this.platform.getDrawingCanvas()}preparePatchSettings(a){return D.preparePatchSettings(a,this.getPatchId())}patchObject(a,b){b=D.preparePatchSettings(b,this.getPatchId());D.patchObject(a,b)}getPatchId(){return this.renderer.getPatchId()}}class A{constructor(){this._fireLevel=
...
b)||this.stage.application.focusBottomUpEvent("_handleKey",b)}destroy(){this.stage.root=void 0;this._updateAttachedFlag();this._updateEnabledFlag()}}class sa extends z{constructor(a){super(a);this._lookupId=this._factory=void 0}set content({factory:a,lookupId:b=void 0}){this._factory=a;this._lookupId=b;this._changed()}_getIsValid(){return!!this._factory}_getLookupId(){return this._lookupId}_getSourceLoader(){const a=this._factory;return(b)=>a((a,d)=>{if(a)return b(a);b(null,this.stage.platform.getTextureOptionsForDrawingCanvas(d))},
...
let m=.5*e+1,t=.5*e+1;k.moveTo(m+d[0],t);k.lineTo(m+b-d[1],t);k.arcTo(m+b,t,m+b,t+d[1],d[1]);k.lineTo(m+b,t+c-d[2]);k.arcTo(m+b,t+c,m+b-d[2],t+c,d[2]);k.lineTo(m+d[3],t+c);k.arcTo(m,t+c,m,t+c-d[3],d[3]);k.lineTo(m,t+d[0]);k.arcTo(m,t,m+d[0],t,d[0]);g&&(l.isNumber(h)?k.fillStyle=q.getRgbaString(h):k.fillStyle="white",k.fill());e&&(l.isNumber(f)?k.strokeStyle=q.getRgbaString(f):k.strokeStyle="white",k.lineWidth=e,k.stroke());return a}static getShadowRect(a,b,c=0,d=5,e=2*d){Array.isArray(c)||(c=[c,c,
...
class va extends ua{constructor(a,b){super(a);this._wrap=b}wrap(a){let b=this._wrap(a);return a._wrapper=b}onAdd(a,b){a=this.wrap(a);super.onAdd(a,b)}onRemove(a,b){super.onRemove(a,b)}onSync(a,b,c){b.forEach((a)=>this.wrap(a));c=c.map((a)=>a._wrapper);super.onSync(a,b,c)}onSet(a,b){a=this.wrap(a);super.onSet(a,b)}onMove(a,b,c){super.onMove(a,b,c)}}class wa extends z{_getLookupId(){return"__noise"}_getSourceLoader(){const a=this.stage.gl;return function(b){const c=new Uint8Array(65536);for(var d=0;65536>
d;d+=4){const a=Math.floor(256*Math.random());c[d]=a;c[d+1]=a;c[d+2]=a;c[d+3]=255}d={};a&&(d[a.TEXTURE_WRAP_S]=a.REPEAT,d[a.TEXTURE_WRAP_T]=a.REPEAT,d[a.TEXTURE_MIN_FILTER]=a.NEAREST,d[a.TEXTURE_MAG_FILTER]=a.NEAREST);b(null,{source:c,w:128,h:128,texParams:d})}}}class xa extends z{constructor(a){super(a);this._htmlElement=void 0;this._scale=1}set htmlElement(a){this._htmlElement=a;this._changed()}get htmlElement(){return this._htmlElement}set scale(a){this._scale=a;this._changed()}get scale(){return this._scale}set html(a){if(a){const b=
...
class B extends w{setupUniforms(a){super.setupUniforms(a);const b=1/a.getTextureWidth(0);a=1/a.getTextureHeight(0);this._setUniform("stepTextureCoord",new Float32Array([b,a]),this.gl.uniform2fv)}}B.vertexShaderSource="\n    #ifdef GL_ES\n    precision lowp float;\n    #endif\n    uniform vec2 stepTextureCoord;\n    attribute vec2 aVertexPosition;\n    attribute vec2 aTextureCoord;\n    attribute vec4 aColor;\n    uniform vec2 projection;\n    varying vec4 vColor;\n    varying vec2 vTextureCoordUl;\n    varying vec2 vTextureCoordUr;\n    varying vec2 vTextureCoordBl;\n    varying vec2 vTextureCoordBr;\n    void main(void){\n        gl_Position = vec4(aVertexPosition.x * projection.x - 1.0, aVertexPosition.y * -abs(projection.y) + 1.0, 0.0, 1.0);\n        vTextureCoordUl = aTextureCoord - stepTextureCoord;\n        vTextureCoordBr = aTextureCoord + stepTextureCoord;\n        vTextureCoordUr = vec2(vTextureCoordBr.x, vTextureCoordUl.y);\n        vTextureCoordBl = vec2(vTextureCoordUl.x, vTextureCoordBr.y);\n        vColor = aColor;\n        gl_Position.y = -sign(projection.y) * gl_Position.y;\n    }\n";
...
function(a,c){if(c._recalc&130){a=c.rw;const b=c.rh;do c=c._children[0],c._view.w=a,c._view.h=b;while(c._children)}};return{Textwrap:{rtt:!0,forceZIndexContext:!0,renderOffscreen:!0,Content:{}},Layers:{L0:{rtt:!0,onUpdate:a,renderOffscreen:!0,visible:!1,Content:{shader:{type:B}}},L1:{rtt:!0,onUpdate:a,renderOffscreen:!0,visible:!1,Content:{shader:{type:B}}},L2:{rtt:!0,onUpdate:a,renderOffscreen:!0,visible:!1,Content:{shader:{type:B}}},L3:{rtt:!0,onUpdate:a,renderOffscreen:!0,visible:!1,Content:{shader:{type:B}}}},
...
class Ba extends x{static _template(){const a=function(a,c){if(c._recalc&130){a=c.rw;const b=c.rh;do c=c._children[0],c._view.w=a,c._view.h=b;while(c._children)}};return{Textwrap:{rtt:!0,forceZIndexContext:!0,renderOffscreen:!0,BloomBase:{shader:{type:Ca},Content:{}}},Layers:{L0:{rtt:!0,onUpdate:a,scale:2,pivot:0,visible:!1,Content:{shader:{type:B}}},L1:{rtt:!0,onUpdate:a,scale:4,pivot:0,visible:!1,Content:{shader:{type:B}}},L2:{rtt:!0,onUpdate:a,scale:8,pivot:0,visible:!1,Content:{shader:{type:B}}},
L3:{rtt:!0,onUpdate:a,scale:16,pivot:0,visible:!1,Content:{shader:{type:B}}}}}}constructor(a){super(a);this._textwrap=this.sel("Textwrap");this._wrapper=this.sel("Textwrap.Content");this._layers=this.sel("Layers");this._paddingY=this._paddingX=this._amount=0}_build(){const a=[{x:1,y:0,kernelRadius:1},{x:0,y:1,kernelRadius:1},{x:1.5,y:0,kernelRadius:1},{x:0,y:1.5,kernelRadius:1}].map((a)=>this.stage.createShader(Object.assign({type:P},a)));this._setLayerTexture(this.getLayerContents(0),this._textwrap.getTexture(),
[]);this._setLayerTexture(this.getLayerContents(1),this.getLayer(0).getTexture(),[a[0],a[1]]);this._setLayerTexture(this.getLayerContents(2),this.getLayer(1).getTexture(),[a[0],a[1],a[2],a[3]]);this._setLayerTexture(this.getLayerContents(3),this.getLayer(2).getTexture(),[a[0],a[1],a[2],a[3]])}_setLayerTexture(a,b,c){if(c.length){var d=c.pop();d=a.stage.c({rtt:!0,shader:d});this._setLayerTexture(d,b,c);a.childList.add(d)}else a.texture=b;return a}get content(){return this.sel("Textwrap.Content")}set content(a){this.sel("Textwrap.Content").patch(a,
!0)}set padding(a){this._paddingY=this._paddingX=a;this._updateBlurSize()}set paddingX(a){this._paddingX=a;this._updateBlurSize()}set paddingY(a){this._paddingY=a;this._updateBlurSize()}getLayer(a){return this._layers.sel("L"+a)}getLayerContents(a){return this.getLayer(a).sel("Content")}_onResize(){this._updateBlurSize()}_updateBlurSize(){let a=this.renderWidth,b=this.renderHeight,c=this._paddingX,d=this._paddingY,e=a+2*c,f=b+2*d;this._textwrap.w=e;this._wrapper.x=c;this.getLayer(0).w=this.getLayerContents(0).w=
...
return{Application:G,Component:x,Base:D,Utils:l,StageUtils:q,View:r,Tools:O,Stage:V,ViewCore:K,ViewTexturizer:ha,Texture:z,EventEmitter:v,shaders:{Grayscale:Y,BoxBlur:B,Dithering:Z,CircularPush:aa,Inversion:Ea,LinearBlur:P,Outline:ba,Pixelate:ca,RadialFilter:da,RadialGradient:ea,Light3d:fa,WebGLShader:S,WebGLDefaultShader:w,C2dShader:T,C2dDefaultShader:M,c2d:{Grayscale:Da,Blur:ya}},textures:{RectangleTexture:ra,NoiseTexture:wa,TextTexture:I,ImageTexture:Q,HtmlTexture:xa,StaticTexture:$a,StaticCanvasTexture:sa,
