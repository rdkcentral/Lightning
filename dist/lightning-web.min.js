...
b}}}static getTimingFunction(a){switch(a){case "linear":return function(a){return a};case "ease":return r.getTimingBezier(.25,.1,.25,1);case "ease-in":return r.getTimingBezier(.42,0,1,1);case "ease-out":return r.getTimingBezier(0,0,.58,1);case "ease-in-out":return r.getTimingBezier(.42,0,.58,1);case "step-start":return function(){return 1};case "step-end":return function(a){return 1===a?1:0};default:if(a&&0===a.indexOf("cubic-bezier(")){var b=a.substr(13,a.length-13-1).split(",");if(4!==b.length)return console.warn("Unknown timing function: "+
...
this._context.measureText(w[m]).width,v.push(x),y=Math.max(y,x);a.lineWidths=v;h||(q=y+c+d,u=y);g=g||e;h=l?l:g*(w.length-1)+.5*e+Math.max(g,e)+f;null===f&&(f=e);a.w=q;a.h=h;a.lines=w;a.precision=b;q||(q=1);h||(h=1);if(k||D)q=Math.min(q,D-k);if(n||p)h=Math.min(h,p-n);this._canvas.width=Math.ceil(q+this._stage.getOption("textRenderIssueMargin"));this._canvas.height=Math.ceil(h);this.setFontProperties();128<=e&&(this._context.globalAlpha=.01,this._context.fillRect(0,0,.01,.01),this._context.globalAlpha=
1);(k||n)&&this._context.translate(-k,-n);D=[];for(let a=0,b=w.length;a<b;a++)p=0,q=a*g+f,"right"===this._settings.textAlign?p+=u-v[a]:"center"===this._settings.textAlign&&(p+=(u-v[a])/2),p+=c,D.push({text:w[a],x:p,y:q,w:v[a]});if(this._settings.highlight)for(f=this._settings.highlightHeight*b||1.5*e,e=null!==this._settings.highlightOffset?this._settings.highlightOffset*b:-.5*e,c=null!==this._settings.highlightPaddingLeft?this._settings.highlightPaddingLeft*b:c,d=null!==this._settings.highlightPaddingRight?
this._settings.highlightPaddingRight*b:d,this._context.fillStyle=r.getRgbaString(this._settings.highlightColor||0),g=0;g<D.length;g++)u=D[g],this._context.fillRect(u.x-c,u.y+e,u.w+d+c,f);d=null;this._settings.shadow&&(d=[this._context.shadowColor,this._context.shadowOffsetX,this._context.shadowOffsetY,this._context.shadowBlur],this._context.shadowColor=r.getRgbaString(this._settings.shadowColor),this._context.shadowOffsetX=this._settings.shadowOffsetX*b,this._context.shadowOffsetY=this._settings.shadowOffsetY*
b,this._context.shadowBlur=this._settings.shadowBlur*b);this._context.fillStyle=r.getRgbaString(this._settings.textColor);for(let a=0,c=D.length;a<c;a++)b=D[a],this._context.fillText(b.text,b.x,b.y);d&&(this._context.shadowColor=d[0],this._context.shadowOffsetX=d[1],this._context.shadowOffsetY=d[2],this._context.shadowBlur=d[3]);(k||n)&&this._context.translate(k,n);this.renderInfo=a}wrapText(a,b){a=a.split(/\r?\n/g);let c=[],d=[];for(let e=0;e<a.length;e++){let f=[],g="",h=b,l=a[e].split(" ");for(let a=
0;a<l.length;a++){let c=this._context.measureText(l[a]).width,d=c+this._context.measureText(" ").width;0===a||d>h?(0<a&&(f.push(g),g=""),g+=l[a],h=b-c):(h-=d,g+=" "+l[a])}g&&f.push(g);c=c.concat(f);e<a.length-1&&d.push(c.length)}return{l:c,n:d}}}class J extends A{constructor(a){super(a);this._precision=this.stage.getOption("precision")}get text(){return this._text}set text(a){this._text!==a&&(this._text=""+a,this._changed())}get w(){return this._w}set w(a){this._w!==a&&(this._w=a,this._changed())}get h(){return this._h}set h(a){this._h!==
...
this.__texture.loadError;a&&this.emit("txError",a,this.__texture._source)}_enableTexture(){this.__texture.isLoaded()?this._setDisplayedTexture(this.__texture):(this._setDisplayedTexture(null),this._enableTextureError())}_disableTexture(){this._setDisplayedTexture(null)}get texture(){return this.__texture}set texture(a){let b;if(k.isObjectLiteral(a))(b=a.type?new a.type(this.stage):this.texture)&&this.stage.patchObject(b,a);else if(a)if(a.isTexture)b=a;else if(a.isTextureSource)b=new ja(this.stage),
...
c.__parent);){c.__treeTags||(c.__treeTags=new Map);let d=c.__treeTags.get(b);d||(d=new Set,c.__treeTags.set(b,d));a.forEach(function(a){d.add(a)});c._clearTagsCache(b)}}))}_getByTag(a){return this.__treeTags?(a=this.__treeTags.get(a))?k.setToArray(a):[]:[]}getTags(){return this.__tags?this.__tags:[]}setTags(a){a=a.reduce((a,b)=>a.concat(b.split(" ")),[]);this.__ref&&a.push(this.__ref);let b,c=a.length,d=[],e=[];for(b=0;b<c;b++)this.hasTag(a[b])||e.push(a[b]);let f=this.tags||[];c=f.length;for(b=0;b<
...
a=JSON.stringify(a,function(a,b){return-1!==d.indexOf(a)?"COLOR["+b.toString(16)+"]":b});a=a.replace(/"COLOR\[([a-f0-9]{1,8})\]"/g,"0x$1");if(c){let d="";if(k.isObjectLiteral(c)){var e=Object.keys(c);d="";for(let a=0,f=e.length;a<f;a++)d+=`\n${b}  "${e[a]}":`,delete c[e[a]].ref,d+=q.getPrettyString(c[e[a]],b+"  ")+(a<f-1?",":"");c="{}"===a;a=a.substr(0,a.length-1)+(c?"":",")+d+"\n"+b+"}"}else{e=c.length;d="[";for(let a=0;a<e;a++)d+=q.getPrettyString(c[a],b+"  ")+(a<e-1?",":"")+"\n";d+=b+"]}";c="{}"===
...
h,e.tc*h,e.tb*h,e.td*h,e.px*h,e.py*h);var l=d===this._rectangleTexture;h={operation:a,target:b,index:m,rect:l};if(l)f?c.fillStyle="white":this._setColorGradient(c,k),c.globalAlpha=e.alpha,this._beforeDrawEl(h),c.fillRect(0,0,k.rw,k.rh);else{c.globalAlpha=e.alpha;this._beforeDrawEl(h);e=g?0:k._ulx*d.w;l=g?0:k._uly*d.h;const a=(g?1:k._brx-k._ulx)*d.w;g=(g?1:k._bry-k._uly)*d.h;if(!f&&1024>=a&&1024>=g){f=this.ctx.stage.renderer.getTintTexture(Math.ceil(a),Math.ceil(g));let b=4278190080>k._colorUl||4278190080>
k._colorUr||4278190080>k._colorBl||4278190080>k._colorBr;if(b){let a=k._colorUl/16777216|0;a===(k._colorUr/16777216|0)&&a===(k._colorBl/16777216|0)&&a===(k._colorBr/16777216|0)&&(b=!1,c.globalAlpha*=a)}b?(f.ctx.globalCompositeOperation="copy",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="multiply",this._setColorGradient(f.ctx,k,a,g,!1),f.ctx.fillRect(0,0,a,g),this._setColorGradient(f.ctx,k,a,g,!0),f.ctx.globalCompositeOperation="destination-in",f.ctx.fillRect(0,0,a,g)):(this._setColorGradient(f.ctx,
k,a,g,!1),f.ctx.globalCompositeOperation="copy",f.ctx.fillRect(0,0,a,g),f.ctx.globalCompositeOperation="multiply",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="destination-in",f.ctx.drawImage(d,e,l,a,g,0,0,a,g));f.ctx.globalCompositeOperation="source-over";c.fillStyle="white";c.drawImage(f,0,0,a,g,0,0,k.rw,k.rh)}else c.drawImage(d,e,l,a,g,0,0,k.rw,k.rh)}this._afterDrawEl(h);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,g;b._colorUl===b._colorUr?b._colorBl===
b._colorBr&&b._colorUl!==b.colorBl&&(g=a.createLinearGradient(0,0,0,d),e?(g.addColorStop(0,r.getRgbaString(b._colorUl)),g.addColorStop(1,r.getRgbaString(b._colorBl))):(g.addColorStop(0,r.getRgbString(b._colorUl)),g.addColorStop(1,r.getRgbString(b._colorBl)))):b._colorUl===b._colorBl&&b._colorUr===b._colorBr&&(g=a.createLinearGradient(0,0,c,0),e?(g.addColorStop(0,r.getRgbaString(b._colorUl)),g.addColorStop(1,r.getRgbaString(b._colorBr))):(g.addColorStop(0,r.getRgbString(b._colorUl)),g.addColorStop(1,
r.getRgbString(b._colorBr))));a.fillStyle=g?g:e?r.getRgbaString(f):r.getRgbString(f)}_beforeDrawEl(a){}_afterDrawEl(a){}}class Na extends pa{constructor(a){super(a);this.setupC2d(this.stage.c2d.canvas)}destroy(){this._tintTexture=void 0}_createDefaultShader(a){return new N(a)}_getShaderBaseType(){return T}_getShaderAlternative(a){return a.getC2d&&a.getC2d()}createCoreQuadList(a){return new La(a)}createCoreQuadOperation(a,b,c,d,e,f){return new Ma(a,b,c,d,e,f)}createCoreRenderExecutor(a){return new qa(a)}createCoreRenderState(a){return new oa(a)}createRenderTexture(a,
b,c,d){a=document.createElement("canvas");a.width=c;a.height=d;this.setupC2d(a);return a}freeRenderTexture(a){}uploadTextureSource(a,b){return b.source.buffer?(a=document.createElement("canvas"),a.width=b.w,a.height=b.h,b=new ImageData(new Uint8ClampedArray(b.source.buffer),b.w,b.h),a.getContext("2d").putImageData(b,0,0),a):b.source}freeTextureSource(a){}addQuad(a,b,c){a=b.quadViews[c];b.setRenderContext(c,a._renderContext);b.setWhite(c,a.isWhite());b.setSimpleTc(c,a.hasSimpleTexCoords())}isRenderTextureReusable(a,
b){return!1}finishRenderState(a){}setupC2d(a){const b=a.getContext("2d");a.ctx=b;b._scissor=null;a.ctx.save()}getPatchId(){return"c2d"}getTintTexture(a,b){this._tintTexture?this._tintTexture.ctx.clearRect(0,0,a,b):(a=document.createElement("canvas"),a.width=1024,a.height=1024,a.ctx=a.getContext("2d"),this._tintTexture=a);return this._tintTexture}}class Oa{constructor(a){this._items=new Map;this._id=0;this._initWorker()}_initWorker(){var a=new Blob([`(${Pa.toString()})()`.replace('"use strict";',"")]);
a=(window.URL?URL:webkitURL).createObjectURL(a,{type:"application/javascript; charset=utf-8"});this._worker=new Worker(a);this._worker.postMessage({type:"config",config:{path:window.location.href}});this._worker.onmessage=(a)=>{if(a.data&&a.data.id){const b=this._items.get(a.data.id);b&&("data"==a.data.type?this.finish(b,a.data.info):this.error(b,a.data.info))}}}create(a){const b=++this._id,c=new Qa(this,b,a);this._items.set(b,c);this._worker.postMessage({type:"add",id:b,src:a});return c}cancel(a){this._worker.postMessage({type:"cancel",
id:a.id});this._items.delete(a.id)}error(a,b){a.error(b);this._items.delete(a.id)}finish(a,b){a.load(b);this._items.delete(a.id)}}class Qa{constructor(a,b,c){this._manager=a;this._id=b;this._src=c;this._onLoad=this._onError=null}get id(){return this._id}get src(){return this._src}set onError(a){this._onError=a}set onLoad(a){this._onLoad=a}cancel(){this._manager.cancel(this)}load(a){this._onLoad&&this._onLoad(a)}error(a){this._onError&&this._onError(a)}}const Pa=function(){class a{constructor(){this.items=
new Map;onmessage=(a)=>{"config"==a.data.type?(this.config=a.data.config,a=this.config.path.split("/"),a.pop(),this._relativeBase=a.join("/")+"/"):"add"==a.data.type?this.add(a.data.id,a.data.src):"cancel"==a.data.type&&this.cancel(a.data.id)}}static isPathAbsolute(a){return/^(?:\/|[a-z]+:\/\/)/.test(a)}add(c,d){a.isPathAbsolute(d)||(d=this._relativeBase+d,console.log("convert to relative: "+d));"//"===d.substr(0,2)&&(d="http:"+d);const e=new b(c,d);e.onFinish=(a)=>{this.finish(e,a)};e.onError=(a)=>
{this.error(e,a)};this.items.set(c,e);e.start()}cancel(a){const b=this.items.get(a);b&&(b.cancel(),this.items.delete(a))}finish(a,{imageBitmap:b,hasAlphaChannel:e}){postMessage({type:"data",id:a.id,info:{imageBitmap:b,hasAlphaChannel:e}},[b]);this.items.delete(a.id)}error(a,{type:b,message:e}){postMessage({type:"error",id:a.id,info:{type:b,message:e}});this.items.delete(a.id)}}class b{constructor(a,b){this._onFinish=this._onError=void 0;this._id=a;this._src=b;this._mimeType=this._xhr=void 0;this._canceled=
!1}get id(){return this._id}set onFinish(a){this._onFinish=a}set onError(a){this._onError=a}start(){this._xhr=new XMLHttpRequest;this._xhr.open("GET",this._src,!0);this._xhr.responseType="blob";this._xhr.onerror=(a)=>{this.error({type:"connection",message:"Connection error"})};this._xhr.onload=(a)=>{a=this._xhr.response;this._mimeType=a.type;this._createImageBitmap(a)};this._xhr.send()}_createImageBitmap(a){createImageBitmap(a,{premultiplyAlpha:"premultiply",colorSpaceConversion:"none",imageOrientation:"none"}).then((a)=>
{this.finish({imageBitmap:a,hasAlphaChannel:this._hasAlphaChannel()})}).catch((a)=>{this.error({type:"parse",message:"Error parsing image data"})})}_hasAlphaChannel(){return!0}cancel(){this._canceled||(this._xhr&&this._xhr.abort(),this._canceled=!0)}error(a,b){!this._canceled&&this._onError&&this._onError({type:a,message:b})}finish(a){!this._canceled&&this._onFinish&&this._onFinish(a)}}new a};class Ra{init(a){this.stage=a;this._awaitingLoop=this._looping=!1;this.stage.getOption("useImageWorker")&&
(window.createImageBitmap&&window.Worker?this._imageWorker=new Oa:console.warn("Can't use image worker because browser does not have createImageBitmap and Web Worker support"))}startLoop(){this._looping=!0;this._awaitingLoop||this.loop()}stopLoop(){this._looping=!1}loop(){let a=this,b=function(){a._awaitingLoop=!1;a._looping&&(a.stage.drawFrame(),requestAnimationFrame(b),a._awaitingLoop=!0)};requestAnimationFrame(b)}uploadGlTexture(a,b,c,d){c instanceof ImageData||c instanceof HTMLImageElement||c instanceof
HTMLCanvasElement||c instanceof HTMLVideoElement||window.ImageBitmap&&c instanceof ImageBitmap?a.texImage2D(a.TEXTURE_2D,0,d.internalFormat,d.format,d.type,c):a.texImage2D(a.TEXTURE_2D,0,d.internalFormat,b.w,b.h,0,d.format,d.type,c)}loadSrcTexture({src:a,hasAlpha:b},c){let d=void 0,e=0<=a.indexOf(".png");if(this._imageWorker){const b=this._imageWorker.create(a);b.onError=function(a){return c("Image load error")};b.onLoad=function({imageBitmap:b,hasAlphaChannel:d}){c(null,{source:b,renderInfo:{src:a},
hasAlpha:d,premultiplyAlpha:!0})};d=function(){b.cancel()}}else{let f=new Image;"data:"!=a.substr(0,5)&&(f.crossOrigin="Anonymous");f.onerror=function(a){if(f.src)return c("Image load error")};f.onload=function(){c(null,{source:f,renderInfo:{src:a},hasAlpha:e||b})};f.src=a;d=function(){f.removeAttribute("src")}}return d}createWebGLContext(a,b){var c=this.stage.getOption("canvas")||document.createElement("canvas");a&&b&&(c.width=a,c.height=b);a={alpha:!0,antialias:!1,premultipliedAlpha:!0,stencil:!0,
preserveDrawingBuffer:!1};c=c.getContext("webgl",a)||c.getContext("experimental-webgl",a);if(!c)throw Error("This browser does not support webGL.");return c}createCanvasContext(a,b){let c=this.stage.getOption("canvas")||document.createElement("canvas");a&&b&&(c.width=a,c.height=b);a=c.getContext("2d");if(!a)throw Error("This browser does not support 2d canvas.");return a}getHrTime(){return window.performance?window.performance.now():(new Date).getTime()}getDrawingCanvas(){return document.createElement("canvas")}getTextureOptionsForDrawingCanvas(a){let b=
{};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Sa{static load(a){return Ra}}class C{static isFunction(a){return"function"===typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===a||!1===a}static isString(a){return"string"==typeof a}static isObject(a){let b=typeof a;return!!a&&("object"==b||"function"==b)}static isPlainObject(a){return!!a&&
...
b,c,d,e){this._state.setSetting(this._vertexAttrib4f,[a,b,c,d,e])&&this._vertexAttrib4f(a,b,c,d,e)}$vertexAttrib4fv(a,b){this._state.setSetting(this._vertexAttrib4fv,[a,b])&&this._vertexAttrib4fv(a,b)}static enable(a,b="default"){Object.getOwnPropertyNames(O.prototype).forEach((b)=>{if("constructor"!==b){const c=O.prototype[b];"$"===b.charAt(0)&&(b=b.substr(1));a[b]&&(a[b].name||(a[b].xname=b),a["_"+b]=a[b]);a[b]=c}});O.prototype._initStateManager.call(a,b);return a}}class Ta{constructor(a){this.stage=
a;this._usedTextureMemory=0;this._uploadedTextureSources=[];this.textureSourceHashmap=new Map}destroy(){for(let a=0,b=this._uploadedTextureSources.length;a<b;a++)this._nativeFreeTextureSource(this._uploadedTextureSources[a]);this.textureSourceHashmap.clear()}getReusableTextureSource(a){return this.textureSourceHashmap.get(a)}getTextureSource(a,b){let c=b?this.textureSourceHashmap.get(b):null;c||(c=new K(this,a),b&&(c.lookupId=b,this.textureSourceHashmap.set(b,c)));return c}uploadTextureSource(a,b){a.isLoaded()||
(b=this._nativeUploadTextureSource(a,b),a._nativeTexture=b,b.w=a.w,b.h=a.h,b.update=this.stage.frameCounter,this._usedTextureMemory+=a.w*a.h,this._uploadedTextureSources.push(a),this.addToLookupMap(a))}addToLookupMap(a){const b=a.lookupId;b&&(this.textureSourceHashmap.has(b)||this.textureSourceHashmap.set(b,a))}removeFromLookupMap(a){this.textureSourceHashmap.delete(a.lookupId)}isFull(){return this._usedTextureMemory>=this.stage.getOption("textureMemory")}freeUnusedTextureSources(){let a=[],b=this._usedTextureMemory;
for(let b=0,d=this._uploadedTextureSources.length;b<d;b++){let c=this._uploadedTextureSources[b];c.allowCleanup()?this._freeManagedTextureSource(c):a.push(c)}this._uploadedTextureSources=a;console.log("freed "+((b-this._usedTextureMemory)/1E6).toFixed(2)+"M texture pixels from GPU memory. Remaining: "+this._usedTextureMemory)}_freeManagedTextureSource(a){a.isLoaded()&&(this._usedTextureMemory-=a.w*a.h,this._nativeFreeTextureSource(a));a.loadingSince=null;this.removeFromLookupMap(a)}freeTextureSource(a){const b=
this._uploadedTextureSources.indexOf(a),c=-1!==b;a.isLoaded()&&(c&&(this._usedTextureMemory-=a.w*a.h,this._uploadedTextureSources.splice(b,1)),this._nativeFreeTextureSource(a));a.loadingSince=null;this.removeFromLookupMap(a)}_nativeUploadTextureSource(a,b){return this.stage.renderer.uploadTextureSource(a,b)}_nativeFreeTextureSource(a){this.stage.renderer.freeTextureSource(a);a.clearNativeTexture()}}class Ua{constructor(a){this.stage=a;this.root=null;this.updateTreeOrder=0;this.renderState=this.stage.renderer.createCoreRenderState(this);
...
null===a||void 0===a?this._clearColor=void 0:Array.isArray(a)?this._clearColor=a:this._clearColor=r.getRgbaComponentsNormalized(a)}getClearColor(){return this._clearColor}createView(){return new q(this)}view(a){if(a.isView)return a;let b;b=a.type?new a.type(this):new q(this);b.patch(a,!0);return b}c(a){return this.view(a)}get w(){return this._options.w}get h(){return this._options.h}get rw(){return this.w/this._options.precision}get rh(){return this.h/this._options.precision}gcTextureMemory(a=!1){console.log("GC texture memory"+
...
return{Application:G,Component:x,Base:E,Utils:k,StageUtils:r,View:q,Tools:P,Stage:V,ViewCore:L,ViewTexturizer:ia,Texture:A,EventEmitter:v,shaders:{Grayscale:Z,BoxBlur:I,Dithering:aa,CircularPush:ba,Inversion:Da,LinearBlur:W,Outline:ca,Pixelate:da,RadialFilter:ea,RadialGradient:fa,Light3d:ha,WebGLShader:S,WebGLDefaultShader:w,C2dShader:T,C2dDefaultShader:N,c2d:{Grayscale:Ca,Blur:za}},textures:{RectangleTexture:sa,NoiseTexture:xa,TextTexture:J,ImageTexture:Q,HtmlTexture:ya,StaticTexture:Xa,StaticCanvasTexture:ta,
