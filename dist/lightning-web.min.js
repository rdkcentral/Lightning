...
k._colorUl||4278190080>k._colorUr||4278190080>k._colorBl||4278190080>k._colorBr;if(b){let a=k._colorUl/16777216|0;a===(k._colorUr/16777216|0)&&a===(k._colorBl/16777216|0)&&a===(k._colorBr/16777216|0)&&(b=!1,c.globalAlpha*=a)}b?(f.ctx.globalCompositeOperation="copy",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="multiply",this._setColorGradient(f.ctx,k,a,g,!1),f.ctx.fillRect(0,0,a,g),this._setColorGradient(f.ctx,k,a,g,!0),f.ctx.globalCompositeOperation="destination-in",f.ctx.fillRect(0,
0,a,g)):(this._setColorGradient(f.ctx,k,a,g,!1),f.ctx.globalCompositeOperation="copy",f.ctx.fillRect(0,0,a,g),f.ctx.globalCompositeOperation="multiply",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="destination-in",f.ctx.drawImage(d,e,l,a,g,0,0,a,g));f.ctx.globalCompositeOperation="source-over";c.fillStyle="white";c.drawImage(f,0,0,a,g,0,0,k.rw,k.rh)}}this._afterDrawEl(h);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,g;b._colorUl===b._colorUr?b._colorBl===
