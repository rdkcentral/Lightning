...
h,e.tc*h,e.tb*h,e.td*h,e.px*h,e.py*h);var l=d===this._rectangleTexture;h={operation:a,target:b,index:m,rect:l};if(l)f?c.fillStyle="white":this._setColorGradient(c,k),c.globalAlpha=e.alpha,this._beforeDrawEl(h),c.fillRect(0,0,k.rw,k.rh);else{c.globalAlpha=e.alpha;this._beforeDrawEl(h);e=g?0:k._ulx*d.w;l=g?0:k._uly*d.h;const a=(g?1:k._brx-k._ulx)*d.w;g=(g?1:k._bry-k._uly)*d.h;if(f)c.drawImage(d,e,l,a,g,0,0,k.rw,k.rh);else{f=document.createElement("canvas");f.width=Math.ceil(a);f.height=Math.ceil(g);
f.ctx=f.getContext("2d");let b=4278190080>k._colorUl||4278190080>k._colorUr||4278190080>k._colorBl||4278190080>k._colorBr;if(b){let a=k._colorUl/16777216|0;a===k._colorUr/16777216|0&&a===k._colorBl/16777216|0&&a===k._colorBr/16777216|0&&(b=!1,c.globalAlpha*=a)}b?(f.ctx.globalCompositeOperation="copy",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="multiply",this._setColorGradient(f.ctx,k,a,g,!1),f.ctx.fillRect(0,0,a,g),this._setColorGradient(f.ctx,k,a,g,!0),f.ctx.globalCompositeOperation=
"destination-in",f.ctx.fillRect(0,0,a,g)):(this._setColorGradient(f.ctx,k,a,g,!1),f.ctx.globalCompositeOperation="copy",f.ctx.fillRect(0,0,a,g),f.ctx.globalCompositeOperation="multiply",f.ctx.drawImage(d,e,l,a,g,0,0,a,g),f.ctx.globalCompositeOperation="destination-in",f.ctx.drawImage(d,e,l,a,g,0,0,a,g));f.ctx.globalCompositeOperation="source-over";c.fillStyle="white";c.drawImage(f,0,0,a,g,0,0,k.rw,k.rh)}}this._afterDrawEl(h);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,
g;b._colorUl===b._colorUr?b._colorBl===b._colorBr&&b._colorUl!==b.colorBl&&(g=a.createLinearGradient(0,0,0,d),e?(g.addColorStop(0,t.getRgbaString(b._colorUl)),g.addColorStop(1,t.getRgbaString(b._colorBl))):(g.addColorStop(0,t.getRgbString(b._colorUl)),g.addColorStop(1,t.getRgbString(b._colorBl)))):b._colorUl===b._colorBl&&b._colorUr===b._colorBr&&(g=a.createLinearGradient(0,0,c,0),e?(g.addColorStop(0,t.getRgbaString(b._colorUl)),g.addColorStop(1,t.getRgbaString(b._colorBr))):(g.addColorStop(0,t.getRgbString(b._colorUl)),
g.addColorStop(1,t.getRgbString(b._colorBr))));a.fillStyle=g||t.getRgbaString(f)}_beforeDrawEl(a){}_afterDrawEl(a){}}class Na extends pa{constructor(a){super(a);this.setupC2d(this.stage.c2d.canvas)}_createDefaultShader(a){return new N(a)}_getShaderBaseType(){return T}_getShaderAlternative(a){return a.getC2d&&a.getC2d()}createCoreQuadList(a){return new La(a)}createCoreQuadOperation(a,b,c,d,e,f){return new Ma(a,b,c,d,e,f)}createCoreRenderExecutor(a){return new qa(a)}createCoreRenderState(a){return new oa(a)}createRenderTexture(a,
...
c))])}:function(c){return 0===c?a:1===c?b:u.mergeColors(b,a,c)}}static getSplineHelpers(a,b,c,d,e,f){if(!c&&!d)return null;e=a+e*c;let g=1-d;d=b-f*d;return[3*c-3*g+1,-6*c+3*g,3*c,3*e-3*d+b-a,3*(d+a)-6*e,3*(e-a),a]}static calculateSpline(a,b){let c=a[0],d=a[1],e=a[2],f=a[3],g=a[4],h=a[5];a=a[6];if(-2===c&&-2===f&&0===e&&0===h)return b;let l=.5;for(var k=0;20>k;k++){var r=l*(l*(l*c+d)+e);r=b-r;if(-1E-8<r&&1E-8>r)return l*(l*(l*f+g)+h)+a;var n=l*(3*l*c+2*d)+e;if(1E-10<n&&1E-10>n)break;l+=r/n}k=0;n=1;
for(let m=0;20>m;m++){l=.5*(k+n);r=l*(l*(l*c+d)+e);r=b-r;if(-1E-8<r&&1E-8>r)return l*(l*(l*f+g)+h)+a;0>r?n=l:k=l}return l}static mergeColors(a,b,c){return 16777216*Math.round((a/16777216|0)*c+(b/16777216|0)*(1-c))+65536*Math.round((a/65536|0)%256*c+(b/65536|0)%256*(1-c))+256*Math.round((a/256|0)%256*c+(b/256|0)%256*(1-c))+Math.round(a%256*c+b%256*(1-c))}static getArgbNumber(a){a[0]=Math.max(0,Math.min(255,a[0]));a[1]=Math.max(0,Math.min(255,a[1]));a[2]=Math.max(0,Math.min(255,a[2]));a[3]=Math.max(0,
...
null===a||void 0===a?this._clearColor=void 0:Array.isArray(a)?this._clearColor=a:this._clearColor=t.getRgbaComponentsNormalized(a)}getClearColor(){return this._clearColor}createView(){return new q(this)}view(a){if(a.isView)return a;let b;b=a.type?new a.type(this):new q(this);b.patch(a,!0);return b}c(a){return this.view(a)}get w(){return this._options.w}get h(){return this._options.h}get rw(){return this.w/this._options.precision}get rh(){return this.h/this._options.precision}gcTextureMemory(a=!1){console.log("GC texture memory"+
...
let l=a.getContext("2d");l.imageSmoothingEnabled=!0;a.width=b+e+2;a.height=c+e+2;l.beginPath();let m=.5*e+1,r=.5*e+1;l.moveTo(m+d[0],r);l.lineTo(m+b-d[1],r);l.arcTo(m+b,r,m+b,r+d[1],d[1]);l.lineTo(m+b,r+c-d[2]);l.arcTo(m+b,r+c,m+b-d[2],r+c,d[2]);l.lineTo(m+d[3],r+c);l.arcTo(m,r+c,m,r+c-d[3],d[3]);l.lineTo(m,r+d[0]);l.arcTo(m,r,m+d[0],r,d[0]);g&&(k.isNumber(h)?l.fillStyle=t.getRgbaString(h):l.fillStyle="white",l.fill());e&&(k.isNumber(f)?l.strokeStyle=t.getRgbaString(f):l.strokeStyle="white",l.lineWidth=
...
return{Application:G,Component:x,Base:E,Utils:k,StageUtils:t,View:q,Tools:P,Stage:V,ViewCore:L,ViewTexturizer:ia,Texture:A,EventEmitter:v,shaders:{Grayscale:Z,BoxBlur:I,Dithering:aa,CircularPush:ba,Inversion:Da,LinearBlur:W,Outline:ca,Pixelate:da,RadialFilter:ea,RadialGradient:fa,Light3d:ha,WebGLShader:S,WebGLDefaultShader:w,C2dShader:T,C2dDefaultShader:N,c2d:{Grayscale:Ca,Blur:za}},textures:{RectangleTexture:sa,NoiseTexture:xa,TextTexture:J,ImageTexture:Q,HtmlTexture:ya,StaticTexture:Xa,StaticCanvasTexture:ta,
