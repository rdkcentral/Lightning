...
0===this.textures.size&&this.becomesUnused()}get isResultTexture(){return this._isResultTexture}set isResultTexture(a){this._isResultTexture=a}forEachEnabledView(a){this.textures.forEach((b)=>{b.views.forEach(a)})}hasEnabledViews(){return 0<this.textures.size}forEachActiveView(a){this.textures.forEach((b)=>{b.views.forEach((b)=>{b.active&&a(b)})})}getRenderWidth(){return this.w}getRenderHeight(){return this.h}allowCleanup(){return!this.permanent&&!this.isUsed()}becomesUsed(){this.lookupId&&(this.manager.textureSourceHashmap.has(this.lookupId)||
...
this._updateTreeOrder+1:this._updateTreeOrder=this.ctx.updateTreeOrder++;b=this._renderToTextureEnabled&&this._texturizer.mustRenderToTexture();this._useRenderToTexture!==b&&(this._recalc|=6,d|=2,this._useRenderToTexture||this._texturizer.release());this._useRenderToTexture=b;b=this._renderContext;let h,k,m;var e=0!=b.tb||0!=b.tc||0>b.ta||0>b.td;e?(c=Math.min(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,k=Math.max(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,
h=Math.min(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py,m=Math.max(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py):(c=b.px,k=b.px+b.ta*this._rw,h=b.py,m=b.py+b.td*this._rh);if(this._rwhEstimate&&(e||1>this._localTa||1>this._localTb)){var f=this._x*a.ta+this._y*a.tb+a.px,g=this._x*a.tc+this._y*a.td+a.py;f<c&&(c=f);g<h&&(h=g);f>k&&(k=f);g>m&&(m=g)}if(d&6||!this._scissor)if(this._clipping&&b.isSquare())if(f=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor){g=
Math.max(f[0],c);const a=Math.max(f[1],h);this._scissor=[g,a,Math.min(f[2]+f[0],k)-g,Math.min(f[3]+f[1],m)-a]}else this._scissor=[c,h,k-c,m-h];else this._scissor=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor;this._recBoundsMargin=void 0!==this._boundsMargin?this._boundsMargin:this._parent._recBoundsMargin;this._onAfterCalcs&&this._onAfterCalcs(this.view)&&(e?(c=Math.min(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,k=Math.max(0,this._rw*b.ta,this._rw*
b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,h=Math.min(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py,m=Math.max(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py):(c=b.px,k=b.px+b.ta*this._rw,h=b.py,m=b.py+b.td*this._rh),this._rwhEstimate&&(e||1>this._localTa||1>this._localTb)&&(e=this._x*a.ta+this._y*a.tb+a.px,a=this._x*a.tc+this._y*a.td+a.py,e<c&&(c=e),a<h&&(h=a),e>k&&(k=e),a>m&&(m=a)));if(2===this._parent._outOfBounds)this._outOfBounds=2,this._withinBoundsMargin&&(this._withinBoundsMargin=
!1,this.view._disableWithinBoundsMargin());else if(d&6){this._outOfBounds=0;d=!0;if(!this._renderToTextureEnabled||!this._texturizer||!this._texturizer.renderOffscreen){if(this._scissor&&(0>=this._scissor[2]||0>=this._scissor[3]))this._outOfBounds=2;else{if(this._scissor[0]>k||this._scissor[1]>m||c>this._scissor[0]+this._scissor[2]||h>this._scissor[1]+this._scissor[3])this._outOfBounds=1;this._outOfBounds&&(this._clipping||this._useRenderToTexture||this._clipbox)&&(this._outOfBounds=2)}d=0===this._outOfBounds;
!d&&this._recBoundsMargin&&(d=!(k<this._scissor[0]-this._recBoundsMargin[2]||m<this._scissor[1]-this._recBoundsMargin[3]||c>this._scissor[0]+this._scissor[2]+this._recBoundsMargin[0]||h>this._scissor[1]+this._scissor[3]+this._recBoundsMargin[1]))&&2===this._outOfBounds&&(this._outOfBounds=1)}if(this._withinBoundsMargin!==d)if(this._withinBoundsMargin=d){this._hasUpdates=!0;d=this._recalc;this._recalc=0;this.view._enableWithinBoundsMargin();if(this._recalc)return this.update();this._recalc=d}else this.view._disableWithinBoundsMargin()}this._useRenderToTexture&&
...
a.withinBoundsMargin&&this.decWithinBoundsCount())}incWithinBoundsCount(){this._withinBoundsCount++;1===this._withinBoundsCount&&this.becomesUsed()}decWithinBoundsCount(){this._withinBoundsCount--;this._withinBoundsCount||this.becomesUnused()}becomesUsed(){this.load()}becomesUnused(){}isUsed(){return 0<this._withinBoundsCount}_getLookupId(){}_getSourceLoader(){throw Error("Texture.generate must be implemented.");}get isValid(){return this._getIsValid()}_getIsValid(){return!0}_changed(){this.isUsed()?
...
e=[1<e.l.length?e.l[1]:""]}else e=[""];var m=g.length;let a=0,c=f.n.length;for(k=this._settings.maxLines;k<m;k++)e[a]+=(e[a]?" ":"")+g[k],k+1<c&&f.n[k+1]&&a++;b.remainingText=e.join("\n");b.moreTextLines=!0;g=h}else b.moreTextLines=!1,b.remainingText="";f=0;h=[];for(e=0;e<g.length;e++)k=this._context.measureText(g[e]).width,h.push(k),f=Math.max(f,k);b.lineWidths=h;this._settings.w||(c=f+this._settings.paddingLeft+this._settings.paddingRight,d=f);e=this._settings.lineHeight||this._settings.fontSize;
m=this._settings.h?this._settings.h:e*(g.length-1)+.5*this._settings.fontSize+Math.max(e,this._settings.fontSize)+this._settings.offsetY;k=null===this._settings.offsetY?this._settings.fontSize:this._settings.offsetY;f=this.getPrecision();b.w=c*f;b.h=m*f;b.lines=g;b.precision=f;if(!a){c||(c=1);m||(m=1);if(this._settings.cutSx||this._settings.cutEx)c=Math.min(c,this._settings.cutEx-this._settings.cutSx);if(this._settings.cutSy||this._settings.cutEy)m=Math.min(m,this._settings.cutEy-this._settings.cutSy);
this._canvas.width=Math.ceil(c*f+this._stage.getOption("textRenderIssueMargin"));this._canvas.height=Math.ceil(m*f);this.setFontProperties(!0);128<=this._realFontSize&&(this._context.globalAlpha=.01,this._context.fillRect(0,0,.01,.01),this._context.globalAlpha=1);(this._settings.cutSx||this._settings.cutSy)&&this._context.translate(-(this._settings.cutSx*f),-(this._settings.cutSy*f));a=[];for(let b=0,l=g.length;b<l;b++)c=0,m=b*e+k,"right"===this._settings.textAlign?c+=d-h[b]:"center"===this._settings.textAlign&&
(c+=(d-h[b])/2),c+=this._settings.paddingLeft,a.push({text:g[b],x:c*f,y:m*f,w:h[b]*f});if(this._settings.highlight)for(d=this._settings.highlightHeight||1.5*this._settings.fontSize,g=null!==this._settings.highlightOffset?this._settings.highlightOffset:-.5*this._settings.fontSize,c=null!==this._settings.highlightPaddingLeft?this._settings.highlightPaddingLeft:this._settings.paddingLeft,h=null!==this._settings.highlightPaddingRight?this._settings.highlightPaddingRight:this._settings.paddingRight,this._context.fillStyle=
...
a.height]);c||(c=[0,0,a.width,a.height]);return l.equalValues(b,c)}}class O extends I{beforeDraw(a){}draw(a){}afterDraw(a){}}class J extends O{constructor(a){super(a);this._rectangleTexture=a.stage.rectangleTexture.source.nativeTexture}draw(a,b){const c=b.ctx;let d=a.length;for(let f=0;f<d;f++){var e=a.getTexture(f);const d=a.getViewCore(f),h=a.getRenderContext(f);c.setTransform(h.ta,h.tc,h.tb,h.td,h.px,h.py);const k=e===this._rectangleTexture,m={operation:a,target:b,index:f,rect:k};if(k){e=d._colorUl;
let a;d._colorUl===d._colorUr?d._colorBl===d._colorBr&&d._colorUl!==d.colorBl&&(a=c.createLinearGradient(0,0,0,d.rh),a.addColorStop(0,r.getRgbaString(d._colorUl)),a.addColorStop(1,r.getRgbaString(d._colorBl))):d._colorUl===d._colorBl&&d._colorUr===d._colorBr&&(a=c.createLinearGradient(0,0,d.rw,0),a.addColorStop(0,r.getRgbaString(d._colorUl)),a.addColorStop(1,r.getRgbaString(d._colorBr)));c.fillStyle=a||r.getRgbaString(e);m.gradient=a;m.color=e;this._beforeDrawEl(m);c.fillRect(0,0,d.rw,d.rh);this._afterDrawEl(m)}else c.globalAlpha=
h.alpha,this._beforeDrawEl(m),c.drawImage(e,d._ulx*e.w,d._uly*e.h,(d._brx-d._ulx)*e.w,(d._bry-d._uly)*e.h,0,0,d.rw,d.rh),this._afterDrawEl(m),c.globalAlpha=1}}_beforeDrawEl(a){}_afterDrawEl(a){}}class Ia extends ka{constructor(a){super(a);this.setupC2d(this.stage.c2d.canvas)}_createDefaultShader(a){return new J(a)}_getShaderBaseType(){return O}_getShaderAlternative(a){return a.getC2d&&a.getC2d()}createCoreQuadList(a){return new Ga(a)}createCoreQuadOperation(a,b,c,d,e,f){return new Ha(a,b,c,d,e,f)}createCoreRenderExecutor(a){return new la(a)}createCoreRenderState(a){return new ja(a)}createRenderTexture(a,
...
a.getContext("2d");a.ctx=b;b._scissor=null;a.ctx.save()}getPatchId(){return"c2d"}}class Ja{constructor(a){this._items=new Map;this._id=0;this._initWorker()}_initWorker(){var a=new Blob([`(${Ka.toString()})()`.replace('"use strict";',"")]);a=(window.URL?URL:webkitURL).createObjectURL(a,{type:"application/javascript; charset=utf-8"});this._worker=new Worker(a);this._worker.postMessage({type:"config",config:{path:window.location.href}});this._worker.onmessage=(a)=>{if(a.data&&a.data.id){const b=this._items.get(a.data.id);
b&&("data"==a.data.type?this.finish(b,a.data.info):this.error(b,a.data.info))}}}create(a){const b=++this._id,c=new La(this,b,a);this._items.set(b,c);this._worker.postMessage({type:"add",id:b,src:a});return c}cancel(a){this._worker.postMessage({type:"cancel",id:a.id});this._items.delete(a.id)}error(a,b){a.error(b);this._items.delete(a.id)}finish(a,b){a.load(b);this._items.delete(a.id)}}class La{constructor(a,b,c){this._manager=a;this._id=b;this._src=c;this._onLoad=this._onError=null}get id(){return this._id}get src(){return this._src}set onError(a){this._onError=
...
message:b})}finish(a){!this._canceled&&this._onFinish&&this._onFinish(a)}}new a};class Ma{init(a){this.stage=a;this._awaitingLoop=this._looping=!1;this.stage.getOption("useImageWorker")&&(window.createImageBitmap&&window.Worker?this._imageWorker=new Ja:console.warn("Can't use image worker because browser does not have createImageBitmap and Web Worker support"))}startLoop(){this._looping=!0;this._awaitingLoop||this.loop()}stopLoop(){this._looping=!1}loop(){let a=this,b=function(){a._awaitingLoop=!1;
...
return a}getHrTime(){return window.performance?window.performance.now():(new Date).getTime()}getDrawingCanvas(){return document.createElement("canvas")}getTextureOptionsForDrawingCanvas(a){let b={};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Na{static load(a){return Ma}}class Oa{constructor(a){this.stage=a;this._usedTextureMemory=0;this._uploadedTextureSources=[];this.textureSourceHashmap=new Map}destroy(){for(let a=
...
a.w*a.h,this._uploadedTextureSources.push(a))}isFull(){return this._usedTextureMemory>=this.stage.getOption("textureMemory")}freeUnusedTextureSources(){let a=[],b=this._usedTextureMemory;for(let b=0,d=this._uploadedTextureSources.length;b<d;b++){let c=this._uploadedTextureSources[b];c.allowCleanup()?this._freeManagedTextureSource(c):a.push(c)}this._uploadedTextureSources=a;console.log("freed "+((b-this._usedTextureMemory)/1E6).toFixed(2)+"M texture pixels from GPU memory. Remaining: "+this._usedTextureMemory)}_freeManagedTextureSource(a){a.isLoaded()&&
(this._usedTextureMemory-=a.w*a.h,this._nativeFreeTextureSource(a));a.loadingSince=null;a.lookupId&&this.textureSourceHashmap.delete(a.lookupId)}freeTextureSource(a){const b=this._uploadedTextureSources.indexOf(a),c=-1!==b;a.isLoaded()&&(c&&(this._usedTextureMemory-=a.w*a.h,this._uploadedTextureSources.splice(b,1)),this._nativeFreeTextureSource(a));a.loadingSince=null;a.lookupId&&this.textureSourceHashmap.delete(a.lookupId)}_nativeUploadTextureSource(a,b){return this.stage.renderer.uploadTextureSource(a,
b)}_nativeFreeTextureSource(a){this.stage.renderer.freeTextureSource(a);a.clearNativeTexture()}}class Pa{constructor(a){this.stage=a;this.root=null;this.updateTreeOrder=0;this.renderState=this.stage.renderer.createCoreRenderState(this);this.renderExec=this.stage.renderer.createCoreRenderExecutor(this);this.renderExec.init();this._renderTexturePixels=0;this._renderTexturePool=[];this._renderTextureId=1;this._zSorts=[]}destroy(){this._renderTexturePool.forEach((a)=>this._freeRenderTexture(a))}hasRenderUpdates(){return!!this.root._parent._hasRenderUpdates}frame(){this.update();
...
return e}_freeRenderTexture(a){this.stage.renderer.freeRenderTexture(a);this._renderTexturePixels-=a.w*a.h}copyRenderTexture(a,b,c){this.stage.renderer.copyRenderTexture(a,b,c)}forceZSort(a){this._zSorts.push(a)}}class P{constructor(a){this.stage=a;this._timingFunction="ease";this._timingFunctionImpl=r.getTimingFunction(this._timingFunction);this.delay=0;this.duration=.2;this.merger=null}get timingFunction(){return this._timingFunction}set timingFunction(a){this._timingFunction=a;this._timingFunctionImpl=
...
new P(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}removeActive(a){this.active.delete(a)}}class u{constructor(){this._clear()}_clear(){this._p=[];this._pe=[];this._idp=[];this._f=[];this._v=[];this._lv=[];this._sm=[];this._s=[];this._ve=[];this._sme=[];this._se=[];this._length=0}parse(a,b){l.isObjectLiteral(b)||(b={0:b});let c=.5,d=[];for(g in b)if(b.hasOwnProperty(g)){var e=b[g];l.isObjectLiteral(e)||(e={v:e});var f=parseFloat(g);"sm"===g?c=e.v:!isNaN(f)&&0<=f&&2>=f&&(e.p=f,e.f=
...
let m=.5*e+1,p=.5*e+1;k.moveTo(m+d[0],p);k.lineTo(m+b-d[1],p);k.arcTo(m+b,p,m+b,p+d[1],d[1]);k.lineTo(m+b,p+c-d[2]);k.arcTo(m+b,p+c,m+b-d[2],p+c,d[2]);k.lineTo(m+d[3],p+c);k.arcTo(m,p+c,m,p+c-d[3],d[3]);k.lineTo(m,p+d[0]);k.arcTo(m,p,m+d[0],p,d[0]);g&&(l.isNumber(h)?k.fillStyle=r.getRgbaString(h):k.fillStyle="white",k.fill());e&&(l.isNumber(f)?k.strokeStyle=r.getRgbaString(f):k.strokeStyle="white",k.lineWidth=e,k.stroke());return a}static getShadowRect(a,b,c=0,d=5,e=2*d){Array.isArray(c)||(c=[c,c,
...
()=>{f.width=d;f.height=e;g.drawImage(h,0,0,f.width,f.height);a(null,f)};h.onError=(b)=>{a(b)};h.src=c}}class pa{static isMf(a){return l.isFunction(a)&&a.__mf}static mf(a){a.__mf=!0;return a}static merge(a,b){const c=Object.keys(a),d=Object.keys(b);if(!d.length)return a;const e={};var f={};for(let a=0,b=d.length;a<b;a++){var g=d[a];e[g]=-1;f[g]=a}for(let a=0,b=c.length;a<b;a++)g=c[a],e[g]=a,void 0===f[g]&&(f[g]=-1);g=c.length;const h={};for(let g=0,n=d.length;g<n;g++){const p=d[g];for(var k=e[p],
m=k;0<=--m&&-1===f[c[m]];);for(;++m<k;){const b=c[m];h[b]=a[b]}k=b[p];m=a[p];k=this.isMf(k)?k(m):l.isObjectLiteral(m)&&l.isObjectLiteral(k)?pa.merge(m,k):k;void 0!==k&&(h[p]=k)}for(b=g;0<=--b&&-1===f[c[b]];);for(;++b<g;)f=c[b],h[f]=a[f];return h}}class qa extends ea{constructor(a){super();this._target=a}onAdd(a,b){this._target.addAt(a,b)}onRemove(a,b){this._target.removeAt(b)}onSync(a,b,c){this._target._setByArray(c)}onSet(a,b){this._target.setAt(a,b)}onMove(a,b,c){this._target.setAt(a,c)}createItem(a){return this._target.createItem(a)}isItem(a){return this._target.isItem(a)}}
