...
"WebGLTexture"===a.constructor.name:a instanceof WebGLTexture}}J.prototype.isTextureSource=!0;J.id=1;class ha{constructor(a){this._view=a.view;this._core=a;this.ctx=this._core.ctx;this._colorize=this.lazy=this._enabled=!1;this._renderTexture=null;this._renderTextureReused=!1;this._resultTextureSource=null;this.empty=this._renderOffscreen=!1}get enabled(){return this._enabled}set enabled(a){this._enabled=a;this._core.updateRenderToTextureEnabled()}get renderOffscreen(){return this._renderOffscreen}set renderOffscreen(a){this._renderOffscreen=
...
class K{constructor(a){this._view=a;this.ctx=a.stage.ctx;this._recalc=0;this._parent=null;this._onUpdate=void 0;this._pRecalc=0;this._worldContext=new G;this._hasUpdates=!1;this._localAlpha=1;this._onAfterUpdate=this._onAfterCalcs=void 0;this._localPy=this._localPx=0;this._localTa=1;this._localTc=this._localTb=0;this._localTd=1;this._isComplex=!1;this._rh=this._rw=0;this._zSort=this._clipping=this._rwhEstimate=!1;this._outOfBounds=0;this._displayedTextureSource=null;this._zContextUsage=0;this._children=
...
(this._viewport[2]=this._rw,this._viewport[3]=this._rh):this._viewport=[0,0,this._rw,this._rh]);this._pRecalc=this._recalc&135;this._recalc=0;this._hasUpdates=!1;if(2>this._outOfBounds){this._useRenderToTexture&&(this._worldContext.isIdentity()?this._renderContext=this._worldContext:this._renderContext=G.IDENTITY);if(this._children)for(let a=0,b=this._children.length;a<b;a++)this._children[a].update();this._useRenderToTexture&&(this._renderContext=b)}else if(this._children)for(let a=0,b=this._children.length;a<
...
this._zIndexedChildren.length;let b=0;var c=this._zIndexedChildren,d=[];for(var e=0;e<a;e++)c[e]._zParent===this&&(c[e]._zIndexResort?(c[e]._zIndexResort=!1,d.push(c[e])):(b!==e&&(c[b]=c[e]),b++));if(a=d.length){d.sort(K.sortZIndexedChildren);const f=b;if(f){let g=b=0,h=0;e=[];do{const k=0<(c[g]._zIndex===d[h]._zIndex?c[g]._updateTreeOrder-d[h]._updateTreeOrder:c[g]._zIndex-d[h]._zIndex)?d[h++]:c[g++];if(0===b||e[b-1]!==k)e[b++]=k;if(g>=f){do if(c=d[h++],0===b||e[b-1]!==c)e[b++]=c;while(h<a);break}else if(h>=
...
(this._texturizer=new ha(this));return this._texturizer}getCornerPoints(){let a=this._worldContext;return[a.px,a.py,a.px+this._rw*a.ta,a.py+this._rw*a.tc,a.px+this._rw*a.ta+this._rh*this.tb,a.py+this._rw*a.tc+this._rh*this.td,a.px+this._rh*this.tb,a.py+this._rh*this.td]}getRenderTextureCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}getAbsoluteCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}}class G{constructor(){this.alpha=1;
this.py=this.px=0;this.ta=1;this.tc=this.tb=0;this.td=1}isIdentity(){return 1===this.alpha&&0===this.px&&0===this.py&&1===this.ta&&0===this.tb&&0===this.tc&&1===this.td}isSquare(){return 0===this.tb&&0===this.tc}}G.IDENTITY=new G;K.sortZIndexedChildren=function(a,b){return a._zIndex===b._zIndex?a._updateTreeOrder-b._updateTreeOrder:a._zIndex-b._zIndex};class D{static defaultSetter(a,b,c){a[b]=c}static patchObject(a,b){if(l.isObjectLiteral(b)){let c=Object.keys(b);for(let d=0,e=c.length;d<e;d++){let e=
...
a&&(this._precision=a,this.updatePrecision())}getRenderWidth(){return(this._w||(this._source?this._source.getRenderWidth()-this._x:0))/this._precision}getRenderHeight(){return(this._h||(this._source?this._source.getRenderHeight()-this._y:0))/this._precision}patch(a){this.stage.patchObject(this,a)}}A.prototype.isTexture=!0;A.id=0;class P extends A{constructor(a){super(a);this._src=void 0;this._hasAlpha=!1}get src(){return this._src}set src(a){this._src!==a&&(this._src=a,this._changed())}get hasAlpha(){return this._hasAlpha}set hasAlpha(a){this._hasAlpha!==
a&&(this._hasAlpha=a,this._changed())}_getIsValid(){return!!this._src}_getLookupId(){return this._src}_getSourceLoader(){let a=this._src,b=this._hasAlpha;if(this.stage.getOption("srcBasePath")){var c=a.charCodeAt(0);-1===a.indexOf("//")&&(65<=c&&90>=c||97<=c&&122>=c||46==c)&&(a=this.stage.getOption("srcBasePath")+a)}const d=this.stage.platform;return function(c){return d.loadSrcTexture({src:a,hasAlpha:b},c)}}getNonDefaults(){const a=super.getNonDefaults();this._src&&(a.src=this._src);return a}}class Da{constructor(a,
b,c){this._stage=a;this._canvas=b;this._context=this._canvas.getContext("2d");this._settings=c}getPrecision(){return this._settings.precision}setFontProperties(){this._context.font=this._getFontSetting();this._context.textBaseline=this._settings.textBaseline}_getFontSetting(){var a=this._settings.fontFace;a='"'+(Array.isArray(a)?this._settings.fontFace.join('","'):a)+'"';return`${this._settings.fontStyle} ${this._settings.fontSize*this.getPrecision()}px ${a}`}_load(){if(l.isWeb&&document.fonts){const a=
this._getFontSetting();try{if(!document.fonts.check(a,this._settings.text))return document.fonts.load(a,this._settings.text).catch((b)=>{console.warn("Font load error",b,a)}).then(()=>{document.fonts.check(a,this._settings.text)||console.warn("Font not found",a)})}catch(b){console.warn("Can't check font loading for "+a)}}}draw(){const a=this._load();if(a)return a.then(()=>{this._draw()});this._draw()}_draw(){let a={};var b=this.getPrecision(),c=this._settings.paddingLeft*b,d=this._settings.paddingRight*
b,e=this._settings.fontSize*b,f=null===this._settings.offsetY?null:this._settings.offsetY*b,g=this._settings.lineHeight*b,h=this._settings.w*b;const k=this._settings.h*b;var m=this._settings.wordWrapWidth*b;const l=this._settings.cutSx*b;var n=this._settings.cutEx*b;const p=this._settings.cutSy*b;var r=this._settings.cutEy*b;this.setFontProperties();var u=h||2048/this.getPrecision(),t=u-c;10>t&&(u+=10-t,t+=10-t);m||(m=t);if(this._settings.wordWrap)var w=this.wrapText(this._settings.text,m);else{w=
{l:this._settings.text.split(/(?:\r\n|\r|\n)/),n:[]};var x=w.l.length;for(var z=0;z<x-1;z++)w.n.push(z)}x=w.l;if(this._settings.maxLines&&x.length>this._settings.maxLines){z=x.slice(0,this._settings.maxLines);if(this._settings.maxLinesSuffix){var y=this._settings.maxLinesSuffix?this._context.measureText(this._settings.maxLinesSuffix).width:0;m=this.wrapText(z[z.length-1],m-y);z[z.length-1]=m.l[0]+this._settings.maxLinesSuffix;m=[1<m.l.length?m.l[1]:""]}else m=[""];let b=x.length,c=0,d=w.n.length;
for(y=this._settings.maxLines;y<b;y++)m[c]+=(m[c]?" ":"")+x[y],y+1<d&&w.n[y+1]&&c++;a.remainingText=m.join("\n");a.moreTextLines=!0;x=z}else a.moreTextLines=!1,a.remainingText="";z=0;w=[];for(m=0;m<x.length;m++)y=this._context.measureText(x[m]).width,w.push(y),z=Math.max(z,y);a.lineWidths=w;h||(u=z+c+d,t=z);g=g||e;h=k?k:g*(x.length-1)+.5*e+Math.max(g,e)+f;null===f&&(f=e);a.w=u;a.h=h;a.lines=x;a.precision=b;u||(u=1);h||(h=1);if(l||n)u=Math.min(u,n-l);if(p||r)h=Math.min(h,r-p);this._canvas.width=Math.ceil(u+
this._stage.getOption("textRenderIssueMargin"));this._canvas.height=Math.ceil(h);this.setFontProperties();128<=e&&(this._context.globalAlpha=.01,this._context.fillRect(0,0,.01,.01),this._context.globalAlpha=1);(l||p)&&this._context.translate(-l,-p);n=[];for(let a=0,b=x.length;a<b;a++)r=0,u=a*g+f,"right"===this._settings.textAlign?r+=t-w[a]:"center"===this._settings.textAlign&&(r+=(t-w[a])/2),r+=c,n.push({text:x[a],x:r,y:u,w:w[a]});if(this._settings.highlight)for(f=this._settings.highlightHeight*b||
1.5*e,e=null!==this._settings.highlightOffset?this._settings.highlightOffset*b:-.5*e,c=null!==this._settings.highlightPaddingLeft?this._settings.highlightPaddingLeft*b:c,d=null!==this._settings.highlightPaddingRight?this._settings.highlightPaddingRight*b:d,this._context.fillStyle=v.getRgbaString(this._settings.highlightColor||0),g=0;g<n.length;g++)t=n[g],this._context.fillRect(t.x-c,t.y+e,t.w+d+c,f);d=null;this._settings.shadow&&(d=[this._context.shadowColor,this._context.shadowOffsetX,this._context.shadowOffsetY,
this._context.shadowBlur],this._context.shadowColor=v.getRgbaString(this._settings.shadowColor),this._context.shadowOffsetX=this._settings.shadowOffsetX*b,this._context.shadowOffsetY=this._settings.shadowOffsetY*b,this._context.shadowBlur=this._settings.shadowBlur*b);this._context.fillStyle=v.getRgbaString(this._settings.textColor);for(let a=0,c=n.length;a<c;a++)b=n[a],this._context.fillText(b.text,b.x,b.y);d&&(this._context.shadowColor=d[0],this._context.shadowOffsetX=d[1],this._context.shadowOffsetY=
d[2],this._context.shadowBlur=d[3]);(l||p)&&this._context.translate(l,p);this.renderInfo=a}wrapText(a,b){a=a.split(/\r?\n/g);let c=[],d=[];for(let e=0;e<a.length;e++){let f=[],g="",h=b,k=a[e].split(" ");for(let a=0;a<k.length;a++){let c=this._context.measureText(k[a]).width,d=c+this._context.measureText(" ").width;0===a||d>h?(0<a&&(f.push(g),g=""),g+=k[a],h=b-c):(h-=d,g+=" "+k[a])}g&&f.push(g);c=c.concat(f);e<a.length-1&&d.push(c.length)}return{l:c,n:d}}}class I extends A{constructor(a){super(a);
this._precision=this.stage.getOption("precision")}get text(){return this._text}set text(a){this._text!==a&&(this._text=""+a,this._changed())}get w(){return this._w}set w(a){this._w!==a&&(this._w=a,this._changed())}get h(){return this._h}set h(a){this._h!==a&&(this._h=a,this._changed())}get fontStyle(){return this._fontStyle}set fontStyle(a){this._fontStyle!==a&&(this._fontStyle=a,this._changed())}get fontSize(){return this._fontSize}set fontSize(a){this._fontSize!==a&&(this._fontSize=a,this._changed())}get fontFace(){return this._fontFace}set fontFace(a){this._fontFace!==
a&&(this._fontFace=a,this._changed())}get wordWrap(){return this._wordWrap}set wordWrap(a){this._wordWrap!==a&&(this._wordWrap=a,this._changed())}get wordWrapWidth(){return this._wordWrapWidth}set wordWrapWidth(a){this._wordWrapWidth!==a&&(this._wordWrapWidth=a,this._changed())}get lineHeight(){return this._lineHeight}set lineHeight(a){this._lineHeight!==a&&(this._lineHeight=a,this._changed())}get textBaseline(){return this._textBaseline}set textBaseline(a){this._textBaseline!==a&&(this._textBaseline=
a,this._changed())}get textAlign(){return this._textAlign}set textAlign(a){this._textAlign!==a&&(this._textAlign=a,this._changed())}get offsetY(){return this._offsetY}set offsetY(a){this._offsetY!==a&&(this._offsetY=a,this._changed())}get maxLines(){return this._maxLines}set maxLines(a){this._maxLines!==a&&(this._maxLines=a,this._changed())}get maxLinesSuffix(){return this._maxLinesSuffix}set maxLinesSuffix(a){this._maxLinesSuffix!==a&&(this._maxLinesSuffix=a,this._changed())}get textColor(){return this._textColor}set textColor(a){this._textColor!==
...
4278190080;p._highlightOffset=0;p._highlightPaddingLeft=0;p._highlightPaddingRight=0;p._cutSx=0;p._cutEx=0;p._cutSy=0;p._cutEy=0;class ia extends A{constructor(a){super(a);this._textureSource=void 0}get textureSource(){return this._textureSource}set textureSource(a){a!==this._textureSource&&(a.isResultTexture&&(this._precision=this.stage.getRenderPrecision()),this._textureSource=a,this._changed())}_getTextureSource(){return this._textureSource}}class Q extends t{constructor(a,b,c,d){super();this.manager=
...
a}get clipbox(){return this.__core.clipbox}set clipbox(a){this.__core.clipbox=a}get tags(){return this.getTags()}set tags(a){Array.isArray(a)||(a=[a]);this.setTags(a)}set t(a){this.tags=a}get _children(){this.__childList||(this.__childList=new Ea(this,!1));return this.__childList}get childList(){this._allowChildrenAccess()||this._throwError("Direct access to children is not allowed in "+this.getLocationString());return this._children}hasChildren(){return this._allowChildrenAccess()&&this.__childList&&
0<this.__childList.length}_allowChildrenAccess(){return!0}get children(){return this.childList.get()}set children(a){this.childList.patch(a)}add(a){return this.childList.a(a)}get parent(){return this.__parent}get src(){if(this.texture&&this.texture instanceof P)return this.texture._src}set src(a){this.texture=new P(this.stage);this.texture.src=a}set mw(a){this.texture?this.texture.mw=a:this._throwError("Please set mw after setting a texture.")}set mh(a){this.texture?this.texture.mh=a:this._throwError("Please set mh after setting a texture.")}get rect(){return this.texture===
...
store:[],rid:0};b=D._preparePatchSettings(b,a);this.parseTemplateRec(b,c,"view");a=c.loc.join(";\n");return{f:new Function("view","store",a),a:c.store}}static parseTemplateRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((f)=>{let g=a[f];if(l.isUcChar(f.charCodeAt(0)))if(l.isObjectLiteral(g)){g=D._preparePatchSettings(g,b.patchId);var h=`r${f.replace(/[^a-z0-9]/gi,"")+b.rid}`,k=g.type?g.type:r;"View"===k?e.push(`const ${h} = view.stage.createView()`):(d.push(k),e.push(`const ${h} = new store[${d.length-
...
!a.isComponent;)a=a.parent;return a}static getParent(a){return x.getComponent(a.parent)}}x.prototype.isComponent=!0;class ka{constructor(a){this.ctx=a;this.quadTextures=[];this.quadViews=[]}get length(){return this.quadTextures.length}reset(){this.quadTextures=[];this.quadViews=[];this.dataLength=0}getView(a){return this.quadViews[a]._view}getViewCore(a){return this.quadViews[a]}getTexture(a){return this.quadTextures[a]}getTextureWidth(a){let b=this.quadTextures[a];return b.w?b.w:this.quadViews[a]._displayedTextureSource.w}getTextureHeight(a){let b=
this.quadTextures[a];return b.h?b.h:this.quadViews[a]._displayedTextureSource.h}}class Fa extends ka{constructor(a){super(a);a=a.stage.getOption("bufferMemory");this.dataLength=0;this.data=new ArrayBuffer(a);this.floats=new Float32Array(this.data);this.uints=new Uint32Array(this.data);a=this.floats;let b=this.uints;a[0]=-1;a[1]=-1;a[2]=0;a[3]=0;b[4]=4294967295;a[5]=1;a[6]=-1;a[7]=1;a[8]=0;b[9]=4294967295;a[10]=1;a[11]=1;a[12]=1;a[13]=1;b[14]=4294967295;a[15]=-1;a[16]=1;a[17]=0;a[18]=1;b[19]=4294967295}getAttribsDataByteOffset(a){return 80*
...
w.fragmentShaderSource="\n    #ifdef GL_ES\n    precision lowp float;\n    #endif\n    varying vec2 vTextureCoord;\n    varying vec4 vColor;\n    uniform sampler2D uSampler;\n    void main(void){\n        gl_FragColor = texture2D(uSampler, vTextureCoord) * vColor;\n    }\n";class oa{constructor(a){this.stage=a;this._defaultShader=void 0}getDefaultShader(a=this.stage.ctx){this._defaultShader||(this._defaultShader=this._createDefaultShader(a));return this._defaultShader}_createDefaultShader(a){}isValidShaderType(a){return a.prototype instanceof
this._getShaderBaseType()}createShader(a,b){const c=b.type||DefaultShader;if(this.isValidShaderType(c))return a=new c(a),this.stage.patchObject(this,b),a;b=this._getShaderAlternative(c);return b?new b(a):(console.warn("Shader has no implementation for render target: "+c.name),this._createDefaultShader(a))}_getShaderBaseType(){}_getShaderAlternative(a){return this.getDefaultShader()}getPatchId(){}copyRenderTexture(a,b,c){console.warn("copyRenderTexture not supported by renderer")}}class Ja extends oa{constructor(a){super(a);
this.shaderPrograms=new Map}destroy(){this.shaderPrograms.forEach((a)=>a.destroy())}_createDefaultShader(a){return new w(a)}_getShaderBaseType(){return R}_getShaderAlternative(a){return a.getWebGL&&a.getWebGL()}createCoreQuadList(a){return new Fa(a)}createCoreQuadOperation(a,b,c,d,e,f){return new Ga(a,b,c,d,e,f)}createCoreRenderExecutor(a){return new Ha(a)}createCoreRenderState(a){return new na(a)}createRenderTexture(a,b,c,d){const e=this.stage.gl,f=e.createTexture();e.bindTexture(e.TEXTURE_2D,f);
...
{this.error({type:"parse",message:"Error parsing image data"})})}_hasAlphaChannel(){return!0}cancel(){this._canceled||(this._xhr&&this._xhr.abort(),this._canceled=!0)}error(a,b){!this._canceled&&this._onError&&this._onError({type:a,message:b})}finish(a){!this._canceled&&this._onFinish&&this._onFinish(a)}}new a};class Qa{init(a){this.stage=a;this._awaitingLoop=this._looping=!1;this.stage.getOption("useImageWorker")&&(window.createImageBitmap&&window.Worker?this._imageWorker=new Na:console.warn("Can't use image worker because browser does not have createImageBitmap and Web Worker support"))}startLoop(){this._looping=
...
document.createElement("canvas");a&&b&&(c.width=a,c.height=b);a=c.getContext("2d");if(!a)throw Error("This browser does not support 2d canvas.");return a}getHrTime(){return window.performance?window.performance.now():(new Date).getTime()}getDrawingCanvas(){return document.createElement("canvas")}getTextureOptionsForDrawingCanvas(a){let b={};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Ra{static load(a){return Qa}}class C{static isFunction(a){return"function"===
typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===a||!1===a}static isString(a){return"string"==typeof a}static isObject(a){let b=typeof a;return!!a&&("object"==b||"function"==b)}static isPlainObject(a){return!!a&&"object"==typeof a}static isObjectLiteral(a){return"object"===typeof a&&a&&a.constructor===Object}static getArrayIndex(a,b){return C.getModuloIndex(a,b.length)}static equalValues(a,b){return typeof a!==
typeof b?!1:C.isObjectLiteral(a)?C.isObjectLiteral(b)&&C.equalObjectLiterals(a,b):Array.isArray(a)?Array.isArray(b)&&C.equalArrays(a,b):a===b}static equalObjectLiterals(a,b){let c=Object.keys(a),d=Object.keys(b);if(c.length!==d.length)return!1;for(let e=0,f=c.length;e<f;e++){const f=c[e],h=d[e];if(f!==h||!C.equalValues(a[f],b[h]))return!1}return!0}static equalArrays(a,b){if(a.length!==b.length)return!1;for(let c=0,d=a.length;c<d;c++)if(!this.equalValues(a[c],b[c]))return!1;return!0}}class E{constructor(a,
...
this._renderTexturePixels-=a.w*a.h}copyRenderTexture(a,b,c){this.stage.renderer.copyRenderTexture(a,b,c)}forceZSort(a){this._zSorts.push(a)}}class T{constructor(a){this.stage=a;this._timingFunction="ease";this._timingFunctionImpl=v.getTimingFunction(this._timingFunction);this.delay=0;this.duration=.2;this.merger=null}get timingFunction(){return this._timingFunction}set timingFunction(a){this._timingFunction=a;this._timingFunctionImpl=v.getTimingFunction(a)}get timingFunctionImpl(){return this._timingFunctionImpl}patch(a){this.stage.patchObject(this,
a)}}T.prototype.isTransitionSettings=!0;class Ua{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set;this.defaultTransitionSettings=new T(this.stage)}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.progress(a);c.isRunning()||(b=!0)});b&&(this.active=new Set([...this.active].filter((a)=>a.isRunning())))}}createSettings(a){let b=new T(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}removeActive(a){this.active.delete(a)}}
...
v.getTimingFunction(a)}get stopTimingFunctionImpl(){return this._stopTimingFunctionImpl}patch(a){this.stage.patchObject(this,a)}}y.STOP_METHODS={FADE:"fade",REVERSE:"reverse",FORWARD:"forward",IMMEDIATE:"immediate",ONETOTWO:"onetotwo"};class n extends t{constructor(a,b,c){super();this.manager=a;this._settings=b;this._view=c;this._state=n.STATES.IDLE;this._stopP=this._stopDelayLeft=this._repeatsLeft=this._delayLeft=this._p=0}start(){this._view&&this._view.attached?(this._p=0,this._delayLeft=this.settings.delay,
...
this._settings.duration*60)}get settings(){return this._settings}}n.STATES={IDLE:0,PLAYING:1,STOPPING:2,STOPPED:3,FINISHED:4,PAUSED:5};class Va{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.isActive()?c.progress(a):b=!0});b&&(this.active=new Set([...this.active].filter((a)=>a.isActive())))}}createAnimation(a,b){l.isObjectLiteral(b)&&(b=this.createSettings(b));
return new n(this,b,a)}createSettings(a){const b=new y(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}}class ra extends A{_getLookupId(){return"__whitepix"}_getSourceLoader(){return function(a){var b=new Uint8Array([255,255,255,255]);a(null,{source:b,w:1,h:1,permanent:!0})}}}class U extends t{constructor(a={}){super();this._setOptions(a);this.platform=new (Ra.load(a));this.platform.init&&this.platform.init(this);this.c2d=this.gl=void 0;(a=this.getOption("context"))?a.useProgram?this.gl=
a:this.c2d=a:!l.isWeb||U.isWebglSupported()&&!this.getOption("canvas2d")?this.gl=this.platform.createWebGLContext(this.getOption("w"),this.getOption("h")):this.c2d=this.platform.createCanvasContext(this.getOption("w"),this.getOption("h"));this.gl&&N.enable(this.gl,"lightning");this._mode=this.gl?0:1;this.getCanvas()&&(this._options.w=this.getCanvas().width,this._options.h=this.getCanvas().height);this._renderer=0===this._mode?new Ja(this):new Ma(this);this.setClearColor(this.getOption("clearColor"));
this.frameCounter=0;this.transitions=new Ua(this);this.animations=new Va(this);this.textureManager=new Sa(this);this._destroyed=!1;this.dt=this.currentTime=this.startTime=0;this.rectangleTexture=new ra(this);this.rectangleTexture.load();this.rectangleTexture.source.permanent=!0;this.ctx=new Ta(this);this._updateSourceTextures=new Set}get renderer(){return this._renderer}static isWebglSupported(){if(l.isNode)return!0;try{return!!window.WebGLRenderingContext}catch(a){return!1}}get mode(){return this._mode}getOption(a){return this._options[a]}_setOptions(a){this._options=
...
v.getRgbaComponentsNormalized(a)}getClearColor(){return this._clearColor}createView(){return new r(this)}view(a){if(a.isView)return a;let b;b=a.type?new a.type(this):new r(this);b.patch(a,!0);return b}c(a){return this.view(a)}get w(){return this._options.w}get h(){return this._options.h}get rw(){return this.w/this._options.precision}get rh(){return this.h/this._options.precision}gcTextureMemory(a=!1){console.log("GC texture memory"+(a?" (aggressive)":""));a&&this.ctx.root.visible?(this.ctx.root.visible=
!1,this.textureManager.freeUnusedTextureSources(),this.ctx.root.visible=!0):this.textureManager.freeUnusedTextureSources()}gcRenderTextureMemory(a=!1){console.log("GC texture render memory"+(a?" (aggressive)":""));a&&this.root.visible?(this.root.visible=!1,this.ctx.freeUnusedRenderTextures(0),this.root.visible=!0):this.ctx.freeUnusedRenderTextures(0)}getDrawingCanvas(){return this.platform.getDrawingCanvas()}patchObject(a,b){b=D.preparePatchSettings(b,this.getPatchId());D.patchObject(a,b)}getPatchId(){return this.renderer.getPatchId()}}
...
this._logPrefix.substr(0,this._logPrefix.length-1)),a;this._fireLevel--;this.debug&&(this._logPrefix=this._logPrefix.substr(0,this._logPrefix.length-1))}}static _executeAction(a,b,c){let d;a.a&&(d=a.a.call(b,c));void 0===d&&(d=a.s);return d}static _getSuperState(a,b){return 0===b?a:a.split(".").slice(0,-b).join(".")}static _compareStatePaths(a,b){a=a.reverse();b=b.reverse();const c=Math.min(a.length,b.length);let d;for(d=0;d<c&&a[d]===b[d];d++);return{exit:a.slice(d),enter:b.slice(d)}}}class F extends x{constructor(a=
{},b){F._temp_options=a;F.booting=!0;super(new U(a.stage),b);F.booting=!1;this.stage.init();this.updateFocusSettings();(this.__keymap=this.getOption("keys"))&&this.stage.platform.registerKeyHandler((a)=>{this._receiveKeydown(a)})}getOption(a){return this.__options[a]}_setOptions(a){this.__options={};let b=(b,d)=>{let c=a[b];this.__options[b]=void 0===c?d:c};b("debug",!1);b("keys",{})}__construct(){this.stage.setApplication(this);this._setOptions(F._temp_options);delete F._temp_options;this.stateManager=
new B;this.stateManager.debug=this.__options.debug;super.__construct()}__init(){super.__init();this.__updateFocus()}updateFocusPath(){this.__updateFocus()}__updateFocus(){this.__updateFocusRec()&&this._handleFocusSettings!==F.prototype._handleFocusSettings&&(F.booting||this.updateFocusSettings())}__updateFocusRec(a=100){var b=this.__getFocusPath();const c=b[b.length-1],d=this._focusPath?this._focusPath[this._focusPath.length-1]:void 0;if(d){var e=Math.min(this._focusPath.length,b.length);let f;for(f=
...
let m=.5*e+1,q=.5*e+1;k.moveTo(m+d[0],q);k.lineTo(m+b-d[1],q);k.arcTo(m+b,q,m+b,q+d[1],d[1]);k.lineTo(m+b,q+c-d[2]);k.arcTo(m+b,q+c,m+b-d[2],q+c,d[2]);k.lineTo(m+d[3],q+c);k.arcTo(m,q+c,m,q+c-d[3],d[3]);k.lineTo(m,q+d[0]);k.arcTo(m,q,m+d[0],q,d[0]);g&&(l.isNumber(h)?k.fillStyle=v.getRgbaString(h):k.fillStyle="white",k.fill());e&&(l.isNumber(f)?k.strokeStyle=v.getRgbaString(f):k.strokeStyle="white",k.lineWidth=e,k.stroke());return a}static getShadowRect(a,b,c=0,d=5,e=2*d){Array.isArray(c)||(c=[c,c,
...
"fixed",this._preloadArea.style.display="block",this._preloadArea.style.top="100vh",this._preloadArea.style.overflow="hidden",document.body.appendChild(this._preloadArea));return this._preloadArea}}class Wa extends A{constructor(a,b){super(a);this._options=b}set options(a){this._options!==a&&(this._options=a,this._changed())}get options(){return this._options}_getIsValid(){return!!this._options}_getSourceLoader(){return(a)=>{a(null,this._options)}}}class Xa extends x{constructor(a){super(a);this._wrapper=
super._children.a({});this._reloadVisibleElements=!1;this._visibleItems=new Set;this._index=0;this._started=!1;this._scrollTransitionSettings=this.stage.transitions.createSettings({});this._itemSize=100;this._itemScrollOffset=this._viewportScrollOffset=0;this._roll=!1;this._rollMax=this._rollMin=0;this._progressAnimation=null;this._invertDirection=!1;this._horizontal=!0;this.itemList=new Ya(this)}_allowChildrenAccess(){return!1}get items(){return this.itemList.get()}set items(a){this.itemList.patch(a)}start(){this._wrapper.transition(this.property,
...
h&&(h=0,c=1),-1>=f&&(f=0,g=1);d=-b*f*this._itemSize;for(let m=f;-1==b?m<=h:m>=h;-1==b?m++:m--){let b=l.getModuloIndex(m,a),n=this.getElement(b);var k=n.parent;this._visibleItems.delete(k);this._horizontal?k.x=d+e:k.y=d+e;let q=k.visible;k.visible=!0;q&&!this._reloadVisibleElements||this.emit("visible",m,b);this._progressAnimation&&(k=1,m==f?k=g:m==h&&(k=c),this._progressAnimation.apply(n,k));d+=this._itemSize}var m=this;this._visibleItems.forEach(function(a){a.visible=!1;m._visibleItems.delete(a)});
...
return{Application:F,Component:x,Base:D,Utils:l,StageUtils:v,View:r,Tools:O,Stage:U,ViewCore:K,ViewTexturizer:ha,Texture:A,EventEmitter:t,shaders:{Grayscale:Y,BoxBlur:H,Dithering:Z,CircularPush:aa,Inversion:Ca,LinearBlur:V,Outline:ba,Pixelate:ca,RadialFilter:da,RadialGradient:ea,Light3d:fa,WebGLShader:R,WebGLDefaultShader:w,C2dShader:S,C2dDefaultShader:M,c2d:{Grayscale:Ba,Blur:ya}},textures:{RectangleTexture:ra,NoiseTexture:wa,TextTexture:I,ImageTexture:P,HtmlTexture:xa,StaticTexture:Wa,StaticCanvasTexture:sa,
SourceTexture:ia},components:{FastBlurComponent:Za,SmoothScaleComponent:X,BorderComponent:$a,ListComponent:Xa},tools:{ObjMerger:ta,ObjectListProxy:ua,ObjectListWrapper:va}}}();
