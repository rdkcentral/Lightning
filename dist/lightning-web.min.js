...
l,m;var e=0!==b.tb||0!==b.tc||0>b.ta||0>b.td;e?(c=Math.min(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,l=Math.max(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,h=Math.min(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py,m=Math.max(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py):(c=b.px,l=b.px+b.ta*this._rw,h=b.py,m=b.py+b.td*this._rh);if(this._rwhEstimate&&(e||1>this._localTa||1>this._localTb)){var f=this._x*a.ta+this._y*a.tb+a.px,
g=this._x*a.tc+this._y*a.td+a.py;f<c&&(c=f);g<h&&(h=g);f>l&&(l=f);g>m&&(m=g)}if(d&6||!this._scissor)if(this._clipping&&b.isSquare())if(f=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor){g=Math.max(f[0],c);const a=Math.max(f[1],h);this._scissor=[g,a,Math.min(f[2]+f[0],l)-g,Math.min(f[3]+f[1],m)-a]}else this._scissor=[c,h,l-c,m-h];else this._scissor=this._parent._useRenderToTexture?this._parent._viewport:this._parent._scissor;this._recBoundsMargin=void 0!==this._boundsMargin?
this._boundsMargin:this._parent._recBoundsMargin;this._onAfterCalcs&&this._onAfterCalcs(this.view)&&(e?(c=Math.min(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,l=Math.max(0,this._rw*b.ta,this._rw*b.ta+this._rh*b.tb,this._rh*b.tb)+b.px,h=Math.min(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py,m=Math.max(0,this._rw*b.tc,this._rw*b.tc+this._rh*b.td,this._rh*b.td)+b.py):(c=b.px,l=b.px+b.ta*this._rw,h=b.py,m=b.py+b.td*this._rh),this._rwhEstimate&&(e||1>this._localTa||
1>this._localTb)&&(e=this._x*a.ta+this._y*a.tb+a.px,a=this._x*a.tc+this._y*a.td+a.py,e<c&&(c=e),a<h&&(h=a),e>l&&(l=e),a>m&&(m=a)));if(2===this._parent._outOfBounds)this._outOfBounds=2,this._withinBoundsMargin&&(this._withinBoundsMargin=!1,this.view._disableWithinBoundsMargin());else if(d&6){this._outOfBounds=0;d=!0;if(!this._renderToTextureEnabled||!this._texturizer||!this._texturizer.renderOffscreen){if(this._scissor&&(0>=this._scissor[2]||0>=this._scissor[3]))this._outOfBounds=2;else{if(this._scissor[0]>
l||this._scissor[1]>m||c>this._scissor[0]+this._scissor[2]||h>this._scissor[1]+this._scissor[3])this._outOfBounds=1;this._outOfBounds&&(this._clipping||this._useRenderToTexture||this._clipbox)&&(this._outOfBounds=2)}d=0===this._outOfBounds;!d&&this._recBoundsMargin&&(d=!(l<this._scissor[0]-this._recBoundsMargin[2]||m<this._scissor[1]-this._recBoundsMargin[3]||c>this._scissor[0]+this._scissor[2]+this._recBoundsMargin[0]||h>this._scissor[1]+this._scissor[3]+this._recBoundsMargin[1]))&&2===this._outOfBounds&&
...
!1,d.push(c[e])):(b!==e&&(c[b]=c[e]),b++));if(a=d.length){d.sort(L.sortZIndexedChildren);const f=b;if(f){let g=b=0,h=0;e=[];do{const l=0<(c[g]._zIndex===d[h]._zIndex?c[g]._updateTreeOrder-d[h]._updateTreeOrder:c[g]._zIndex-d[h]._zIndex)?d[h++]:c[g++];if(0===b||e[b-1]!==l)e[b++]=l;if(g>=f){do if(c=d[h++],0===b||e[b-1]!==c)e[b++]=c;while(h<a);break}else if(h>=a){do if(d=c[g++],0===b||e[b-1]!==d)e[b++]=d;while(g<f);break}}while(1);this._zIndexedChildren=e}else{e=b=0;do c[b++]=d[e++];while(e<a);c.length>
...
b,this._context.shadowOffsetY=this._settings.shadowOffsetY*b,this._context.shadowBlur=this._settings.shadowBlur*b);this._context.fillStyle=q.getRgbaString(this._settings.textColor);for(let a=0,c=D.length;a<c;a++)b=D[a],this._context.fillText(b.text,b.x,b.y);d&&(this._context.shadowColor=d[0],this._context.shadowOffsetX=d[1],this._context.shadowOffsetY=d[2],this._context.shadowBlur=d[3]);(k||n)&&this._context.translate(k,n);this.renderInfo=a}wrapText(a,b){a=a.split(/\r?\n/g);let c=[],d=[];for(let e=
0;e<a.length;e++){let f=[],g="",h=b,l=a[e].split(" ");for(let a=0;a<l.length;a++){let c=this._context.measureText(l[a]).width,d=c+this._context.measureText(" ").width;0===a||d>h?(0<a&&(f.push(g),g=""),g+=l[a],h=b-c):(h-=d,g+=" "+l[a])}g&&f.push(g);c=c.concat(f);e<a.length-1&&d.push(c.length)}return{l:c,n:d}}}class J extends A{constructor(a){super(a);this._precision=this.stage.getOption("precision")}get text(){return this._text}set text(a){this._text!==a&&(this._text=""+a,this._changed())}get w(){return this._w}set w(a){this._w!==
...
this._view.stage.createView()}isItem(a){return a.isView}}class r{constructor(a){this._hasEventListeners=!1;this.__id=r.id++;this.stage=a;this.__core=new L(this);this.__ref=null;this.__active=this.__enabled=this.__attached=!1;this.__tagToComplex=this.__tagsCache=this.__treeTags=this.__tags=this.__displayedTexture=this.__texture=this.__parent=null;this.__tagRoot=!1;this.__childList=null}get id(){return this.__id}set ref(a){if(this.__ref!==a){const b=a.charCodeAt(0);k.isUcChar(b)||this._throwError("Ref must start with an upper case character: "+
...
this._isEnabled()||this._updateDimensions())}_enableTextureError(){const a=this.__texture.loadError;a&&this.emit("txError",a,this.__texture._source)}_enableTexture(){this.__texture.isLoaded()?this._setDisplayedTexture(this.__texture):(this._setDisplayedTexture(null),this._enableTextureError())}_disableTexture(){this._setDisplayedTexture(null)}get texture(){return this.__texture}set texture(a){let b;if(k.isObjectLiteral(a))(b=a.type?new a.type(this.stage):this.texture)&&this.stage.patchObject(b,a);
...
else if(a=k.iteratorToArray(this.__treeTags.keys()),b=a.length,0<b)for(let c=0;c<b;c++){let b=this.__treeTags.get(a[c]),e=this;for(;e=e.__parent;){let d=e.__treeTags.get(a[c]);b.forEach(function(a){d.delete(a)});e._clearTagsCache(a[c]);if(e.__tagRoot)break}}}_setTagsParent(){this.__treeTags&&this.__treeTags.size&&(this.__tagRoot?this.__tags&&this.__tags.forEach((a)=>{let b=this;for(;b=b.__parent;){b.__treeTags||(b.__treeTags=new Map);let c=b.__treeTags.get(a);c||(c=new Set,b.__treeTags.set(a,c));
c.add(this);b._clearTagsCache(a);if(b.__tagRoot)break}}):this.__treeTags.forEach((a,b)=>{let c=this;for(;!c.__tagRoot&&(c=c.__parent);){c.__treeTags||(c.__treeTags=new Map);let d=c.__treeTags.get(b);d||(d=new Set,c.__treeTags.set(b,d));a.forEach(function(a){d.add(a)});c._clearTagsCache(b)}}))}_getByTag(a){return this.__treeTags?(a=this.__treeTags.get(a))?k.setToArray(a):[]:[]}getTags(){return this.__tags?this.__tags:[]}setTags(a){a=a.reduce((a,b)=>a.concat(b.split(" ")),[]);this.__ref&&a.push(this.__ref);
let b,c=a.length,d=[],e=[];for(b=0;b<c;b++)this.hasTag(a[b])||e.push(a[b]);let f=this.tags||[];c=f.length;for(b=0;b<c;b++)-1==a.indexOf(f[b])&&d.push(f[b]);for(b=0;b<d.length;b++)this.removeTag(d[b]);for(b=0;b<e.length;b++)this.addTag(e[b])}addTag(a){if(-1===a.indexOf(" "))k.isUcChar(a.charCodeAt(0))&&this._throwError("Tag may not start with an upper case character."),this._addTag(a);else{a=a.split(" ");for(let b=0,c=a.length;b<c;b++){const c=a[b];k.isUcChar(c.charCodeAt(0))&&this._throwError("Tag may not start with an upper case character.");
...
b){var c=a.children;delete a.children;let d=["color","colorUl","colorUr","colorBl","colorBr"];a=JSON.stringify(a,function(a,b){return-1!==d.indexOf(a)?"COLOR["+b.toString(16)+"]":b});a=a.replace(/"COLOR\[([a-f0-9]{1,8})\]"/g,"0x$1");if(c){let d="";if(k.isObjectLiteral(c)){var e=Object.keys(c);d="";for(let a=0,f=e.length;a<f;a++)d+=`\n${b}  "${e[a]}":`,delete c[e[a]].ref,d+=r.getPrettyString(c[e[a]],b+"  ")+(a<f-1?",":"");c="{}"===a;a=a.substr(0,a.length-1)+(c?"":",")+d+"\n"+b+"}"}else{e=c.length;
...
this.stage.rectangleTexture}set rect(a){this.texture=a?this.stage.rectangleTexture:null}enableTextTexture(){this.texture&&this.texture instanceof J||(this.texture=new J(this.stage),this.texture.w||this.texture.h||(this.texture.w=this.w,this.texture.h=this.h));return this.texture}get text(){if(this.texture&&this.texture instanceof J)return this.texture}set text(a){this.texture&&this.texture instanceof J||this.enableTextTexture();k.isString(a)?this.texture.text=a:this.texture.patch(a)}set onUpdate(a){this.__core.onUpdate=
...
new Map;class x extends r{constructor(a,b){super(a);this.tagRoot=!0;k.isObjectLiteral(b)&&Object.assign(this,b);this.__state="";this.__firstEnable=this.__firstActive=this.__initialized=!1;this.__passSignals=this.__signals=void 0;this.__construct();a=this.constructor.getTemplateFunc(a);a.f(this,a.a)}static getTemplateFunc(a){a=a.getPatchId();const b="_templateFunc_"+a,c="__has"+b;this[c]!==this&&(this[c]=this,this[b]=this.parseTemplate(a?"_$"+a:a,this._template()));return this[b]}static parseTemplate(a,
b){const c={patchId:a,loc:[],store:[],rid:0};b=E._preparePatchSettings(b,a);this.parseTemplateRec(b,c,"view");a=c.loc.join(";\n");return{f:new Function("view","store",a),a:c.store}}static parseTemplateRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((f)=>{let g=a[f];if(k.isUcChar(f.charCodeAt(0)))if(k.isObjectLiteral(g)){g=E._preparePatchSettings(g,b.patchId);var h=`r${f.replace(/[^a-z0-9]/gi,"")+b.rid}`,l=g.type?g.type:r;"View"===l?e.push(`const ${h} = view.stage.createView()`):(d.push(l),
e.push(`const ${h} = new store[${d.length-1}](${c}.stage)`));e.push(`${h}.ref = "${f}"`);b.rid++;this.parseTemplateRec(g,b,h);e.push(`${c}.childList.add(${h})`)}else k.isObject(g)&&(d.push(g),e.push(`${c}.childList.add(store[${d.length-1}])`));else"text"===f?(f=c+"__text",e.push(`${f} = ${c}.enableTextTexture()`),this.parseTemplatePropRec(g,b,f)):"texture"===f&&k.isObjectLiteral(g)?(h=c+"__texture",(l=g.type)?(d.push(l),e.push(`${h} = new store[${d.length-1}](${c}.stage)`),this.parseTemplatePropRec(g,
b,h),e.push(`${c}["${f}"] = ${h}`)):(e.push(`${h} = ${c}.texture`),this.parseTemplatePropRec(g,b,h))):k.isNumber(g)?e.push(`${c}["${f}"] = ${g}`):k.isBoolean(g)?e.push(`${c}["${f}"] = ${g?"true":"false"}`):k.isObject(g)||Array.isArray(g)?(d.push(g),e.push(`${c}["${f}"] = store[${d.length-1}]`)):e.push(`${c}["${f}"] = ${JSON.stringify(g)}`)})}static parseTemplatePropRec(a,b,c){const d=b.store,e=b.loc;Object.keys(a).forEach((b)=>{if("type"!==b){const f=a[b];k.isNumber(f)?e.push(`${c}["${b}"] = ${f}`):
k.isBoolean(f)?e.push(`${c}["${b}"] = ${f?"true":"false"}`):k.isObject(f)||Array.isArray(f)?(d.push(f),e.push(`${c}["${b}"] = store[${d.length-1}]`)):e.push(`${c}["${b}"] = ${JSON.stringify(f)}`)}})}_onSetup(){this.__initialized||this.fire("_setup")}_onAttach(){this.__initialized||(this.__init(),this.__initialized=!0);this.fire("_attach")}_onDetach(){this.fire("_detach")}_onEnabled(){this.__firstEnable||(this.fire("_firstEnable"),this.__firstEnable=!0);this.fire("_enable")}_onDisabled(){this.fire("_disable")}_onActive(){this.__firstActive||
...
this._throwError("Broadcasts: specify an object with broadcast-to-fire mappings");this.__broadcasts=Object.assign(this.__broadcasts||{},a)}static getComponent(a){for(;a&&!a.isComponent;)a=a.parent;return a}static getParent(a){return x.getComponent(a.parent)}}x.prototype.isComponent=!0;class la{constructor(a){this.ctx=a;this.quadTextures=[];this.quadViews=[]}get length(){return this.quadTextures.length}reset(){this.quadTextures=[];this.quadViews=[];this.dataLength=0}getView(a){return this.quadViews[a]._view}getViewCore(a){return this.quadViews[a]}getTexture(a){return this.quadTextures[a]}getTextureWidth(a){let b=
this.quadTextures[a];return b.w?b.w:this.quadViews[a]._displayedTextureSource.w}getTextureHeight(a){let b=this.quadTextures[a];return b.h?b.h:this.quadViews[a]._displayedTextureSource.h}}class Ga extends la{constructor(a){super(a);a=a.stage.getOption("bufferMemory");this.dataLength=0;this.data=new ArrayBuffer(a);this.floats=new Float32Array(this.data);this.uints=new Uint32Array(this.data);a=this.floats;let b=this.uints;a[0]=-1;a[1]=-1;a[2]=0;a[3]=0;b[4]=4294967295;a[5]=1;a[6]=-1;a[7]=1;a[8]=0;b[9]=
...
w.fragmentShaderSource="\n    #ifdef GL_ES\n    precision lowp float;\n    #endif\n    varying vec2 vTextureCoord;\n    varying vec4 vColor;\n    uniform sampler2D uSampler;\n    void main(void){\n        gl_FragColor = texture2D(uSampler, vTextureCoord) * vColor;\n    }\n";class pa{constructor(a){this.stage=a;this._defaultShader=void 0}destroy(){}getDefaultShader(a=this.stage.ctx){this._defaultShader||(this._defaultShader=this._createDefaultShader(a));return this._defaultShader}_createDefaultShader(a){}isValidShaderType(a){return a.prototype instanceof
...
a}}static _equalScissorAreas(a,b,c){b||(b=[0,0,a.width,a.height]);c||(c=[0,0,a.width,a.height]);return k.equalValues(b,c)}}class T extends M{beforeDraw(a){}draw(a){}afterDraw(a){}}class N extends T{constructor(a){super(a);this._rectangleTexture=a.stage.rectangleTexture.source.nativeTexture}draw(a,b){const c=b.ctx;let d=a.length;for(let m=0;m<d;m++){const d=a.getTexture(m),k=a.getViewCore(m);var e=a.getRenderContext(m),f=a.getWhite(m),g=a.getSimpleTc(m),h=this.ctx.stage.getRenderPrecision();c.setTransform(e.ta*
h,e.tc*h,e.tb*h,e.td*h,e.px*h,e.py*h);var l=d===this._rectangleTexture;h={operation:a,target:b,index:m,rect:l};if(l)f?c.fillStyle="white":this._setColorGradient(c,k),c.globalAlpha=e.alpha,this._beforeDrawEl(h),c.fillRect(0,0,k.rw,k.rh);else{c.globalAlpha=e.alpha;this._beforeDrawEl(h);e=g?0:k._ulx*d.w;l=g?0:k._uly*d.h;const a=(g?1:k._brx-k._ulx)*d.w;g=(g?1:k._bry-k._uly)*d.h;if(f)c.drawImage(d,e,l,a,g,0,0,k.rw,k.rh);else{f=this.ctx.stage.renderer.getTintTexture(Math.ceil(a),Math.ceil(g));let b=k._colorUl;
if(k._colorUl!==k._colorUr||k._colorUr!==k._colorBl||k._colorBr!==k._colorBl)b=q.mergeMultiColorsEqual([k._colorUl,k._colorUr,k._colorBl,k._colorBr]);c.globalAlpha*=b/16777216|0;f.ctx.fillStyle=q.getRgbString(b);this._setColorGradient(f.ctx,k,a,g,!1);f.ctx.globalCompositeOperation="copy";f.ctx.fillRect(0,0,a,g);f.ctx.globalCompositeOperation="multiply";f.ctx.drawImage(d,e,l,a,g,0,0,a,g);f.ctx.globalCompositeOperation="destination-in";f.ctx.drawImage(d,e,l,a,g,0,0,a,g);f.ctx.globalCompositeOperation=
"source-over";c.fillStyle="white";c.drawImage(f,0,0,a,g,0,0,k.rw,k.rh)}}this._afterDrawEl(h);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,g;b._colorUl===b._colorUr?b._colorBl===b._colorBr&&b._colorUl!==b.colorBl&&(g=a.createLinearGradient(0,0,0,d),e?(g.addColorStop(0,q.getRgbaString(b._colorUl)),g.addColorStop(1,q.getRgbaString(b._colorBl))):(g.addColorStop(0,q.getRgbString(b._colorUl)),g.addColorStop(1,q.getRgbString(b._colorBl)))):b._colorUl===b._colorBl&&b._colorUr===
b._colorBr&&(g=a.createLinearGradient(0,0,c,0),e?(g.addColorStop(0,q.getRgbaString(b._colorUl)),g.addColorStop(1,q.getRgbaString(b._colorBr))):(g.addColorStop(0,q.getRgbString(b._colorUl)),g.addColorStop(1,q.getRgbString(b._colorBr))));a.fillStyle=g?g:e?q.getRgbaString(f):q.getRgbString(f)}_beforeDrawEl(a){}_afterDrawEl(a){}}class Na extends pa{constructor(a){super(a);this.setupC2d(this.stage.c2d.canvas)}destroy(){this._tintTexture=void 0}_createDefaultShader(a){return new N(a)}_getShaderBaseType(){return T}_getShaderAlternative(a){return a.getC2d&&
...
document.createElement("canvas");a&&b&&(c.width=a,c.height=b);a=c.getContext("2d");if(!a)throw Error("This browser does not support 2d canvas.");return a}getHrTime(){return window.performance?window.performance.now():(new Date).getTime()}getDrawingCanvas(){return document.createElement("canvas")}getTextureOptionsForDrawingCanvas(a){let b={};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Sa{static load(a){return Ra}}class C{static isFunction(a){return"function"===
...
class u{constructor(){this._clear()}_clear(){this._p=[];this._pe=[];this._idp=[];this._f=[];this._v=[];this._lv=[];this._sm=[];this._s=[];this._ve=[];this._sme=[];this._se=[];this._length=0}parse(a,b){k.isObjectLiteral(b)||(b={0:b});let c=.5,d=[];for(g in b)if(b.hasOwnProperty(g)){var e=b[g];k.isObjectLiteral(e)||(e={v:e});var f=parseFloat(g);"sm"===g?c=e.v:!isNaN(f)&&0<=f&&2>=f&&(e.p=f,e.f=k.isFunction(e.v),e.lv=e.f?e.v(0,0):e.v,d.push(e))}d=d.sort(function(a,b){return a.p-b.p});var g=d.length;for(b=
...
this._getItem(a);if(-1!==b)return this._f[b]?this._v[b](Math.min(1,Math.max(0,(a-this._p[b])*this._idp[b]))):this._v[b]}get length(){return this._length}static getRgbaComponents(a){return[(a/65536|0)%256,(a/256|0)%256,a%256,a/16777216|0]}static getSplineValueFunction(a,b,c,d,e,f,g,h){c=d-c;let l=u.getSplineHelpers(a,b,e,f,g*c,h*c);return l?function(c){return 0===c?a:1===c?b:u.calculateSpline(l,c)}:function(c){return 0===c?a:1===c?b:b*c+a*(1-c)}}static getSplineRgbaValueFunction(a,b,c,d,e,f,g,h){c=
d-c;g[0]*=c;g[1]*=c;g[2]*=c;g[3]*=c;h[0]*=c;h[1]*=c;h[2]*=c;h[3]*=c;c=u.getRgbaComponents(a);d=u.getRgbaComponents(b);let l=[u.getSplineHelpers(c[0],d[0],e,f,g[0],h[0]),u.getSplineHelpers(c[1],d[1],e,f,g[1],h[1]),u.getSplineHelpers(c[2],d[2],e,f,g[2],h[2]),u.getSplineHelpers(c[3],d[3],e,f,g[3],h[3])];return l[0]?function(c){return 0===c?a:1===c?b:u.getArgbNumber([Math.min(255,u.calculateSpline(l[0],c)),Math.min(255,u.calculateSpline(l[1],c)),Math.min(255,u.calculateSpline(l[2],c)),Math.min(255,u.calculateSpline(l[3],
c))])}:function(c){return 0===c?a:1===c?b:u.mergeColors(b,a,c)}}static getSplineHelpers(a,b,c,d,e,f){if(!c&&!d)return null;e=a+e*c;let g=1-d;d=b-f*d;return[3*c-3*g+1,-6*c+3*g,3*c,3*e-3*d+b-a,3*(d+a)-6*e,3*(e-a),a]}static calculateSpline(a,b){let c=a[0],d=a[1],e=a[2],f=a[3],g=a[4],h=a[5];a=a[6];if(-2===c&&-2===f&&0===e&&0===h)return b;let l=.5;for(var k=0;20>k;k++){var t=l*(l*(l*c+d)+e);t=b-t;if(-1E-8<t&&1E-8>t)return l*(l*(l*f+g)+h)+a;var n=l*(3*l*c+2*d)+e;if(1E-10<n&&1E-10>n)break;l+=t/n}k=0;n=1;
for(let m=0;20>m;m++){l=.5*(k+n);t=l*(l*(l*c+d)+e);t=b-t;if(-1E-8<t&&1E-8>t)return l*(l*(l*f+g)+h)+a;0>t?n=l:k=l}return l}static mergeColors(a,b,c){return 16777216*Math.round((a/16777216|0)*c+(b/16777216|0)*(1-c))+65536*Math.round((a/65536|0)%256*c+(b/65536|0)%256*(1-c))+256*Math.round((a/256|0)%256*c+(b/256|0)%256*(1-c))+Math.round(a%256*c+b%256*(1-c))}static getArgbNumber(a){a[0]=Math.max(0,Math.min(255,a[0]));a[1]=Math.max(0,Math.min(255,a[1]));a[2]=Math.max(0,Math.min(255,a[2]));a[3]=Math.max(0,
Math.min(255,a[3]));a=((a[3]|0)<<24)+((a[0]|0)<<16)+((a[1]|0)<<8)+(a[2]|0);0>a&&(a=4294967295+a+1);return a}}class ra{constructor(a){this.animationSettings=a;this._selector="";this._items=new u;this._props=[];this._propSetters=[];this._resetValue=void 0;this._hasResetValue=!1;this._hasColorProperty=void 0}getResetValue(){return this._hasResetValue?this._resetValue:this._items.getValue(0)}apply(a,b,c){a=this.getAnimatedViews(a);b=this._items.getValue(b);if(void 0!==b&&a.length){if(1!==c){var d=this.getResetValue();
k.isNumber(b)&&k.isNumber(d)&&(b=this.hasColorProperty()?q.mergeColors(b,d,c):q.mergeNumbers(b,d,c))}c=this._propSetters.length;d=a.length;for(let e=0;e<d;e++)for(let d=0;d<c;d++)this._propSetters[d](a[e],b)}}getAnimatedViews(a){return a.select(this._selector)}reset(a){a=this.getAnimatedViews(a);let b=this.getResetValue();if(void 0!==b&&a.length){var c=this._propSetters.length,d=a.length;for(let e=0;e<d;e++)for(let d=0;d<c;d++)this._propSetters[d](a[e],b)}}set selector(a){this._selector=a}set t(a){this.selector=
...
(a?" (aggressive)":""));a&&this.ctx.root.visible?(this.ctx.root.visible=!1,this.textureManager.freeUnusedTextureSources(),this.ctx.root.visible=!0):this.textureManager.freeUnusedTextureSources()}gcRenderTextureMemory(a=!1){console.log("GC texture render memory"+(a?" (aggressive)":""));a&&this.root.visible?(this.root.visible=!1,this.ctx.freeUnusedRenderTextures(0),this.root.visible=!0):this.ctx.freeUnusedRenderTextures(0)}getDrawingCanvas(){return this.platform.getDrawingCanvas()}patchObject(a,b){b=
E.preparePatchSettings(b,this.getPatchId());E.patchObject(a,b)}getPatchId(){return this.renderer.getPatchId()}}class B{constructor(){this._fireLevel=0;this._logPrefix="";this._debug=!1}get debug(){return this._debug}set debug(a){this._debug=a}fire(a,b,c){const d=0===this._fireLevel;this._fireLevel++;this.debug&&(this._logPrefix=d?"":this._logPrefix+" ");let e;try{(e=Array.isArray(b)?this._mfire(a,b,c):this._fire(a,b,c))&&d&&a.application.__updateFocus()}catch(f){console.error(`${a.constructor.name} "${a.state}".${b} ${a.getLocationString()}`),
...
a((a,d)=>{if(a)return b(a);b(null,this.stage.platform.getTextureOptionsForDrawingCanvas(d))},this.stage)}}class P{static getCanvasTexture(a,b){return{type:ta,content:{factory:a,lookupId:b}}}static getRoundRect(a,b,c,d,e,f,g){Array.isArray(c)||(c=[c,c,c,c]);let h="rect"+[a,b,d,e,f?1:0,g].concat(c).join(",");return P.getCanvasTexture((h,k)=>{h(null,this.createRoundRect(k,a,b,c,d,e,f,g))},h)}static createRoundRect(a,b,c,d,e,f,g,h){void 0===g&&(g=!0);void 0===e&&(e=0);a=a.platform.getDrawingCanvas();
let l=a.getContext("2d");l.imageSmoothingEnabled=!0;a.width=b+e+2;a.height=c+e+2;l.beginPath();let m=.5*e+1,t=.5*e+1;l.moveTo(m+d[0],t);l.lineTo(m+b-d[1],t);l.arcTo(m+b,t,m+b,t+d[1],d[1]);l.lineTo(m+b,t+c-d[2]);l.arcTo(m+b,t+c,m+b-d[2],t+c,d[2]);l.lineTo(m+d[3],t+c);l.arcTo(m,t+c,m,t+c-d[3],d[3]);l.lineTo(m,t+d[0]);l.arcTo(m,t,m+d[0],t,d[0]);g&&(k.isNumber(h)?l.fillStyle=q.getRgbaString(h):l.fillStyle="white",l.fill());e&&(k.isNumber(f)?l.strokeStyle=q.getRgbaString(f):l.strokeStyle="white",l.lineWidth=
e,l.stroke());return a}static getShadowRect(a,b,c=0,d=5,e=2*d){Array.isArray(c)||(c=[c,c,c,c]);let f="shadow"+[a,b,d,e].concat(c).join(",");return P.getCanvasTexture((f,h)=>{f(null,this.createShadowRect(h,a,b,c,d,e))},f)}static createShadowRect(a,b,c,d,e,f){a=a.platform.getDrawingCanvas();let g=a.getContext("2d");g.imageSmoothingEnabled=!0;a.width=b+2*f;a.height=c+2*f;g.globalAlpha=.01;g.fillRect(0,0,.01,.01);g.globalAlpha=1;g.shadowColor=q.getRgbaString(4294967295);g.fillStyle=q.getRgbaString(4294967295);
...
g=f.getContext("2d");g.imageSmoothingEnabled=!0;let h=new Image;h.onload=()=>{f.width=d;f.height=e;g.drawImage(h,0,0,f.width,f.height);a(null,f)};h.onError=(b)=>{a(b)};h.src=c}}class ua{static isMf(a){return k.isFunction(a)&&a.__mf}static mf(a){a.__mf=!0;return a}static merge(a,b){const c=Object.keys(a),d=Object.keys(b);if(!d.length)return a;const e={};var f={};for(let a=0,b=d.length;a<b;a++){var g=d[a];e[g]=-1;f[g]=a}for(let a=0,b=c.length;a<b;a++)g=c[a],e[g]=a,void 0===f[g]&&(f[g]=-1);g=c.length;
const h={};for(let g=0,n=d.length;g<n;g++){const n=d[g];for(var l=e[n],m=l;0<=--m&&-1===f[c[m]];);for(;++m<l;){const b=c[m];h[b]=a[b]}l=b[n];m=a[n];l=this.isMf(l)?l(m):k.isObjectLiteral(m)&&k.isObjectLiteral(l)?ua.merge(m,l):l;void 0!==l&&(h[n]=l)}for(b=g;0<=--b&&-1===f[c[b]];);for(;++b<g;)f=c[b],h[f]=a[f];return h}}class va extends ka{constructor(a){super();this._target=a}onAdd(a,b){this._target.addAt(a,b)}onRemove(a,b){this._target.removeAt(b)}onSync(a,b,c){this._target._setByArray(c)}onSet(a,b){this._target.setAt(a,
b)}onMove(a,b,c){this._target.setAt(a,c)}createItem(a){return this._target.createItem(a)}isItem(a){return this._target.isItem(a)}}class wa extends va{constructor(a,b){super(a);this._wrap=b}wrap(a){let b=this._wrap(a);return a._wrapper=b}onAdd(a,b){a=this.wrap(a);super.onAdd(a,b)}onRemove(a,b){super.onRemove(a,b)}onSync(a,b,c){b.forEach((a)=>this.wrap(a));c=c.map((a)=>a._wrapper);super.onSync(a,b,c)}onSet(a,b){a=this.wrap(a);super.onSet(a,b)}onMove(a,b,c){super.onMove(a,b,c)}}class xa extends A{_getLookupId(){return"__noise"}_getSourceLoader(){const a=
this.stage.gl;return function(b){const c=new Uint8Array(65536);for(var d=0;65536>d;d+=4){const a=Math.floor(256*Math.random());c[d]=a;c[d+1]=a;c[d+2]=a;c[d+3]=255}d={};a&&(d[a.TEXTURE_WRAP_S]=a.REPEAT,d[a.TEXTURE_WRAP_T]=a.REPEAT,d[a.TEXTURE_MIN_FILTER]=a.NEAREST,d[a.TEXTURE_MAG_FILTER]=a.NEAREST);b(null,{source:c,w:128,h:128,texParams:d})}}}class ya extends A{constructor(a){super(a);this._htmlElement=void 0;this._scale=1}set htmlElement(a){this._htmlElement=a;this._changed()}get htmlElement(){return this._htmlElement}set scale(a){this._scale=
...
return{Application:G,Component:x,Base:E,Utils:k,StageUtils:q,View:r,Tools:P,Stage:V,ViewCore:L,ViewTexturizer:ia,Texture:A,EventEmitter:v,shaders:{Grayscale:Z,BoxBlur:I,Dithering:aa,CircularPush:ba,Inversion:Da,LinearBlur:W,Outline:ca,Pixelate:da,RadialFilter:ea,RadialGradient:fa,Light3d:ha,WebGLShader:S,WebGLDefaultShader:w,C2dShader:T,C2dDefaultShader:N,c2d:{Grayscale:Ca,Blur:za}},textures:{RectangleTexture:sa,NoiseTexture:xa,TextTexture:J,ImageTexture:Q,HtmlTexture:ya,StaticTexture:Xa,StaticCanvasTexture:ta,
