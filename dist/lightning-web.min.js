...
!1,d.push(c[e])):(b!==e&&(c[b]=c[e]),b++));if(a=d.length){d.sort(L.sortZIndexedChildren);const f=b;if(f){let g=b=0,h=0;e=[];do{const k=0<(c[g]._zIndex===d[h]._zIndex?c[g]._updateTreeOrder-d[h]._updateTreeOrder:c[g]._zIndex-d[h]._zIndex)?d[h++]:c[g++];if(0===b||e[b-1]!==k)e[b++]=k;if(g>=f){do if(c=d[h++],0===b||e[b-1]!==c)e[b++]=c;while(h<a);break}else if(h>=a){do if(d=c[g++],0===b||e[b-1]!==d)e[b++]=d;while(g<f);break}}while(1);this._zIndexedChildren=e}else{e=b=0;do c[b++]=d[e++];while(e<a);c.length>
b&&c.splice(b)}}else c.length>b&&c.splice(b);this._zSort=!1}get localTa(){return this._localTa}get localTb(){return this._localTb}get localTc(){return this._localTc}get localTd(){return this._localTd}get rw(){return this._rw}get rh(){return this._rh}get view(){return this._view}get renderUpdates(){return this._hasRenderUpdates}get texturizer(){this._texturizer||(this._texturizer=new ia(this));return this._texturizer}getCornerPoints(){let a=this._worldContext;return[a.px,a.py,a.px+this._rw*a.ta,a.py+
this._rw*a.tc,a.px+this._rw*a.ta+this._rh*this.tb,a.py+this._rw*a.tc+this._rh*this.td,a.px+this._rh*this.tb,a.py+this._rh*this.td]}getRenderTextureCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}getAbsoluteCoords(a,b){let c=this._renderContext;return[c.px+c.ta*a+c.tb*b,c.py+c.tc*a+c.td*b]}}class H{constructor(){this.alpha=1;this.py=this.px=0;this.ta=1;this.tc=this.tb=0;this.td=1}isIdentity(){return 1===this.alpha&&0===this.px&&0===this.py&&1===this.ta&&0===this.tb&&
0===this.tc&&1===this.td}isSquare(){return 0===this.tb&&0===this.tc}}H.IDENTITY=new H;L.sortZIndexedChildren=function(a,b){return a._zIndex===b._zIndex?a._updateTreeOrder-b._updateTreeOrder:a._zIndex-b._zIndex};class D{static defaultSetter(a,b,c){a[b]=c}static patchObject(a,b){if(l.isObjectLiteral(b)){let c=Object.keys(b);for(let d=0,e=c.length;d<e;d++){let e=c[d];this.patchObjectProperty(a,e,b[e])}}else console.error("Settings must be object literal")}static preparePatchSettings(a,b){if(b)return this._preparePatchSettings(a,
"_$"+b)}static _preparePatchSettings(a,b){b&&a[b]&&(a=Object.assign({},a,a[b]),delete a[b]);return a}static patchObjectProperty(a,b,c){let d=a.setSetting||D.defaultSetter;"_"===b.charAt(0)?"$"!==b.charAt(1)&&"__create"!==b&&console.error("Patch of private property '"+b+"' is not allowed"):"type"!==b&&(l.isFunction(c)&&c.__local&&(c=c.__local(a)),d(a,b,c))}static local(a){a.__local=!0}}class v{constructor(){this._hasEventListeners=!1}on(a,b){this._hasEventListeners||(this._eventFunction={},this._eventListeners=
{},this._hasEventListeners=!0);this._eventFunction[a]?this._eventFunction[a]!==v.combiner?(this._eventListeners[a]=[this._eventFunction[a],b],this._eventFunction[a]=v.combiner):this._eventListeners[a].push(b):this._eventFunction[a]=b}has(a,b){if(this._hasEventListeners){const c=this._eventFunction[a];if(c){if(c===v.combiner)return 0<=this._eventListeners[a].indexOf(b);if(this._eventFunction[a]===b)return!0}}return!1}off(a,b){if(this._hasEventListeners){var c=this._eventFunction[a];c&&(c===v.combiner?
(c=this._eventListeners[a],b=c.indexOf(b),0<=b&&c.splice(b,1),1===c.length&&(this._eventFunction[a]=c[0],this._eventListeners[a]=void 0)):this._eventFunction[a]===b&&(this._eventFunction[a]=void 0))}}removeListener(a,b){this.off(a,b)}emit(a,b,c,d){if(this._hasEventListeners){const e=this._eventFunction[a];e&&(e===v.combiner?e(this,a,b,c,d):e(b,c,d))}}listenerCount(a){if(this._hasEventListeners){const b=this._eventFunction[a];if(b)return b===v.combiner?this._eventListeners[a].length:1}else return 0}removeAllListeners(a){this._hasEventListeners&&
(delete this._eventFunction[a],delete this._eventListeners[a])}}v.combiner=function(a,b,c,d,e){(a=a._eventListeners[b])&&a.forEach((a)=>{a(c,d,e)})};v.addAsMixin=function(a){a.prototype.on=v.prototype.on;a.prototype.has=v.prototype.has;a.prototype.off=v.prototype.off;a.prototype.removeListener=v.prototype.removeListener;a.prototype.emit=v.prototype.emit;a.prototype.listenerCount=v.prototype.listenerCount};class M{constructor(a){this._initialized=!1;this.ctx=a;this._views=new Set}static create(a,b){let c;
if(l.isObjectLiteral(b))(c=b.type?a.renderer.createShader(a.ctx,b):this.shader)&&a.patchObject(c,b);else if(null===b)c=a.ctx.renderState.defaultShader;else if(void 0===b)c=null;else if(b.isShader)a.renderer.isValidShaderType(b.constructor)||(console.error("Invalid shader type"),b=null),c=b;else{console.error("Please specify a shader type.");return}return c}static getWebGL(){}static getC2d(){}addView(a){this._views.add(a)}removeView(a){this._views.delete(a);this._views||this.cleanup()}redraw(){this._views.forEach((a)=>
{a.setHasRenderUpdates(2)})}patch(a){this.ctx.stage.patchObject(this,a)}useDefault(){return!1}addEmpty(){return!1}cleanup(){}get isShader(){return!0}}class A{constructor(a){this.stage=a;this.manager=this.stage.textureManager;this.id=A.id++;this.views=new Set;this._activeCount=0;this._source=void 0;this._h=this._w=this._y=this._x=0;this._precision=1;this.mh=this.mw=2048;this.clipping=!1;this._mustUpdate=!0}get source(){this._mustUpdate&&(this._performUpdateSource(!0),this.stage.removeUpdateSourceTexture(this));
...
this.source.decActiveTextureCount()}isUsed(){return 0<this._activeCount}_getLookupId(){}_getSourceLoader(){throw Error("Texture.generate must be implemented.");}get isValid(){return this._getIsValid()}_getIsValid(){return!0}_changed(){this.isUsed()?this._updateSource():this._mustUpdate=!0}_updateSource(){this.stage.addUpdateSourceTexture(this)}_performUpdateSource(a=!1){if(a||this.isUsed())this._mustUpdate=!1,a=this._getTextureSource(),this._replaceTextureSource(a)}_getTextureSource(){let a=void 0;
if(this._getIsValid()){const b=this._getLookupId();b&&(a=this.manager.getReusableTextureSource(b));a||(a=this.manager.getTextureSource(this._getSourceLoader(),b))}return a}_replaceTextureSource(a=void 0){let b=this._source;this._source=a;this.views.size&&(b&&(this._activeCount&&b.decActiveTextureCount(),b.removeTexture(this)),a&&(a.addTexture(this),this._activeCount&&a.incActiveTextureCount()));if(this.isUsed())if(a)if(a.isLoaded())this.views.forEach((a)=>{a.active&&a._setDisplayedTexture(this)});
else{const b=a.loadError;b&&this.views.forEach((a)=>{if(a.active)a.onTextureSourceLoadError(b)})}else this.views.forEach((a)=>{a.active&&a._setDisplayedTexture(null)})}load(){this.source&&(this.isLoaded()||this.source.load())}isLoaded(){return this._source&&this._source.isLoaded()}get loadError(){return this._source&&this._source.loadError}free(){this._source&&this._source.free()}enableClipping(a,b,c,d){a*=this._precision;b*=this._precision;c*=this._precision;d*=this._precision;if(this._x!==a||this._y!==
b||this._w!==c||this._h!==d)this._x=a,this._y=b,this._w=c,this._h=d,this.updateClipping(!0)}disableClipping(){if(this._x||this._y||this._w||this._h)this._h=this._w=this._y=this._x=0,this.updateClipping(!1)}updateClipping(a){this.clipping=!0===a||!1===a?a:!!(this._x||this._y||this._w||this._h);let b=this;this.views.forEach(function(a){if(a.displayedTexture===b)a.onDisplayedTextureClippingChanged()})}updatePrecision(){let a=this;this.views.forEach(function(b){if(b.displayedTexture===a)b.onPrecisionChanged()})}getNonDefaults(){let a=
{};a.type=this.constructor.name;0!==this.x&&(a.x=this.x);0!==this.y&&(a.y=this.y);0!==this.w&&(a.w=this.w);0!==this.h&&(a.h=this.h);1!==this.precision&&(a.precision=this.precision);return a}get px(){return this._x}get py(){return this._y}get pw(){return this._w}get ph(){return this._h}get x(){return this._x/this._precision}set x(a){a*=this._precision;this._x!==a&&(this._x=a,this.updateClipping())}get y(){return this._y/this._precision}set y(a){a*=this._precision;this._y!==a&&(this._y=a,this.updateClipping())}get w(){return this._w/
this._precision}set w(a){a*=this._precision;this._w!==a&&(this._w=a,this.updateClipping())}get h(){return this._h/this._precision}set h(a){a*=this._precision;this._h!==a&&(this._h=a,this.updateClipping())}get precision(){return this._precision}set precision(a){this._precision!==a&&(this._precision=a,this.updatePrecision())}getRenderWidth(){return(this._w||(this._source?this._source.getRenderWidth()-this._x:0))/this._precision}getRenderHeight(){return(this._h||(this._source?this._source.getRenderHeight()-
this._y:0))/this._precision}patch(a){this.stage.patchObject(this,a)}}A.prototype.isTexture=!0;A.id=0;class Q extends A{constructor(a){super(a);this._src=void 0;this._hasAlpha=!1}get src(){return this._src}set src(a){this._src!==a&&(this._src=a,this._changed())}get hasAlpha(){return this._hasAlpha}set hasAlpha(a){this._hasAlpha!==a&&(this._hasAlpha=a,this._changed())}_getIsValid(){return!!this._src}_getLookupId(){return this._src}_getSourceLoader(){let a=this._src,b=this._hasAlpha;if(this.stage.getOption("srcBasePath")){var c=
a.charCodeAt(0);-1===a.indexOf("//")&&(65<=c&&90>=c||97<=c&&122>=c||46==c)&&(a=this.stage.getOption("srcBasePath")+a)}const d=this.stage.platform;return function(c){return d.loadSrcTexture({src:a,hasAlpha:b},c)}}getNonDefaults(){const a=super.getNonDefaults();this._src&&(a.src=this._src);return a}}class Ea{constructor(a,b,c){this._stage=a;this._canvas=b;this._context=this._canvas.getContext("2d");this._settings=c}getPrecision(){return this._settings.precision}setFontProperties(){this._context.font=
...
4278190080;p._highlightOffset=0;p._highlightPaddingLeft=0;p._highlightPaddingRight=0;p._cutSx=0;p._cutEx=0;p._cutSy=0;p._cutEy=0;class ja extends A{constructor(a){super(a);this._textureSource=void 0}get textureSource(){return this._textureSource}set textureSource(a){a!==this._textureSource&&(a.isResultTexture&&(this._precision=this.stage.getRenderPrecision()),this._textureSource=a,this._changed())}_getTextureSource(){return this._textureSource}}class R extends v{constructor(a,b,c,d){super();this.manager=
...
b);a[0]/=this.getRenderWidth();a[1]/=this.getRenderHeight();a[0]=2*a[0]-1;a[1]=1-2*a[1];return a}getProjection(){return null===this.renderTextureInfo?this.ctx.renderExec._projection:this.renderTextureInfo.nativeTexture.projection}}class na{constructor(a){this.ctx=a;this.renderState=a.renderState;this.gl=this.ctx.stage.gl}destroy(){}_reset(){this._bindRenderTexture(null);this._setScissor(null);this._clearRenderTexture()}execute(){this._reset();let a=this.renderState.quadOperations,b=0,c=a.length;for(;b<
...
a}_clearRenderTexture(a){}_setScissor(a){}}class Ia extends na{constructor(a){super(a);this.gl=this.ctx.stage.gl;this.init()}init(){let a=this.gl;this._attribsBuffer=a.createBuffer();let b=Math.floor(this.renderState.quads.data.byteLength/80),c=new Uint16Array(6*b);for(let a=0,e=0;a<b;a+=6,e+=4)c[a]=e,c[a+1]=e+1,c[a+2]=e+2,c[a+3]=e,c[a+4]=e+2,c[a+5]=e+3;this._quadsBuffer=a.createBuffer();a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this._quadsBuffer);a.bufferData(a.ELEMENT_ARRAY_BUFFER,c,a.STATIC_DRAW);this._projection=
...
{};b.source=a;return b}nextFrame(a){}registerKeyHandler(a){window.addEventListener("keydown",(b)=>{a({keyCode:b.keyCode})})}}class Ua{static load(a){return Ta}}class C{static isFunction(a){return"function"===typeof a}static isNumber(a){return"number"===typeof a}static isInteger(a){return"number"===typeof a&&0===a%1}static isBoolean(a){return!0===a||!1===a}static isString(a){return"string"==typeof a}static isObject(a){let b=typeof a;return!!a&&("object"==b||"function"==b)}static isPlainObject(a){return!!a&&
...
b,c,d,e){this._state.setSetting(this._vertexAttrib4f,[a,b,c,d,e])&&this._vertexAttrib4f(a,b,c,d,e)}$vertexAttrib4fv(a,b){this._state.setSetting(this._vertexAttrib4fv,[a,b])&&this._vertexAttrib4fv(a,b)}static enable(a,b="default"){Object.getOwnPropertyNames(O.prototype).forEach((b)=>{if("constructor"!==b){const c=O.prototype[b];"$"===b.charAt(0)&&(b=b.substr(1));a[b]&&(a[b].name||(a[b].xname=b),a["_"+b]=a[b]);a[b]=c}});O.prototype._initStateManager.call(a,b);return a}}class Va{constructor(a){this.stage=
...
1)),this._nativeFreeTextureSource(a));a.loadingSince=null;this.removeFromLookupMap(a)}_nativeUploadTextureSource(a,b){return this.stage.renderer.uploadTextureSource(a,b)}_nativeFreeTextureSource(a){this.stage.renderer.freeTextureSource(a);a.clearNativeTexture()}}class Wa{constructor(a){this.stage=a;this.root=null;this.updateTreeOrder=0;this.renderState=this.stage.renderer.createCoreRenderState(this);this.renderExec=this.stage.renderer.createCoreRenderExecutor(this);this.renderExec.init();this._usedMemory=
...
q.getTimingFunction(a)}get timingFunctionImpl(){return this._timingFunctionImpl}patch(a){this.stage.patchObject(this,a)}}U.prototype.isTransitionSettings=!0;class Xa{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set;this.defaultTransitionSettings=new U(this.stage)}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.progress(a);c.isRunning()||(b=!0)});b&&(this.active=new Set([...this.active].filter((a)=>a.isRunning())))}}createSettings(a){let b=
new U(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}removeActive(a){this.active.delete(a)}}class u{constructor(){this._clear()}_clear(){this._p=[];this._pe=[];this._idp=[];this._f=[];this._v=[];this._lv=[];this._sm=[];this._s=[];this._ve=[];this._sme=[];this._se=[];this._length=0}parse(a,b){l.isObjectLiteral(b)||(b={0:b});let c=.5,d=[];for(g in b)if(b.hasOwnProperty(g)){var e=b[g];l.isObjectLiteral(e)||(e={v:e});var f=parseFloat(g);"sm"===g?c=e.v:!isNaN(f)&&0<=f&&2>=f&&(e.p=f,e.f=
l.isFunction(e.v),e.lv=e.f?e.v(0,0):e.v,d.push(e))}d=d.sort(function(a,b){return a.p-b.p});var g=d.length;for(b=0;b<g;b++)e=b===g-1,d[b].hasOwnProperty("pe")?(e=b<g-1?d[b+1].p:1,d[b].pe>e&&(d[b].pe=e)):d[b].pe=e?1>=d[b].p?1:2:d[b+1].p,d[b].idp=d[b].pe===d[b].p?0:1/(d[b].pe-d[b].p);for(b=0;b<g;b++)if(d[b].hasOwnProperty("sm")||(d[b].sm=c),!d[b].hasOwnProperty("s"))if(0===b||b===g-1||1===d[b].p)d[b].s=a?[0,0,0,0]:0;else{var h=d[b-1];const c=d[b+1];h.p===c.p?d[b].s=a?[0,0,0,0]:0:a?(e=u.getRgbaComponents(c.lv),
f=u.getRgbaComponents(h.lv),h=1/(c.p-h.p),d[b].s=[h*(e[0]-f[0]),h*(e[1]-f[1]),h*(e[2]-f[2]),h*(e[3]-f[3])]):d[b].s=(c.lv-h.lv)/(c.p-h.p)}for(b=0;b<g-1;b++)d[b].f||(e=b===g-1,d[b].hasOwnProperty("ve")||(d[b].ve=e?d[b].lv:d[b+1].lv),l.isNumber(d[b].v)&&l.isNumber(d[b].lv)&&(d[b].hasOwnProperty("sme")||(d[b].sme=e?c:d[b+1].sm),d[b].hasOwnProperty("se")||(d[b].se=e?a?[0,0,0,0]:0:d[b+1].s),d[b].v=a?u.getSplineRgbaValueFunction(d[b].v,d[b].ve,d[b].p,d[b].pe,d[b].sm,d[b].sme,d[b].s,d[b].se):u.getSplineValueFunction(d[b].v,
d[b].ve,d[b].p,d[b].pe,d[b].sm,d[b].sme,d[b].s,d[b].se),d[b].f=!0));this.length&&this._clear();b=0;for(g=d.length;b<g;b++)this._add(d[b])}_add(a){this._p.push(a.p||0);this._pe.push(a.pe||0);this._idp.push(a.idp||0);this._f.push(a.f||!1);this._v.push(a.hasOwnProperty("v")?a.v:0);this._lv.push(a.lv||0);this._sm.push(a.sm||0);this._s.push(a.s||0);this._ve.push(a.ve||0);this._sme.push(a.sme||0);this._se.push(a.se||0);this._length++}_getItem(a){const b=this._length;if(!b)return-1;if(a<this._p[0])return 0;
...
c?a:1===c?b:b*c+a*(1-c)}}static getSplineRgbaValueFunction(a,b,c,d,e,f,g,h){c=d-c;g[0]*=c;g[1]*=c;g[2]*=c;g[3]*=c;h[0]*=c;h[1]*=c;h[2]*=c;h[3]*=c;c=u.getRgbaComponents(a);d=u.getRgbaComponents(b);let k=[u.getSplineHelpers(c[0],d[0],e,f,g[0],h[0]),u.getSplineHelpers(c[1],d[1],e,f,g[1],h[1]),u.getSplineHelpers(c[2],d[2],e,f,g[2],h[2]),u.getSplineHelpers(c[3],d[3],e,f,g[3],h[3])];return k[0]?function(c){return 0===c?a:1===c?b:u.getArgbNumber([Math.min(255,u.calculateSpline(k[0],c)),Math.min(255,u.calculateSpline(k[1],
c)),Math.min(255,u.calculateSpline(k[2],c)),Math.min(255,u.calculateSpline(k[3],c))])}:function(c){return 0===c?a:1===c?b:u.mergeColors(b,a,c)}}static getSplineHelpers(a,b,c,d,e,f){if(!c&&!d)return null;e=a+e*c;let g=1-d;d=b-f*d;return[3*c-3*g+1,-6*c+3*g,3*c,3*e-3*d+b-a,3*(d+a)-6*e,3*(e-a),a]}static calculateSpline(a,b){let c=a[0],d=a[1],e=a[2],f=a[3],g=a[4],h=a[5];a=a[6];if(-2===c&&-2===f&&0===e&&0===h)return b;let k=.5;for(var l=0;20>l;l++){var t=k*(k*(k*c+d)+e);t=b-t;if(-1E-8<t&&1E-8>t)return k*
(k*(k*f+g)+h)+a;var n=k*(3*k*c+2*d)+e;if(1E-10<n&&1E-10>n)break;k+=t/n}l=0;n=1;for(let m=0;20>m;m++){k=.5*(l+n);t=k*(k*(k*c+d)+e);t=b-t;if(-1E-8<t&&1E-8>t)return k*(k*(k*f+g)+h)+a;0>t?n=k:l=k}return k}static mergeColors(a,b,c){return 16777216*Math.round((a/16777216|0)*c+(b/16777216|0)*(1-c))+65536*Math.round((a/65536|0)%256*c+(b/65536|0)%256*(1-c))+256*Math.round((a/256|0)%256*c+(b/256|0)%256*(1-c))+Math.round(a%256*c+b%256*(1-c))}static getArgbNumber(a){a[0]=Math.max(0,Math.min(255,a[0]));a[1]=Math.max(0,
Math.min(255,a[1]));a[2]=Math.max(0,Math.min(255,a[2]));a[3]=Math.max(0,Math.min(255,a[3]));a=((a[3]|0)<<24)+((a[0]|0)<<16)+((a[1]|0)<<8)+(a[2]|0);0>a&&(a=4294967295+a+1);return a}}class ra{constructor(a){this.animationSettings=a;this._selector="";this._items=new u;this._props=[];this._propSetters=[];this._resetValue=void 0;this._hasResetValue=!1;this._hasColorProperty=void 0}getResetValue(){return this._hasResetValue?this._resetValue:this._items.getValue(0)}apply(a,b,c){a=this.getAnimatedViews(a);
...
this._settings.duration*60)}get settings(){return this._settings}}n.STATES={IDLE:0,PLAYING:1,STOPPING:2,STOPPED:3,FINISHED:4,PAUSED:5};class Ya{constructor(a){this.stage=a;this.stage.on("frameStart",()=>this.progress());this.active=new Set}progress(){if(this.active.size){let a=this.stage.dt,b=!1;this.active.forEach(function(c){c.isActive()?c.progress(a):b=!0});b&&(this.active=new Set([...this.active].filter((a)=>a.isActive())))}}createAnimation(a,b){l.isObjectLiteral(b)&&(b=this.createSettings(b));
return new n(this,b,a)}createSettings(a){const b=new z(this.stage);b.patch(a);return b}addActive(a){this.active.add(a)}}class sa extends A{_getLookupId(){return"__whitepix"}_getSourceLoader(){return function(a){var b=new Uint8Array([255,255,255,255]);a(null,{source:b,w:1,h:1,permanent:!0})}}}class V extends v{constructor(a={}){super();this._setOptions(a);this._lastGcFrame=this._usedMemory=0;this.platform=new (Ua.load(a));this.platform.init&&this.platform.init(this);this.c2d=this.gl=void 0;(a=this.getOption("context"))?
a.useProgram?this.gl=a:this.c2d=a:!l.isWeb||V.isWebglSupported()&&!this.getOption("canvas2d")?this.gl=this.platform.createWebGLContext(this.getOption("w"),this.getOption("h")):this.c2d=this.platform.createCanvasContext(this.getOption("w"),this.getOption("h"));this.gl&&O.enable(this.gl,"lightning");this._mode=this.gl?0:1;this.getCanvas()&&(this._options.w=this.getCanvas().width,this._options.h=this.getCanvas().height);this._renderer=0===this._mode?new Ka(this):new Pa(this);this.setClearColor(this.getOption("clearColor"));
this.frameCounter=0;this.transitions=new Xa(this);this.animations=new Ya(this);this.textureManager=new Va(this);this._destroyed=!1;this.dt=this.currentTime=this.startTime=0;this.rectangleTexture=new sa(this);this.rectangleTexture.load();this.rectangleTexture.source.permanent=!0;this.ctx=new Wa(this);this._updateSourceTextures=new Set}get renderer(){return this._renderer}static isWebglSupported(){if(l.isNode)return!0;try{return!!window.WebGLRenderingContext}catch(a){return!1}}get mode(){return this._mode}isWebgl(){return 0===
...
this._updateSourceTextures.size&&(this._updateSourceTextures.forEach((a)=>{a._performUpdateSource()}),this._updateSourceTextures=new Set);this.emit("update");const a=this.ctx.hasRenderUpdates();a&&(this._updatingFrame=!0,this.ctx.frame(),this._updatingFrame=!1);this.platform.nextFrame(a);this.emit("frameEnd");this.frameCounter++}renderFrame(){this.ctx.frame()}forceRenderUpdate(){this.root&&this.root.core._parent.setHasRenderUpdates(1)}setClearColor(a){this.forceRenderUpdate();null===a||void 0===a?
this._clearColor=void 0:Array.isArray(a)?this._clearColor=a:this._clearColor=q.getRgbaComponentsNormalized(a)}getClearColor(){return this._clearColor}createView(){return new r(this)}view(a){if(a.isView)return a;let b;b=a.type?new a.type(this):new r(this);b.patch(a,!0);return b}c(a){return this.view(a)}get w(){return this._options.w}get h(){return this._options.h}get rw(){return this.w/this._options.precision}get rh(){return this.h/this._options.precision}addMemoryUsage(a){this._usedMemory+=a;this._lastGcFrame!==
this.frameCounter&&this._usedMemory>this.getOption("memoryPressure")&&(this.gc(!1),this._usedMemory>this.getOption("memoryPressure")-2E6&&this.gc(!0))}get usedMemory(){return this._usedMemory}gc(a){if(this._lastGcFrame!==this.frameCounter){this._lastGcFrame=this.frameCounter;const b=this._usedMemory;this.gcTextureMemory(a);this.gcRenderTextureMemory(a);this.renderer.gc(a);console.log(`GC${a?"[aggressive]":""}! Frame ${this._lastGcFrame} Freed ${((b-this._usedMemory)/1E6).toFixed(2)}MP from GPU memory. Remaining: ${(this._usedMemory/
...
(this.root.visible=!1,this.ctx.freeUnusedRenderTextures(0),this.root.visible=!0):this.ctx.freeUnusedRenderTextures(0)}getDrawingCanvas(){return this.platform.getDrawingCanvas()}preparePatchSettings(a){return D.preparePatchSettings(a,this.getPatchId())}patchObject(a,b){b=D.preparePatchSettings(b,this.getPatchId());D.patchObject(a,b)}getPatchId(){return this.renderer.getPatchId()}}class B{constructor(){this._fireLevel=0;this._logPrefix="";this._debug=!1}get debug(){return this._debug}set debug(a){this._debug=
...
{keyCode:a.keyCode};this.__keymap[a.keyCode]?this.stage.application.focusTopDownEvent([{event:"_capture"+this.__keymap[a.keyCode],args:b},{event:"_captureKey",args:b}])||this.stage.application.focusBottomUpEvent([{event:"_handle"+this.__keymap[a.keyCode],args:b},{event:"_handleKey",args:b}]):this.stage.application.focusTopDownEvent("_captureKey",b)||this.stage.application.focusBottomUpEvent("_handleKey",b)}destroy(){this.stage.root=void 0;this._updateAttachedFlag();this._updateEnabledFlag()}}class ta extends A{constructor(a){super(a);
this._lookupId=this._factory=void 0}set content({factory:a,lookupId:b=void 0}){this._factory=a;this._lookupId=b;this._changed()}_getIsValid(){return!!this._factory}_getLookupId(){return this._lookupId}_getSourceLoader(){const a=this._factory;return(b)=>a((a,d)=>{if(a)return b(a);b(null,this.stage.platform.getTextureOptionsForDrawingCanvas(d))},this.stage)}}class P{static getCanvasTexture(a,b){return{type:ta,content:{factory:a,lookupId:b}}}static getRoundRect(a,b,c,d,e,f,g){Array.isArray(c)||(c=[c,
c,c,c]);let h="rect"+[a,b,d,e,f?1:0,g].concat(c).join(",");return P.getCanvasTexture((h,l)=>{h(null,this.createRoundRect(l,a,b,c,d,e,f,g))},h)}static createRoundRect(a,b,c,d,e,f,g,h){void 0===g&&(g=!0);void 0===e&&(e=0);a=a.platform.getDrawingCanvas();let k=a.getContext("2d");k.imageSmoothingEnabled=!0;a.width=b+e+2;a.height=c+e+2;k.beginPath();let m=.5*e+1,t=.5*e+1;k.moveTo(m+d[0],t);k.lineTo(m+b-d[1],t);k.arcTo(m+b,t,m+b,t+d[1],d[1]);k.lineTo(m+b,t+c-d[2]);k.arcTo(m+b,t+c,m+b-d[2],t+c,d[2]);k.lineTo(m+
d[3],t+c);k.arcTo(m,t+c,m,t+c-d[3],d[3]);k.lineTo(m,t+d[0]);k.arcTo(m,t,m+d[0],t,d[0]);g&&(l.isNumber(h)?k.fillStyle=q.getRgbaString(h):k.fillStyle="white",k.fill());e&&(l.isNumber(f)?k.strokeStyle=q.getRgbaString(f):k.strokeStyle="white",k.lineWidth=e,k.stroke());return a}static getShadowRect(a,b,c=0,d=5,e=2*d){Array.isArray(c)||(c=[c,c,c,c]);let f="shadow"+[a,b,d,e].concat(c).join(",");return P.getCanvasTexture((f,h)=>{f(null,this.createShadowRect(h,a,b,c,d,e))},f)}static createShadowRect(a,b,c,
...
c,e,0+c-d[3],d[3]);g.lineTo(e,0+d[0]);g.arcTo(e,0,e+d[0],0,d[0]);g.fill();return a}static getSvgTexture(a,b,c){let d="svg"+[b,c,a].join();return P.getCanvasTexture((d,f)=>{this.createSvg(d,f,a,b,c)},d)}static createSvg(a,b,c,d,e){let f=b.platform.getDrawingCanvas(),g=f.getContext("2d");g.imageSmoothingEnabled=!0;let h=new Image;h.onload=()=>{f.width=d;f.height=e;g.drawImage(h,0,0,f.width,f.height);a(null,f)};h.onError=(b)=>{a(b)};h.src=c}}class ua{static isMf(a){return l.isFunction(a)&&a.__mf}static mf(a){a.__mf=
...
this._preloadArea.style.overflow="hidden",document.body.appendChild(this._preloadArea));return this._preloadArea}}class Za extends A{constructor(a,b){super(a);this._options=b}set options(a){this._options!==a&&(this._options=a,this._changed())}get options(){return this._options}_getIsValid(){return!!this._options}_getSourceLoader(){return(a)=>{a(null,this._options)}}}class $a extends x{constructor(a){super(a);this._wrapper=super._children.a({});this._reloadVisibleElements=!1;this._visibleItems=new Set;
this._index=0;this._started=!1;this._scrollTransitionSettings=this.stage.transitions.createSettings({});this._itemSize=100;this._itemScrollOffset=this._viewportScrollOffset=0;this._roll=!1;this._rollMax=this._rollMin=0;this._progressAnimation=null;this._invertDirection=!1;this._horizontal=!0;this.itemList=new ab(this)}_allowChildrenAccess(){return!1}get items(){return this.itemList.get()}set items(a){this.itemList.patch(a)}start(){this._wrapper.transition(this.property,this._scrollTransitionSettings);
...
return{Application:G,Component:x,Base:D,Utils:l,StageUtils:q,View:r,Tools:P,Stage:V,ViewCore:L,ViewTexturizer:ia,Texture:A,EventEmitter:v,shaders:{Grayscale:Z,BoxBlur:I,Dithering:aa,CircularPush:ba,Inversion:Da,LinearBlur:W,Outline:ca,Pixelate:da,RadialFilter:ea,RadialGradient:fa,Light3d:ha,WebGLShader:S,WebGLDefaultShader:w,C2dShader:T,C2dDefaultShader:N,c2d:{Grayscale:Ca,Blur:za}},textures:{RectangleTexture:sa,NoiseTexture:xa,TextTexture:J,ImageTexture:Q,HtmlTexture:ya,StaticTexture:Za,StaticCanvasTexture:ta,
SourceTexture:ja},components:{FastBlurComponent:bb,SmoothScaleComponent:Y,BorderComponent:cb,ListComponent:$a},tools:{ObjMerger:ua,ObjectListProxy:va,ObjectListWrapper:wa}}}();
