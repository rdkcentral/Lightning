...
else for(let a=0,c=this._children.length;a<c;a++)0===this._children[a]._zIndex&&this._children[a].render();this._hasRenderUpdates=0}}_renderAdvanced(){this._zSort&&this.sortZIndexedChildren();if(2>this._outOfBounds&&this._renderContext.alpha){let d=this.renderState;var a=!0;let e;if(this._useRenderToTexture){if(0===this._rw||0===this._rh){this._hasRenderUpdates=0;return}if(!this._texturizer.hasRenderTexture()||3<=this._hasRenderUpdates){d.setShader(d.defaultShader,this);e=d.renderTextureInfo;var b=
{nativeTexture:null,offset:0,w:this._rw,h:this._rh,empty:!0,cleared:!1,ignore:!1,cache:!1};if(this._texturizer.hasResultTexture()||!d.isCachingTexturizer&&3>this._hasRenderUpdates)b.cache=!0,d.isCachingTexturizer=!0;this._texturizer.hasResultTexture()||this._texturizer.releaseRenderTexture();d.setRenderTextureInfo(b);d.setScissor(void 0);if(this._displayedTextureSource){var c=this._renderContext;this._renderContext=H.IDENTITY;this.renderState.addQuad(this);this._renderContext=c}}else a=!1}else 0===
this._outOfBounds&&this._displayedTextureSource&&(d.setShader(this.activeShader,this._shaderOwner),d.setScissor(this._scissor),this.renderState.addQuad(this));if(a&&this._children)if(this._zContextUsage)for(let a=0,b=this._zIndexedChildren.length;a<b;a++)this._zIndexedChildren[a].render();else for(let a=0,b=this._children.length;a<b;a++)0===this._children[a]._zIndex&&this._children[a].render();this._useRenderToTexture&&(c=!1,a&&(d.finishedRenderTexture(),(this._texturizer.empty=b.empty)?this._texturizer.releaseRenderTexture():
b.nativeTexture?(this._texturizer.reuseTextureAsRenderTexture(b.nativeTexture),b.ignore=!0):(this._texturizer.renderTextureReused&&this._texturizer.releaseRenderTexture(),b.nativeTexture=this._texturizer.getRenderTexture()),d.setRenderTextureInfo(e),c=!0),this._texturizer.empty||(a=this._texturizer.getResultTexture(),c&&(a&&(a.update=d.stage.frameCounter),this._texturizer.updateResultTexture()),this._texturizer.renderOffscreen||(d.setShader(this.activeShader,this._shaderOwner),d.setScissor(this._scissor),
b=!b||b.cache,d.setTexturizer(this._texturizer,b),this._stashTexCoords(),this._texturizer.colorize||this._stashColors(),this.renderState.addQuad(this,!0),this._texturizer.colorize||this._unstashColors(),this._unstashTexCoords(),d.setTexturizer(null),b&&(d.isCachingTexturizer=!1))));this._hasRenderUpdates=0}}get zSort(){return this._zSort}sortZIndexedChildren(){var a=this._zIndexedChildren.length;let b=0;var c=this._zIndexedChildren,d=[];for(var e=0;e<a;e++)c[e]._zParent===this&&(c[e]._zIndexResort?
...
h,e.tc*h,e.tb*h,e.td*h,e.px*h,e.py*h);var k=d===this._rectangleTexture;h={operation:a,target:b,index:m,rect:k};if(k)f?c.fillStyle="white":this._setColorGradient(c,l),c.globalAlpha=e.alpha,this._beforeDrawEl(h),c.fillRect(0,0,l.rw,l.rh);else{c.globalAlpha=e.alpha;this._beforeDrawEl(h);e=g?0:l._ulx*d.w;k=g?0:l._uly*d.h;const a=(g?1:l._brx-l._ulx)*d.w;g=(g?1:l._bry-l._uly)*d.h;f?c.drawImage(d,e,k,a,g,0,0,l.rw,l.rh):(f=this.ctx.allocateRenderTexture(Math.ceil(a),Math.ceil(g),1),f.ctx.clearRect(0,0,f.w,
f.h),4278190080>l._colorUl||4278190080>l._colorUr||4278190080>l._colorBl||4278190080>l._colorBr?(f.ctx.drawImage(d,e,k,a,g,0,0,a,g),f.ctx.globalCompositeOperation="multiply",this._setColorGradient(f.ctx,l,a,g,!1),f.ctx.fillRect(0,0,a,g),this._setColorGradient(f.ctx,l,a,g,!0),f.ctx.globalCompositeOperation="destination-in",f.ctx.fillRect(0,0,a,g)):(this._setColorGradient(f.ctx,l,a,g,!1),f.ctx.fillRect(0,0,a,g),f.ctx.globalCompositeOperation="multiply",f.ctx.drawImage(d,e,k,a,g,0,0,a,g),f.ctx.globalCompositeOperation=
"destination-in",f.ctx.drawImage(d,e,k,a,g,0,0,a,g)),f.ctx.globalCompositeOperation="source-over",c.fillStyle="white",c.drawImage(f,0,0,a,g,0,0,l.rw,l.rh),this.ctx.releaseRenderTexture(f))}this._afterDrawEl(h);c.globalAlpha=1}}_setColorGradient(a,b,c=b.rw,d=b.rh,e=!0){let f=b._colorUl,g;b._colorUl===b._colorUr?b._colorBl===b._colorBr&&b._colorUl!==b.colorBl&&(g=a.createLinearGradient(0,0,0,d),e?(g.addColorStop(0,t.getRgbaString(b._colorUl)),g.addColorStop(1,t.getRgbaString(b._colorBl))):(g.addColorStop(0,
