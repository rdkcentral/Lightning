...
stage.root.add({type: wpe.BorderView, borderWidth: 1, x: 200, w: 300, h: 400, children: [
    {type: wpe.ListView, tag: 'list', w: 300, h: 400, clipping: true, itemSize: 100, scrollTransition: {duration: 0.5}, invertDirection: false, roll: true, viewportScrollOffset: 0.5, itemScrollOffset: 0.5, children: [
