...
import FontAtlasCoreQuadList from "./FontAtlasCoreQuadList.mjs";
import FontAtlasCoreQuadOperation from "./FontAtlasCoreQuadOperation.mjs";
import FontAtlasCoreRenderExecutor from "./FontAtlasCoreRenderExecutor.mjs";
import CoreRenderState from "../../tree/core/CoreRenderState.mjs";
import DefaultShader from "./shaders/DefaultShader.mjs";
import FontAtlasShader from "./FontAtlasShader.mjs";
import Renderer from "../Renderer.mjs";

export default class FontAtlasRenderer extends Renderer {
    ...
    createCoreQuadList(ctx) {
        return new FontAtlasCoreQuadList(ctx);
    }
    ...
    createCoreRenderExecutor(ctx) {
        return new FontAtlasCoreRenderExecutor(ctx);
    }
